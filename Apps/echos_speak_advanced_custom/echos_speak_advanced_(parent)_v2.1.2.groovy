 ...
 *                          - Preserved direct HTTP command dispatch while allowing the server's authoritative 1,200 ms volume queue and asynchronous Amazon pipeline to execute cleanly.
