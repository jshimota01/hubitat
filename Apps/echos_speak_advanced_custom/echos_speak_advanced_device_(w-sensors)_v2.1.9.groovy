 ...
 *                          - Added missing iconFileName and iconImage attribute declarations to metadata definition to achieve full attribute parity with Standard driver baseline.
...
def timeStamp() { return "2026/09/22 02:58 PM" }
