...
def timeStamp() { return "2026/09/17 11:45 AM" }
...
private void initialize(Boolean isInstall = false) {
    ...
    // Seed Default Values across all 23 attributes
    ...
    if (device.currentValue("lastSpokenText") == null) sendEvent(name: "lastSpokenText", value: "")
    if (device.currentValue("lastAnnouncementText") == null) sendEvent(name: "lastAnnouncementText", value: "")
    ...
    if (device.currentValue("icon") == null) sendEvent(name: "icon", value: "")
    if (device.currentValue("trackImage") == null) sendEvent(name: "trackImage", value: "")
    if (device.currentValue("trackImageHtml") == null) sendEvent(name: "trackImageHtml", value: "")
