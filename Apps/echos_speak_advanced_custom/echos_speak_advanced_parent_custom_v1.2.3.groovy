...
def timeStamp() { return "2026/09/12 12:20 AM" }
...
def mainPage() {
    ...
    dynamicPage(name: "mainPage", title: "", install: true, uninstall: true) {
        ...
        section("<b>SECTION 2: Device Family Filtering Matrix</b>", hideable: true, hidden: false) {
            paragraph "<div style='color:#555; font-size:12px; margin-bottom:8px;'>" +
                      "<b>Category Filter Toggles:</b> Include or exclude specific Amazon device family categories from appearing in the discovery list.</div>"
        ...
        section("<b>SECTION 3: Amazon Echo Device Discovery</b>", hideable: true, hidden: false) {
            paragraph "<div style='color:#555; font-size:12px; margin-bottom:8px;'>" +
