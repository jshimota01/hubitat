 ...
 *
 *  Changelog:
 *  v2.0.9 (2026-09-21) - PlayTextAndRestore Volume Parameter Addition:
 *                          - Added optional volume parameter to playTextAndRestore metadata declaration.
 *                          - Updated playTextAndRestore implementation to route text and volume directly through speak() for automatic temporary volume scaling and restoration.
...
def timeStamp() { return "2026/09/21 07:40 PM" }
