...
static String version() { return '1.7.4' }
def timeStamp() { return "2026/09/19 10:15 AM" }
...
void parseDeviceFeatures(Map resp) {
    ...
    // 1. Temperature Sensor (Dynamic Capability Management)
    ...
    // 2. Motion Detection (Dynamic Capability Management)
    if (caps.motion == true) {
    ...
    // 3. Display Brightness (SwitchLevel Dynamic Capability Management)
    if (caps.displayBrightness == true || caps.display == true) {
        ...
        // Re-align level attribute for audio volume if display capability is absent
    ...
    // 4. Display Power (Switch Dynamic Capability Management)
