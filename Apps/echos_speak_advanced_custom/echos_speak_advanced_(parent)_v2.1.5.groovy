...
def timeStamp() { return "2026/09/22 12:47 PM" }
        ...
        httpPostJson(params) { resp ->
            ...
            if (resp.status == 200) {
                ...
                if (cmdStatus == "pending") {
                    // DEMOTED TO LOGDEBUG TO KEEP INFO LOGS CLEAN
                    logDebug "[${serialNumber}] Command '${command}' accepted by bridge (status: PENDING)"
                    
                    // TRAILING RECONCILIATION POLL (Resets timer on rapid clicks; fires 5000 ms after last click)
