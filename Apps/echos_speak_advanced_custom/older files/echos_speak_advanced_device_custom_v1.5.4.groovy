...
def timeStamp() { return "2026/09/15 02:20 PM" }
...
metadata {
    definition (
        ...
        command "playAnnouncementAll", [[name: "text*", type: "STRING", description: "Play text as a global whole-house Alexa Announcement"]]
...
void speak(String text, String voice = null, Object volume = null) {
    if (!text) return
