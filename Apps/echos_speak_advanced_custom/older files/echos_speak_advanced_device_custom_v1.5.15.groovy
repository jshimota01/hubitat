...
static String version() { return '1.5.15' }
...
/**
 * 2-Argument Overload Disambiguation:
 * Disambiguates speak(text, voiceOrVolume) calls from Rule Machine or platform actions.
 * If 2nd parameter is numeric (e.g. 90), routes as temporary speech volume.
 * If 2nd parameter is non-numeric string, routes as voice profile.
 */
