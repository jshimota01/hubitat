...
def timeStamp() { return "2026/09/12 09:15 AM" }
...
metadata {
    definition (
        ...
        // Dashboard HTML Output Attributes
...
/* =========================================================================================
   PARENT DATA PARSER & HTML TILE BUILDERS
   ========================================================================================= */
...
void parseServerStatusData(Map statusData) {
    ...
    // Construct Legacy ES_Tile Styled Table (html and htmlAlt)
    ...
    // Alternate Legacy HTML Output
    String wkStr2 = baseTable + 
                    "<tr><td>Last Check: ${lastValid}</td></tr>" +
                    "<tr><td>Next Check: ${nextValStr}</td></tr>" +
                    "<tr><th style='text-align:left;padding-top:4px;'>Server Data</th></tr>" +
                    "<tr><td>Server IP: ${serverIpVal}</td></tr>" +
                    "</table>"
    
    updateAttribute("htmlAlt", wkStr2)

    // Modern Compact HD+ Dashboard HTML Tile Output
