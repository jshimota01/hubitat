...
def timeStamp() { return "2026/09/12 12:00 AM" }
...
def mainPage() {
    ...
    dynamicPage(name: "mainPage", title: "", install: true, uninstall: true) {
        ...
        section("<b>SECTION 2: Amazon Echo Device Discovery</b>", hideable: true, hidden: false) {
            ...
            if (devMap) {
                input name: "selectedEchoes", type: "enum", title: "<b>Discovered Echo Devices (${devMap.size()} Found)</b>", options: devMap, multiple: true, required: false
            } else {
        ...
        section("<b>SECTION 3: Background Refresh & State Sync Engine</b>", hideable: true, hidden: false) {
            paragraph "<div style='color:#555; font-size:12px; margin-bottom:8px;'>" +
        ...
        section("<b>SECTION 4: System Diagnostics & Logging Options</b>", hideable: true, hidden: true) {
