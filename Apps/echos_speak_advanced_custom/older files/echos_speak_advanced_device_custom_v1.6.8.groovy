...
@Field static final List<Map> deviceModelTable = [
    ...
    [deviceType: "ASQZWP4GPYUT7", family: "ECHO", generation: null, modelName: "Echo Pop", imageFilename: "echo_pop", validated: true],
    ...
    [deviceType: "AZANTNEUTYY6L", family: "KNIGHT", generation: null, modelName: "Echo Show 21", imageFilename: "echo_show_21", validated: true],
    [deviceType: "A2LLN0UXRW4N50", family: "KNIGHT", generation: null, modelName: "Echo Show 11", imageFilename: "echo_show_11", validated: true],

    // ============================================================
    // OTHER ECHO HARDWARE
    // ============================================================
    [deviceType: "A3RBAYBE7VM004", family: "ECHO", generation: null, modelName: "Echo Studio", imageFilename: "echo_studio", validated: true],
    [deviceType: "A3VRME03NAXFUB", family: "ECHO", generation: null, modelName: "Echo Flex", imageFilename: "echo_flex", validated: true],
    [deviceType: "A3SSG6GR8UU7SN", family: "ECHO", generation: 1, modelName: "Echo Sub", imageFilename: "echo_sub_gen1", validated: true],
    [deviceType: "A27VEYGQBW3YR5", family: "ECHO", generation: null, modelName: "Echo Link", imageFilename: "echo_link", validated: false],
    [deviceType: "A2RU4B77X9R9NZ", family: "ECHO", generation: null, modelName: "Echo Link Amp", imageFilename: "echo_link_amp", validated: false],
    [deviceType: "A1JJ0KFC4ZPNJ3", family: "ECHO", generation: null, modelName: "Echo Input", imageFilename: "echo_input", validated: true],
    [deviceType: "A38949IHXHRQ5P", family: "ECHO", generation: null, modelName: "Echo Tap", imageFilename: "echo_tap", validated: true],
    [deviceType: "A3IYPH06PH1HRA", family: "ECHO", generation: null, modelName: "Echo Frames", imageFilename: "echo_frames", validated: false],
    [deviceType: "A15QWUTQ6FSMYX", family: "ECHO", generation: 2, modelName: "Echo Buds", imageFilename: "echo_buds_gen2", validated: false],

    // ============================================================
    // ECHO AUTO
    // ============================================================
    [deviceType: "A303PJF6ISQ7IC", family: "ALEXA_AUTO", generation: null, modelName: "Echo Auto", imageFilename: "echo_auto", validated: true],
    [deviceType: "A195TXHV1M5D4A", family: "ALEXA_AUTO", generation: null, modelName: "Echo Auto", imageFilename: "echo_auto", validated: false],
    [deviceType: "ALT9P69K6LORD", family: "ALEXA_AUTO", generation: null, modelName: "Echo Auto", imageFilename: "echo_auto", validated: false],
    [deviceType: "A13W6HQIHKEN3Z", family: "ALEXA_AUTO", generation: null, modelName: "Echo Auto", imageFilename: "echo_auto", validated: false],

    // ============================================================
    // ECHO HUB
    // ============================================================
    [deviceType: "ADMKNMEVNL158", family: "KNIGHT", generation: null, modelName: "Echo Hub", imageFilename: "echo_hub", validated: true],
    ...
    [deviceType: "A265XOI9586NML", family: "FIRE_TV", generation: null, modelName: "Fire TV Stick", imageFilename: "firetv_stick_gen1", validated: false],
    ...
    [deviceType: "A31DTMEEVDDOIV", family: "FIRE_TV", generation: null, modelName: "Fire TV Stick Lite", imageFilename: "unknown", validated: false],
    [deviceType: "A1WZKXFLI43K86", family: "FIRE_TV", generation: null, modelName: "Fire TV Stick 4K Max", imageFilename: "unknown", validated: false],
    [deviceType: "A3EVMLQTU6WL1W", family: "FIRE_TV", generation: null, modelName: "Fire TV Stick 4K Max", imageFilename: "unknown", validated: false],
    ...
    [deviceType: "A3HF4YRA2L7XGC", family: "FIRE_TV_CUBE", generation: null, modelName: "Fire TV Cube", imageFilename: "firetv_cube", validated: false],
    ...
    [deviceType: "AN630UQPG2CA4", family: "FIRE_TV", generation: null, modelName: "Fire TV Toshiba", imageFilename: "firetv_toshiba", validated: false],
    [deviceType: "A1F8D55J0FWDTN", family: "FIRE_TV", generation: null, modelName: "Fire TV Toshiba", imageFilename: "toshiba_firetv", validated: false],
    [deviceType: "AP4RS91ZQ0OOI", family: "FIRE_TV", generation: null, modelName: "Fire TV Toshiba", imageFilename: "toshiba_firetv", validated: false],
    [deviceType: "AFF5OAL5E3DIU", family: "FIRE_TV", generation: null, modelName: "Fire TV", imageFilename: "firetv_toshiba", validated: false],
    [deviceType: "AFF50AL5E3DIU", family: "FIRE_TV", generation: null, modelName: "Fire TV Insignia", imageFilename: "insignia_firetv", validated: false],

    // ============================================================
    // AMAZON TABLETS
    // ============================================================
    [deviceType: "A1Q7QCGNMXAKYW", family: "TABLET", generation: null, modelName: "Fire Tablet", imageFilename: "amazon_tablet", validated: false],
    [deviceType: "ATNLRCEBX3W4P", family: "TABLET", generation: null, modelName: "Fire Tablet", imageFilename: "amazon_tablet", validated: false],
    [deviceType: "A1J16TEDOYCZTN", family: "TABLET", generation: null, modelName: "Fire Tablet", imageFilename: "amazon_tablet", validated: false],
    [deviceType: "A2M4YX06LWP8WI", family: "TABLET", generation: null, modelName: "Fire Tablet", imageFilename: "amazon_tablet", validated: false],
    [deviceType: "A1C66CX2XD756O", family: "TABLET", generation: null, modelName: "Fire Tablet HD", imageFilename: "amazon_tablet", validated: false],
    [deviceType: "A2N49KXGVA18AR", family: "TABLET", generation: null, modelName: "Fire Tablet HD 10 Plus", imageFilename: "tablet_hd10", validated: false],
    [deviceType: "A3L0T0VL9A921N", family: "TABLET", generation: null, modelName: "Fire Tablet HD 8", imageFilename: "tablet_hd10", validated: false],
    [deviceType: "AVU7CPPF2ZRAS", family: "TABLET", generation: null, modelName: "Fire Tablet HD 8 Plus", imageFilename: "tablet_hd10", validated: false],
    [deviceType: "A38EHHIB10L47V", family: "TABLET", generation: null, modelName: "Fire Tablet HD 8", imageFilename: "tablet_hd10", validated: false],
    [deviceType: "A3R9S4ZZECZ6YL", family: "TABLET", generation: null, modelName: "Fire Tablet HD 10", imageFilename: "tablet_hd10", validated: false],
    [deviceType: "A2V9UEGZ82H4KZ", family: "TABLET", generation: null, modelName: "Fire Tablet HD 10", imageFilename: "tablet_hd10", validated: false],

    // ============================================================
    // MULTIROOM / WHA
    // ============================================================
    [deviceType: "A3C9PE6TNYLTCH", family: "WHA", generation: null, modelName: "Multiroom", imageFilename: "echo_wha", validated: true]
]

static String version() { return '1.6.8' }
def timeStamp() { return "2026/09/18 11:15 AM" }
...
metadata {
    definition (
        ...
        // CAPABILITY-AWARE DISPLAY COMMANDS
...
/* =========================================================================================
   CAPABILITY-GUARDED DISPLAY CONTROL COMMANDS
   ========================================================================================= */

private Boolean hasCapability(String capName) {
    List caps = state.capabilities ?: []
    return (capName in caps)
}

void setDisplayBrightness(level) {
    if (level == null) return
    if (!hasCapability("DISPLAY_BRIGHTNESS_ADJUST")) {
        logWarn "${device.displayName} - setDisplayBrightness() suppressed: Device does not advertise DISPLAY_BRIGHTNESS_ADJUST capability."
        return
    }
    int targetVal = level.toBigDecimal().intValue().clamp(0, 100)
...
void setDisplayPowerOn() {
    if (!hasCapability("DISPLAY_POWER_TOGGLE")) {
        logWarn "${device.displayName} - setDisplayPowerOn() suppressed: Device does not advertise DISPLAY_POWER_TOGGLE capability."
        return
    }
...
void setDisplayPowerOff() {
    if (!hasCapability("DISPLAY_POWER_TOGGLE")) {
        logWarn "${device.displayName} - setDisplayPowerOff() suppressed: Device does not advertise DISPLAY_POWER_TOGGLE capability."
        return
    }
...
void setAdaptiveBrightnessOn() {
    if (!hasCapability("DISPLAY_ADAPTIVE_BRIGHTNESS")) {
        logWarn "${device.displayName} - setAdaptiveBrightnessOn() suppressed: Device does not advertise DISPLAY_ADAPTIVE_BRIGHTNESS capability."
        return
    }
...
void setAdaptiveBrightnessOff() {
    if (!hasCapability("DISPLAY_ADAPTIVE_BRIGHTNESS")) {
        logWarn "${device.displayName} - setAdaptiveBrightnessOff() suppressed: Device does not advertise DISPLAY_ADAPTIVE_BRIGHTNESS capability."
        return
    }
...
void setVolume(volumeLevel) {
    ...
    int vol = volumeLevel.toBigDecimal().intValue().clamp(0, 100)
...
/* =========================================================================================
   DYNAMIC CAPABILITY & FEATURE RECONCILIATION
   ========================================================================================= */

private void reconcileCapabilities(List rawCaps) {
    state.capabilities = rawCaps

    if (!("DISPLAY_BRIGHTNESS_ADJUST" in rawCaps)) device.deleteCurrentState("displayBrightness")
    if (!("DISPLAY_POWER_TOGGLE" in rawCaps))      device.deleteCurrentState("displayPower")
    if (!("DISPLAY_ADAPTIVE_BRIGHTNESS" in rawCaps)) device.deleteCurrentState("adaptiveBrightness")
    if (!("MOTION_DETECTION" in rawCaps))          device.deleteCurrentState("motion")
    if (!("TEMPERATURE_SENSOR" in rawCaps))        device.deleteCurrentState("temperature")
}

void parseDeviceFeatures(Map feat) {
    if (!feat) return
    logTrace "--> parseDeviceFeatures() Payload received for ${device.displayName}: ${feat}"
    List rawCaps = state.capabilities ?: []

    // 1. Display Brightness (0-100)
    if ("DISPLAY_BRIGHTNESS_ADJUST" in rawCaps && feat.displayBrightness != null) {
        int brightVal = feat.displayBrightness.toInteger().clamp(0, 100)
        sendEvent(name: "displayBrightness", value: brightVal, unit: "%")
    }

    // 2. Display Power ("on" / "off")
    if ("DISPLAY_POWER_TOGGLE" in rawCaps && feat.displayPower != null) {
        Boolean pwr = feat.displayPower.toBoolean()
        sendEvent(name: "displayPower", value: pwr ? "on" : "off")
    }

    // 3. Adaptive Brightness ("on" / "off")
    if ("DISPLAY_ADAPTIVE_BRIGHTNESS" in rawCaps && feat.adaptiveBrightness != null) {
        Boolean adapt = feat.adaptiveBrightness.toBoolean()
        sendEvent(name: "adaptiveBrightness", value: adapt ? "on" : "off")
    }

    // 4. Motion State ("active" / "inactive")
    if ("MOTION_DETECTION" in rawCaps && feat.motion != null) {
        String rawMot = feat.motion.toString().trim().toUpperCase()
        String cleanMotion = (rawMot in ["DETECTED", "ACTIVE", "TRUE", "MOTION"]) ? "active" : "inactive"
        sendEvent(name: "motion", value: cleanMotion)
    }

    // 5. Temperature Sensor
    if ("TEMPERATURE_SENSOR" in rawCaps && feat.temperature != null) {
        BigDecimal rawTemp = feat.temperature.toBigDecimal()
        String rawScale = feat.temperatureScale?.toString()?.toUpperCase() ?: "CELSIUS"
...
void parseDeviceData(Map devData) {
    ...
    sendEvent(name: "generation", value: genVal)
    ...
    // 2. Capability Extraction & Dynamic Attribute Reconciliation
    List rawCaps = []
    if (devData.capabilities instanceof List) {
        rawCaps = devData.capabilities.collect { it.toString() }
    }
    reconcileCapabilities(rawCaps)

    // 3. Connectivity & Online State Mapping
    ...
    // 5. Speech, Announcements & Interactions
