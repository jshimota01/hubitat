...
static String version() { return '1.8.9' }
def timeStamp() { return "2026/09/20 02:15 PM" }
                ...
                resp.data.devices.each { dev ->
                    ...
                    if (sNum) {
                        ...
                        if (maskedAmazonEndpoints.containsKey(sNum)) {
                            logWarn "Masking Amazon bug endpoint: ${name} [${sNum}] (${fam})"
                            return
                        }
...
def syncDeviceStates() {
    ...
    // 1. Fetch Authoritative Amazon Endpoint List (applies bug masking automatically)
