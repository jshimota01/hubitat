...
def timeStamp() { return "2026/09/12 12:30 AM" }
...
def mainPage() {
    ...
    dynamicPage(name: "mainPage", title: "", install: true, uninstall: true) {
        ...
        section("<b>SECTION 2: Device Family Filtering Matrix</b>", hideable: true, hidden: false) {
            ...
            input name: "catIncludeShows", type: "bool", title: "<b>Category 2: Echo Show & Screen Hardware (SHOW)</b>", defaultValue: true, submitOnChange: true, width: 6
...
private Boolean isFamilyAllowed(String family) {
    ...
    if (fam in ["WHA"] && incWHA) return true
    if (fam in ["EVERYWHERE"] && incEverywhere) return true

    // Default true for standard unclassified Echo hardware if main toggle enabled
    return incEcho
}
