...
def servPrefPage() {
    ...
    return dynamicPage(name: "servPrefPage", install: (newInstall || resumeConf), nextPage: (!(newInstall || resumeConf) ? "mainPage" : sBLANK), uninstall: !(Boolean)state.serviceConfigured) {
        ...
        section(sectHead("Cookie Server Deployment Option:")) {
            input "useHeroku", sBOOL, title: inTS1("Deploy server to Heroku?", sHEROKU), description: spanSm("Turn Off to allow local server deployment"), required: false, defaultValue: false, submitOnChange: true
        }

        // --- ALWAYS SHOW LOCAL SERVER OVERRIDE WHEN HEROKU IS DISABLED ---
        if((Boolean)settings.useHeroku == false) {
            section(sectHead("Local Server Configuration:")) {
                input "serverHostOverride", "text", title: inTS1("Local Server Host URL"), description: "e.g. http://192.168.1.50:8080", required: true, submitOnChange: true
            }
        }

        srvcPrefOpts(true)

        section(sectHead("Deploy or Connect Server:")) {
            href url: getAppEndpointUrl("config"), style: sEXTNRL, title: inTS1("Begin Server Setup / Login", "upload"), description: inactFoot(sTTP)
        }
    }
}
...
static String getPublicImg(String imgName) { return "https://raw.githubusercontent.com/jshimota01/hubitat/main/Drivers/echo_speaks_custom/resources/icons/${imgName}.png" }
...
@Field static final Map deviceSupportMapFLD = [
    types: [
        ...
        "A2LLN0UXRW4N50"  : [ c: [ "a", "t" ], i: "echo_show_11_gen4", n: "Echo Show 11 (Gen4)" ],
        "AQ24620N8QD5Q"  : [ c: [ "a", "t" ], i: "echo_show_15", n: "Echo Show 15 (Gen2)" ],
        "A1EIANJ7PNB0Q7" : [ c: [ "a", "t" ], i: "echo_show_15", n: "Echo Show 15 (Gen1)" ],
        "AZANTNEUTYY6L" : [ c: [ "a", "t" ], i: "echo_show_21", n: "Echo Show 21 (Gen1)" ],
