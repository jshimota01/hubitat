 ...
 *
 *  Changelog:
 *  v1.4.4    08/28/26    jshimota    Aligned version references with Driver v1.4.2
 *  v1.4.3    08/28/26    jshimota    Aligned version references with Driver v1.4.1
...
def timeStamp() { return "2026/08/28 03:20 PM" }
    ...
    dynamicPage(name: "mainPage") {
        ...
        """) {
            if (garageControl) {
                ...
                String driverVer = garageControl.currentValue("driverVersion") ?: "v1.4.2"
