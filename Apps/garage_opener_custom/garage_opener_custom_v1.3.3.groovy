...
def timeStamp() { return "2026/08/28 11:58 AM" }
    ...
    dynamicPage(name: "mainPage") {
        ...
        """) {
            ...
            if (garageControl) {
                ...
                String driverVer = garageControl.currentValue("driverVersion") ?: "v1.3.0"
...
def relayTriggerHandler(evt) {
    if (evt.value == "pulse") {
        logInfo "Explicit open/close command received from Virtual Controller. Pulsing physical garage relay..."
        garageSwitch.on()
    }
}
...
def doorStateTileHandler(evt) {
    logDebug "Virtual Garage Controller door state changed: ${evt.value}"
