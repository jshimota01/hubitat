    ...
    dynamicPage(name: "mainPage") {
        ...
        """) {
            ...
            if (garageControl) {
                ...
                String driverVer = garageControl.currentValue("driverVersion") ?: "v1.2.6"
...
private void refreshNotificationTile(String reason = "") {
    ...
    if (formatType == "plain") {
        ...
        // Read typography preferences from driver settings map
        Map devSettings = garageControl.getSettings() ?: [:]
        
        String tSize = devSettings.titleFontSize ?: "0.85em"
        String sSize = devSettings.statusFontSize ?: "0.75em"
        String cSize = devSettings.sensorFontSize ?: "0.75em"
        String uSize = devSettings.updatedFontSize ?: "0.65em"
        ...
        tileOutput = """<div style='height:100%; width:100%; box-sizing:border-box; padding:4px 6px; font-family:sans-serif; background:#181818; color:#fff; border-radius:6px; overflow:hidden; display:flex; flex-direction:column; justify-content:space-between;'>
            <div style='display:flex; justify-content:space-between; align-items:center; gap:4px;'>
                ...
                <span style='background:${stateBgColor}; color:#fff; padding:1px 6px; border-radius:8px; ${sWeight} font-size:${sSize}; letter-spacing:0.5px;'>${doorState}</span>
            </div>
