    ...
    dynamicPage(name: "mainPage") {
        ...
        """) {
            if (garageControl) {
                ...
                String shadowLockVal = garageControl.currentValue("shadowLockState") ?: "DISABLED"
                String shadowChildName = "Option A Shadow Lock"
                ...
                try {
                    ...
                    if (shadowChild) {
                        shadowChildName = shadowChild.displayName
                ...
                String driverVer = garageControl.currentValue("driverVersion") ?: "v1.5.4"
