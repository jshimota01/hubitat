...
def timeStamp() { return "2026/08/28 03:05 PM" }
    ...
    dynamicPage(name: "mainPage") {
        ...
        """) {
            if (garageControl) {
                ...
                String alexaState = garageControl.currentValue("alexaState") ?: "SETTLED"
                String driverVer = garageControl.currentValue("driverVersion") ?: "v1.4.0"
                ...
                <table style='width:100%; border-collapse: collapse; border: 1px solid #ddd; font-family: sans-serif; font-size: 13px;'>
                    ...
                    <tr>
                        <td style='padding: 8px; border: 1px solid #ddd;'><b>Alexa Confirmation</b></td>
                        <td style='padding: 8px; border: 1px solid #ddd;'>Voice Timeout Guard</td>
                        <td style='padding: 8px; border: 1px solid #ddd; color: ${alexaState == 'SETTLED' ? '#2e7d32' : '#ef6c00'}; font-weight: bold;'>${alexaState}</td>
                    </tr>
                    <tr>
...
private void logTrace(String msg) {
    String nameStr = app.label ?: "Garage Opener"
    if (getSettingBool("logTraceEnable", false)) log.trace "${nameStr}: ${msg}"
}
