...
def timeStamp() { return "2026/08/28 01:15 PM" }
    ...
    dynamicPage(name: "mainPage") {
        ...
        """) {
            ...
            if (garageControl) {
                ...
                String driverVer = garageControl.currentValue("driverVersion") ?: "v1.3.2"
...
private void refreshNotificationTile(String reason = "") {
    ...
    if (formatType == "plain") {
        ...
        // Read style attributes safely using native currentValue calls
        String tSize = sanitizeFontSize(garageControl.currentValue("titleFontSize"), "0.85em")
        String sSize = sanitizeFontSize(garageControl.currentValue("statusFontSize"), "0.75em")
        String cSize = sanitizeFontSize(garageControl.currentValue("sensorFontSize"), "0.75em")
        String uSize = sanitizeFontSize(garageControl.currentValue("updatedFontSize"), "0.65em")
