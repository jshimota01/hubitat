...
2026-07-22  Orig Authored sent info about sort prob. fixed.
*/
...
function sortTable(columnIndex, forcedDirection = null) {
    ...
    // Determine target direction: use forcedDirection if provided, otherwise toggle current direction
...
document.addEventListener("DOMContentLoaded", function() {
    sortTable(${defaultSortIndex}, '${sortDir}');
});
</script>
    """
    return html
