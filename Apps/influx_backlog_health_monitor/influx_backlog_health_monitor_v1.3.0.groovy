...
def timeStamp() { return "2026/08/30 11:40 AM" }
...
definition(
    ...
    iconX2Url: "",
    iconX3Url: "",
    importUrl: "https://raw.githubusercontent.com/jshimota01/hubitat/main/Apps/influxdb_backlog_health_monitor/influx_backlog_health_monitor_v1.3.0.groovy",
    singleThreaded: true
)
...
def sendTestValuesToTile() {
    ...
    testCounts.each { testVal ->
        ...
        def testOutputString = "${cleanTimeStr} ${volumeTag}Influx Backlog: ${testVal} steady"
