 ...
 *      2026-09-20    jshimota      0.5.6       Room Assignment Architecture Correction:
 *                                              - Removed unsupported location.setDeviceRoom() call entirely from existing-child update path.
 *                                              - Retained reliable initial room assignment via roomId in devProps map passed to addChildDevice() during creation.
 *
 */
...
def timeStamp() { return "2026/09/20 11:45 AM" }
