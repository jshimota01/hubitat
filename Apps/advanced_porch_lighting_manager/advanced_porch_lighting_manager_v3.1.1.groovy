...
def timeStamp() { return "2026/09/07 09:15 AM" }
...
def mainPage() {
    dynamicPage(name: "mainPage", title: "", install: true, uninstall: true) {
        ...
        section("<b>3. Optional Schedule Adjustments</b>", hideable: true, hidden: true) {
            ...
            paragraph "<div style='font-size:0.85em; color:#555; margin-top:-8px; margin-bottom:8px;'>" +
                      "<i>Note: The cloud adjustment scales proportionally based on current cloud percentage. For example, a 50% cloud cover applies 50% of your configured maximum offset minutes to advance light turn-ON times.</i></div>"
            ...
            paragraph "<div style='font-size:0.85em; color:#555; margin-top:-8px; margin-bottom:8px;'>" +
                      "<i>Note: The Lux adjustment uses a binary threshold model. When current illuminance drops to or below your configured lx threshold, the full extension minutes are appended to Morning OFF to maintain lighting coverage during dark mornings.</i></div>"
