...
def timeStamp() { return "2026/09/07 09:25 AM" }
    ...
    dynamicPage(name: "mainPage", title: "", install: true, uninstall: true) {
        ...
        section("<b>3. Environmental & Schedule Adjustments</b>", hideable: true, hidden: true) {
            ...
            paragraph "<div style='background:#F8F9FA; padding:8px 12px; border-left:4px solid #FFB74D; margin-top:-6px; margin-bottom:8px; font-size:0.85em; color:#333;'>" +
                      ...
                      "• <b>Scope:</b> Applied strictly to Morning OFF.<br/>" +
                      "• <b>Behavior:</b> When illuminance falls at or below your configured threshold, it adds extension minutes to the Morning OFF time to keep lights on longer during dark, gloomy mornings. It does not adjust Evening OFF, because Evening OFF is governed by a fixed bedtime/cutoff time (e.g. 12:00 AM) or a Sleep Mode trigger." +
                      "</div>"
