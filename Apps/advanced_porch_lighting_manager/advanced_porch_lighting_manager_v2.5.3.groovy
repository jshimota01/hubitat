...
def timeStamp() { return "2026/09/06 03:00 PM" }
...
private Map calculateSchedulePreview() {
    ...
    // Evening OFF: Anchored to Cutoff Time + Sleep Mode Indicator
    ...
    preview.eveOffFactors = eOffFactors.join(" ")
