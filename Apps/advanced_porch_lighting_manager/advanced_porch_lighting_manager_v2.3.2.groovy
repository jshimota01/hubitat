...
def timeStamp() { return "2026/09/06 11:45 AM" }
    ...
    dynamicPage(name: "mainPage", title: "", install: true, uninstall: true) {
        ...
        section(schedSectionTitle, hideable: true, hidden: true) {
            ...
            if (enableMorningSchedule != false) {
                paragraph "<div style='background:#F1F3F4; padding:8px 12px; border-left:4px solid #1A73E8; margin:6px 0; font-size:0.9em; color:#202124;'>" +
