...
def timeStamp() { return "2026/09/06 01:50 PM" }
    ...
    dynamicPage(name: "mainPage", title: "", install: true, uninstall: true) {
        ...
        section(schedSectionTitle, hideable: true, hidden: true) {
            ...
            if (enableEveningSchedule != false) {
                ...
                input name: "eveOnTime", type: "time", title: "Evening On - Specific Time (Optional Override)", description: "If set, overrides all twilight lead times and cloud shifts for Evening ON", required: false, submitOnChange: true
...
private Map calculateSchedulePreview() {
    ...
    if (twilightTimes.begin) {
        ...
        if (mornTwilightDate) {
            ...
            // MORNING ON EVALUATION (Lux removed from ON)
            if (mornOnTime) {
            ...
            // MORNING OFF EVALUATION (Lux adds extension)
