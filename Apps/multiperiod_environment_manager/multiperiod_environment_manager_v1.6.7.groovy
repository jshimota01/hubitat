 ...
 **/
// [KEEP-EXACT] See possible changelog.txt for past changelog history versions v0 - v1.5.9

static String version() { return '1.6.7' }
def timeStamp() { return "2026/09/02 01:15 PM" }
...
def mainPage() {
    dynamicPage(name: "mainPage", title: "", install: true, uninstall: true) {
        ...
        section("<b>SECTION 4: System Overrides (Presence & Sleeping Setpoints)</b>", hideable: true, hidden: true) {
            ...
            input name: "awayDev1Enabled", type: "bool", title: "<b>Enable House HVAC Controller/Thermostat Device Presence Override</b>", defaultValue: true, submitOnChange: false
            input name: "awayDev2Enabled", type: "bool", title: "<b>Enable Office HVAC Controller/Thermostat Device Presence Override</b>", defaultValue: true, submitOnChange: false
            ...
            input name: "awayDev1Heat", type: "number", title: "<b>House Presence</b>", required: true, defaultValue: 62, width: 6
            input name: "awayDev1Cool", type: "number", title: "<b>House Presence</b>", required: true, defaultValue: 78, width: 6
            ...
            input name: "awayDev2Heat", type: "number", title: "<b>Office Presence</b>", required: true, defaultValue: 60, width: 6
            input name: "awayDev2Cool", type: "number", title: "<b>Office Presence</b>", required: true, defaultValue: 80, width: 6
            ...
            input name: "sleepDev1Enabled", type: "bool", title: "<b>Enable House HVAC Controller/Thermostat Device Sleeping Override</b>", defaultValue: true, submitOnChange: false
            input name: "sleepDev2Enabled", type: "bool", title: "<b>Enable Office HVAC Controller/Thermostat Device Sleeping Override</b>", defaultValue: true, submitOnChange: false
            ...
            input name: "sleepDev1Heat", type: "number", title: "<b>House Sleeping</b>", required: true, defaultValue: 65, width: 6
            input name: "sleepDev1Cool", type: "number", title: "<b>House Sleeping</b>", required: true, defaultValue: 74, width: 6
            ...
            input name: "sleepDev2Heat", type: "number", title: "<b>Office Sleeping</b>", required: true, defaultValue: 62, width: 6
            input name: "sleepDev2Cool", type: "number", title: "<b>Office Sleeping</b>", required: true, defaultValue: 76, width: 6
        }
        ...
        section("<b>SECTION 5: Safety Controls (Office HVAC Isolation)</b>", hideable: true, hidden: true) {
            ...
            input name: "awayDev2ForceOff", type: "bool", title: "<b>Force Office HVAC Controller/Thermostat Device OFF During Presence Override</b>", defaultValue: true, submitOnChange: false
            ...
            input name: "sleepDev2ForceOff", type: "bool", title: "<b>Force Office HVAC Controller/Thermostat Device OFF During Sleeping Override</b>", defaultValue: true, submitOnChange: false
        ...
        section("<b>SECTION 6: Automatic Fan Circulation Control</b>", hideable: true, hidden: true) {
            ...
            input name: "fanCirculateEnabled", type: "bool", title: "<b>Enable Fan Circulation Loop (House HVAC Controller/Thermostat Device)</b>", defaultValue: false, submitOnChange: false
...
def overrideSwitchHandler(evt) { executeEvaluationPass("Override Attribute Changed (${evt?.device?.displayName} = ${evt?.value})", true) }
