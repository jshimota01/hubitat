 ...
 *      2026-08-07    Gemini        0.9.7       Fixed NullPointerException in mainPage AQI tier limits table rendering
 *      2026-08-07    Gemini        0.9.8       Added inline Elvis operator guards (?:) on table additions to permanently resolve null+1 NPE in mainPage
 *      2026-08-20    Gemini        0.10.0      Removed thermostat setpoint subscriptions to allow temporary external manual setpoint overrides until next period boundary reset
 *      2026-08-20    Gemini        0.11.0      Restructured mainPage GUI layout to match Mode Manager Advanced styling standards (dark title banner, category headers, collapsible sections, and status badges)
 */
 ...
 */
static String version() { return '0.11.0' }
...
def mainPage() {
    dynamicPage(name: "mainPage", title: "", install: true, uninstall: true) {
        ...
        section("<b>SECTION 8: Logging Preferences</b>", hideable: true, hidden: isCollapsed) {
            paragraph "<div style='color:#555; font-size:12px; margin-bottom:8px;'>" +
                      "Configure system logging outputs. <i>(Debug logging auto-disables after 30 minutes)</i>.</div>"

            input name: "logInfoEnable", type: "bool", title: "Enable Info Logging", defaultValue: true
            input name: "logDebugEnable", type: "bool", title: "Enable Debug Logging", defaultValue: false, submitOnChange: true
