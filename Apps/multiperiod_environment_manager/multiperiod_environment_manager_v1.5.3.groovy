...
static String version() { return '1.5.3' }
def timeStamp() { return "2026/09/02 10:52 AM" }
...
def mainPage() {
    dynamicPage(name: "mainPage", title: "", install: true, uninstall: true) {
        ...
        section("<b>SECTION 1: House HVAC Controller (Primary)</b>", hideable: true, hidden: true) {
            ...
            // EXPERIMENT TEST BOX FOR CHATGPT JS-TO-NATIVE BRIDGE
            paragraph "<div style='background-color:#EBF5FB; border:1px solid #2980B9; padding:8px; border-radius:4px; margin-bottom:10px; font-size:12px;'>" +
                      "<b>EXPERIMENTAL JS-TO-NATIVE BRIDGE TEST (Morning Setpoints):</b><br/>" +
                      "Adjust the HTML spinners below to test if JavaScript updates the visible native Hubitat number fields underneath." +
                      "</div>"

            def mHeatVal = settings["d1MorningHeat"] != null ? settings["d1MorningHeat"] : 68
            def mCoolVal = settings["d1MorningCool"] != null ? settings["d1MorningCool"] : 72

            paragraph "<table style='width:100%; border-collapse:collapse; font-size:13px; text-align:left;'>" +
                      "<tr style='background-color:#F2F4F4; border-bottom:2px solid #2C3E50;'><th style='padding:4px;'>Period (HTML Spinner)</th><th style='padding:4px;'>Heating (°F)</th><th style='padding:4px;'>Cooling (°F)</th></tr>" +
                      "<tr><td style='padding:4px;'><b>Morning Test</b></td>" +
                      "<td style='padding:4px;'><input type='number' value='${mHeatVal}' style='width:65px; padding:3px;' onchange=\"var target=document.getElementsByName('d1MorningHeat')[0]; if(target){ target.value=this.value; target.dispatchEvent(new Event('change')); }\" /></td>" +
                      "<td style='padding:4px;'><input type='number' value='${mCoolVal}' style='width:65px; padding:3px;' onchange=\"var target=document.getElementsByName('d1MorningCool')[0]; if(target){ target.value=this.value; target.dispatchEvent(new Event('change')); }\" /></td>" +
                      "</tr></table>"

            paragraph "<div style='background-color:#F2F4F4; padding:6px; font-weight:bold; border-bottom:2px solid #2C3E50; margin-top:10px;'>House HVAC Native Number Controls (Authoritative)</div>"
            
            input name: "d1MorningHeat", type: "number", title: "<b>Morning Heating (°F)</b> <i>(below)</i>", defaultValue: 68, required: true, width: 6, submitOnChange: false
            input name: "d1MorningCool", type: "number", title: "<b>Morning Cooling (°F)</b> <i>(exceeds)</i>", defaultValue: 72, required: true, width: 6, submitOnChange: false
            
            input name: "d1DayHeat", type: "number", title: "<b>Day Heating (°F)</b> <i>(below)</i>", defaultValue: 66, required: true, width: 6, submitOnChange: false
            input name: "d1DayCool", type: "number", title: "<b>Day Cooling (°F)</b> <i>(exceeds)</i>", defaultValue: 75, required: true, width: 6, submitOnChange: false
            
            input name: "d1EveningHeat", type: "number", title: "<b>Evening Heating (°F)</b> <i>(below)</i>", defaultValue: 69, required: true, width: 6, submitOnChange: false
            input name: "d1EveningCool", type: "number", title: "<b>Evening Cooling (°F)</b> <i>(exceeds)</i>", defaultValue: 73, required: true, width: 6, submitOnChange: false
            
            input name: "d1NightHeat", type: "number", title: "<b>Night Heating (°F)</b> <i>(below)</i>", defaultValue: 64, required: true, width: 6, submitOnChange: false
            input name: "d1NightCool", type: "number", title: "<b>Night Cooling (°F)</b> <i>(exceeds)</i>", defaultValue: 75, required: true, width: 6, submitOnChange: false
        }
        ...
        section("<b>SECTION 2: Office HVAC Controller (Secondary / Floor Heater)</b>", hideable: true, hidden: true) {
            ...
            paragraph "<div style='background-color:#F2F4F4; padding:6px; font-weight:bold; border-bottom:2px solid #2C3E50;'>Office HVAC Native Number Controls (Authoritative)</div>"
            
            input name: "d2MorningHeat", type: "number", title: "<b>Morning Heating (°F)</b> <i>(below)</i>", defaultValue: 68, required: true, width: 6, submitOnChange: false
            input name: "d2MorningCool", type: "number", title: "<b>Morning Cooling (°F)</b> <i>(exceeds)</i>", defaultValue: 72, required: true, width: 6, submitOnChange: false
            
            input name: "d2DayHeat", type: "number", title: "<b>Day Heating (°F)</b> <i>(below)</i>", defaultValue: 66, required: true, width: 6, submitOnChange: false
            input name: "d2DayCool", type: "number", title: "<b>Day Cooling (°F)</b> <i>(exceeds)</i>", defaultValue: 75, required: true, width: 6, submitOnChange: false
            
            input name: "d2EveningHeat", type: "number", title: "<b>Evening Heating (°F)</b> <i>(below)</i>", defaultValue: 69, required: true, width: 6, submitOnChange: false
            input name: "d2EveningCool", type: "number", title: "<b>Evening Cooling (°F)</b> <i>(exceeds)</i>", defaultValue: 73, required: true, width: 6, submitOnChange: false
            
            input name: "d2NightHeat", type: "number", title: "<b>Night Heating (°F)</b> <i>(below)</i>", defaultValue: 62, required: true, width: 6, submitOnChange: false
            input name: "d2NightCool", type: "number", title: "<b>Night Cooling (°F)</b> <i>(exceeds)</i>", defaultValue: 78, required: true, width: 6, submitOnChange: false
        }
