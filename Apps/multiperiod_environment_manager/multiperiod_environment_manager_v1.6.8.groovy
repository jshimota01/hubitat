 ...
 *
 *  Changelog:
 *  v1.6.8	  09/02/26	  jshimota	  GUI Text cleaning related to device/presence/sleeping.  Removed Forced switches - declared notation that Office device will always be off during sleep and away modes.
 *	v1.6.7	  09/02/26	  jshimota	  Standardized UI labels across Sections 1, 2, and 4 to consistently reference 'House HVAC Controller/Thermostat Device' and 'Office HVAC Controller/Thermostat Device'. Updated Section 4, 5, and 6 terminology and enforced non-configurable Office OFF safety isolation.
...
def mainPage() {
    dynamicPage(name: "mainPage", title: "", install: true, uninstall: true) {
        ...
        section("<b>SECTION 4: System Overrides (Presence & Sleeping Setpoints)</b>", hideable: true, hidden: true) {
            ...
            input name: "awayDev2Enabled", type: "bool", title: "<b>Enable Control Office HVAC Controller/Thermostat Device Presence Override</b>", defaultValue: true, submitOnChange: false
            ...
            input name: "awayDev1Heat", type: "number", title: "<b>House Device</b>", required: true, defaultValue: 62, width: 6
            ...
            input name: "awayDev2Heat", type: "number", title: "<b>Office Device</b>", required: true, defaultValue: 60, width: 6
            input name: "awayDev2Cool", type: "number", title: "<b>Office Device</b>", required: true, defaultValue: 80, width: 6
            ...
            input name: "sleepDev2Enabled", type: "bool", title: "<b>Enable Control Office HVAC Controller/Thermostat Device Sleeping Override</b>", defaultValue: true, submitOnChange: false
            ...
            input name: "sleepDev1Heat", type: "number", title: "<b>House Device</b>", required: true, defaultValue: 65, width: 6
            ...
            input name: "sleepDev2Heat", type: "number", title: "<b>Office Device</b>", required: true, defaultValue: 62, width: 6
            input name: "sleepDev2Cool", type: "number", title: "<b>Office Device</b>", required: true, defaultValue: 76, width: 6
        }
...
private Map getCalculatedScheduleData() {
    ...
    if (isAway) {
        ...
        if (getSettingBool("awayDev2Enabled", true) && !d2ForceOff) {
        ...
        if (getSettingBool("sleepDev2Enabled", true) && !d2ForceOff) {
...
def manageFanCirculation(Boolean isInitial = false, String targetPhase = null) {
    ...
    try {
        if (executeOnPhase) {
            ...
            logInfo "Fan Circulation Control (${isSleeping ? 'Sleeping Mode Circulation Period' : 'Standard Circulation Period'}): Setting fan to AUTO for ${safeOff} minutes."
