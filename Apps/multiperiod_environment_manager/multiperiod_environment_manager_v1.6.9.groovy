...
def timeStamp() { return "2026/09/02 01:52 PM" }
...
def mainPage() {
    dynamicPage(name: "mainPage", title: "", install: true, uninstall: true) {
        ...
        section("<b>SECTION 4: System Overrides (Presence & Sleeping Setpoints)</b>", hideable: true, hidden: true) {
            ...
            input name: "awayDev2Heat", type: "number", title: "<div style='border-right:1px solid #CCC; padding-right:8px;'><b>Office Device</b></div>", required: true, defaultValue: 60, width: 6
            ...
            input name: "sleepDev2Heat", type: "number", title: "<div style='border-right:1px solid #CCC; padding-right:8px;'><b>Office Device</b></div>", required: true, defaultValue: 62, width: 6
