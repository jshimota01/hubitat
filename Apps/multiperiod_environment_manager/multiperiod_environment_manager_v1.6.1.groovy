 ...
 *	v1.5.9	  09/02/26	  jshimota	  Extended vertical column divider lines, header banners, and colorized labels across all multi-input sections (House, Office, Presence/Sleeping Overrides, Fan Circulation, and AQI Boundaries).
 *	v1.5.8	  09/02/26	  jshimota	  Refined 4-column header bar to match Mockup 1 layout, removed period numbers, and colorized Heating (FireBrick) and Cooling (DodgerBlue) column titles.
 *	v1.5.7	  09/02/26	  jshimota	  Integrated custom 4-column HTML header bar, simplified native setpoint input labels to eliminate redundant 'Heating/Cooling' text, and added CSS cell divider borders for 1080p desktop layout.
 *	v1.5.6	  09/02/26	  jshimota	  Diagnostic layout update: Reduced Section 1 House HVAC native setpoint input widths to width: 3 (4-across) to test native row compression and visual density.
 *	v1.5.5	  09/02/26	  jshimota	  Aligned native Hubitat inputs into clean side-by-side 2-column grid pairs (width: 6). Relabeled Section 1 & 2 headers and enable toggles. Clarified Section 4 Presence/Sleeping Override headers and switch guidance.
 *	v1.5.4	  09/02/26	  jshimota	  Purged JS-to-native test scaffolding and restored all matrix and override fields to standard native Hubitat number inputs. Split Category B into dedicated Section 4 (Overrides) and Section 5 (Safety Controls).
 *	v1.5.3	  09/02/26	  jshimota	  Purged invalid type: 'hidden' controls to eliminate 'Which?' UI entries. Implemented ChatGPT's JS-to-Native input bridge experiment on Morning setpoints while retaining valid native inputs across matrix.
...
def timeStamp() { return "2026/09/02 12:20 PM" }
...
def mainPage() {
    dynamicPage(name: "mainPage", title: "", install: true, uninstall: true) {
        ...
        /* Global App CSS Styling: Injects Vertical Divider Bars between Desktop Grid Inputs */
        paragraph "<style>.mdl-cell--3-col, .mdl-cell--6-col, .mdl-cell--4-col { border-right: 2px solid #BDC3C7 !important; padding-right: 12px !important; margin-right: 0px !important; box-sizing: border-box !important; } .mdl-cell--3-col:nth-of-type(4n), .mdl-cell--6-col:nth-of-type(2n) { border-right: none !important; }</style>"
        ...
        section("<b>SECTION 1: House HVAC Controller or Thermostat (Primary)</b>", hideable: true, hidden: true) {
            ...
            input name: "dev1AppEnabled", type: "bool", title: "<b>Enable House Controller/Thermostat Control</b>", defaultValue: true, submitOnChange: false
            ...
            paragraph "<table style='width:100%; border-collapse:collapse; margin-bottom:4px; font-size:13px; font-weight:bold; text-align:center; background-color:#2C3E50; color:#FFFFFF; border-radius:4px;'>" +
                      "<tr>" +
                      "<td style='width:25%; padding:8px; border-right:1px solid #555;'><span style='color:FireBrick;'>HEATING (°F)</span></td>" +
                      "<td style='width:25%; padding:8px; border-right:1px solid #555;'><span style='color:DodgerBlue;'>COOLING (°F)</span></td>" +
                      "<td style='width:25%; padding:8px; border-right:1px solid #555;'><span style='color:FireBrick;'>HEATING (°F)</span></td>" +
                      "<td style='width:25%; padding:8px;'><span style='color:DodgerBlue;'>COOLING (°F)</span></td>" +
                      "</tr></table>"

            // Clean 4-across inputs with vertical divider lines
            input name: "d1MorningHeat", type: "number", title: "<b>Morning</b>", defaultValue: 68, required: true, width: 3, submitOnChange: false
            input name: "d1MorningCool", type: "number", title: "<b>Morning</b>", defaultValue: 72, required: true, width: 3, submitOnChange: false
            input name: "d1DayHeat", type: "number", title: "<b>Day</b>", defaultValue: 66, required: true, width: 3, submitOnChange: false
            input name: "d1DayCool", type: "number", title: "<b>Day</b>", defaultValue: 75, required: true, width: 3, submitOnChange: false
            
            input name: "d1EveningHeat", type: "number", title: "<b>Evening</b>", defaultValue: 69, required: true, width: 3, submitOnChange: false
            input name: "d1EveningCool", type: "number", title: "<b>Evening</b>", defaultValue: 73, required: true, width: 3, submitOnChange: false
            input name: "d1NightHeat", type: "number", title: "<b>Night</b>", defaultValue: 64, required: true, width: 3, submitOnChange: false
        ...
        section("<b>SECTION 2: Office HVAC Controller or Thermostat (Secondary / Floor Heater)</b>", hideable: true, hidden: true) {
            paragraph "<div style='color:#555; font-size:12px; margin-bottom:8px;'>" +
            ...
            input name: "dev2AppEnabled", type: "bool", title: "<b>Enable Office Controller/Thermostat Control</b>", defaultValue: false, submitOnChange: false
            ...
            input name: "d2MorningHeat", type: "number", title: "<b>Morning</b>", defaultValue: 68, required: true, width: 3, submitOnChange: false
            input name: "d2MorningCool", type: "number", title: "<b>Morning</b>", defaultValue: 72, required: true, width: 3, submitOnChange: false
            input name: "d2DayHeat", type: "number", title: "<b>Day</b>", defaultValue: 66, required: true, width: 3, submitOnChange: false
            input name: "d2DayCool", type: "number", title: "<b>Day</b>", defaultValue: 75, required: true, width: 3, submitOnChange: false
            
            input name: "d2EveningHeat", type: "number", title: "<b>Evening</b>", defaultValue: 69, required: true, width: 3, submitOnChange: false
            input name: "d2EveningCool", type: "number", title: "<b>Evening</b>", defaultValue: 73, required: true, width: 3, submitOnChange: false
            input name: "d2NightHeat", type: "number", title: "<b>Night</b>", defaultValue: 62, required: true, width: 3, submitOnChange: false
        ...
        section("<b>SECTION 4: System Overrides (Presence & Sleeping Setpoints)</b>", hideable: true, hidden: true) {
            paragraph "<div style='color:#555; font-size:12px; margin-bottom:8px;'>" +
                      "Configure temperature setpoint overrides when Presence or Sleeping switches are active.</div>"
            ...
            input name: "awaySwitch", type: "capability.switch", title: "<b>Select Presence Switch</b>", required: false, multiple: false, submitOnChange: false
            paragraph "<div style='color:#666; font-size:11px; margin-top:-6px; margin-bottom:8px;'>" +
                      "<i>Detects Hub Presence, Home/Away mode switches, or virtual markers to activate presence target setpoints.</i></div>"
            ...
            // Header bar for Presence Target Setpoints
            paragraph "<table style='width:100%; border-collapse:collapse; margin:6px 0 4px 0; font-size:12px; font-weight:bold; text-align:center; background-color:#2C3E50; color:#FFFFFF; border-radius:4px;'>" +
                      "<tr>" +
                      "<td style='width:25%; padding:6px; border-right:1px solid #555;'><span style='color:FireBrick;'>HOUSE HEAT (°F)</span></td>" +
                      "<td style='width:25%; padding:6px; border-right:1px solid #555;'><span style='color:DodgerBlue;'>HOUSE COOL (°F)</span></td>" +
                      "<td style='width:25%; padding:6px; border-right:1px solid #555;'><span style='color:FireBrick;'>OFFICE HEAT (°F)</span></td>" +
                      "<td style='width:25%; padding:6px;'><span style='color:DodgerBlue;'>OFFICE COOL (°F)</span></td>" +
                      "</tr></table>"

            input name: "awayDev1Heat", type: "number", title: "<b>House Heat</b>", required: true, defaultValue: 62, width: 3
            input name: "awayDev1Cool", type: "number", title: "<b>House Cool</b>", required: true, defaultValue: 78, width: 3
            input name: "awayDev2Heat", type: "number", title: "<b>Office Heat</b>", required: true, defaultValue: 60, width: 3
            input name: "awayDev2Cool", type: "number", title: "<b>Office Cool</b>", required: true, defaultValue: 80, width: 3
            ...
            // Header bar for Sleeping Target Setpoints
            paragraph "<table style='width:100%; border-collapse:collapse; margin:6px 0 4px 0; font-size:12px; font-weight:bold; text-align:center; background-color:#2C3E50; color:#FFFFFF; border-radius:4px;'>" +
                      "<tr>" +
                      "<td style='width:25%; padding:6px; border-right:1px solid #555;'><span style='color:FireBrick;'>HOUSE HEAT (°F)</span></td>" +
                      "<td style='width:25%; padding:6px; border-right:1px solid #555;'><span style='color:DodgerBlue;'>HOUSE COOL (°F)</span></td>" +
            ...
            input name: "sleepDev1Heat", type: "number", title: "<b>House Heat</b>", required: true, defaultValue: 65, width: 3
            input name: "sleepDev1Cool", type: "number", title: "<b>House Cool</b>", required: true, defaultValue: 74, width: 3
            input name: "sleepDev2Heat", type: "number", title: "<b>Office Heat</b>", required: true, defaultValue: 62, width: 3
            input name: "sleepDev2Cool", type: "number", title: "<b>Office Cool</b>", required: true, defaultValue: 76, width: 3
        }
        ...
        section("<b>SECTION 6: Automatic Fan Circulation Control</b>", hideable: true, hidden: true) {
            ...
            paragraph "<div style='background-color:#F2F4F4; padding:6px; font-weight:bold; border-left:4px solid #2980B9; margin-top:10px; margin-bottom:6px;'>Standard Circulation Schedule</div>"
            input name: "fanOnMinutes", type: "number", title: "<b>Fan ON (Minutes)</b>", required: true, defaultValue: 10, width: 6
            input name: "fanOffMinutes", type: "number", title: "<b>Fan OFF / AUTO (Minutes)</b>", required: true, defaultValue: 50, width: 6
            
            paragraph "<div style='background-color:#F2F4F4; padding:6px; font-weight:bold; border-left:4px solid #8E44AD; margin-top:12px; margin-bottom:6px;'>Sleeping Mode Circulation Schedule</div>"
            input name: "fanSleepOnMinutes", type: "number", title: "<b>Sleeping Fan ON (Minutes)</b>", required: true, defaultValue: 5, width: 6
            input name: "fanSleepOffMinutes", type: "number", title: "<b>Sleeping Fan OFF / AUTO (Minutes)</b>", required: true, defaultValue: 115, width: 6
        }
        ...
        section("<b>SECTION 7: Air Quality Monitoring & RGB Indicator Light</b>", hideable: true, hidden: true) {
            ...
            input name: "aqiGoodMax", type: "number", title: "<b>Good Max</b>", required: true, defaultValue: 50, width: 3, submitOnChange: false
            input name: "aqiModMax", type: "number", title: "<b>Moderate Max</b>", required: true, defaultValue: 100, width: 3, submitOnChange: false
            input name: "aqiSensMax", type: "number", title: "<b>Sensitive Max</b>", required: true, defaultValue: 150, width: 3, submitOnChange: false
            input name: "aqiUnhealthyMax", type: "number", title: "<b>Unhealthy Max</b>", required: true, defaultValue: 200, width: 3, submitOnChange: false
            input name: "aqiVeryUnhealthyMax", type: "number", title: "<b>Very Unhealthy Max</b>", required: true, defaultValue: 300, width: 4, submitOnChange: false
        }
