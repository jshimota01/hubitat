...
def timeStamp() { return "2026/09/02 12:30 PM" }
    ...
    dynamicPage(name: "mainPage", title: "", install: true, uninstall: true) {
        ...
        section("<b>SECTION 1: House HVAC Controller or Thermostat (Primary)</b>", hideable: true, hidden: true) {
            ...
            paragraph "<table style='width:100%; border-collapse:collapse; margin-bottom:4px; font-size:13px; font-weight:bold; text-align:center; background-color:#2C3E50; color:#FFFFFF; border-radius:4px;'>" +
                      "<tr>" +
                      "<td style='width:50%; padding:8px; border-right:2px solid #FFFFFF;'><span style='color:#E74C3C;'>HEATING SETPOINT (°F)</span><br/><span style='font-size:10px; font-weight:normal; opacity:0.9;'>(Heat ON if &lt;)</span></td>" +
                      "<td style='width:50%; padding:8px;'><span style='color:DodgerBlue;'>COOLING SETPOINT (°F)</span><br/><span style='font-size:10px; font-weight:normal; opacity:0.9;'>(A/C ON if &gt;)</span></td>" +
                      "</tr></table>"

            input name: "d1MorningHeat", type: "number", title: "<b>Morning Heating</b>", defaultValue: 68, required: true, width: 6, submitOnChange: false
            input name: "d1MorningCool", type: "number", title: "<b>Morning Cooling</b>", defaultValue: 72, required: true, width: 6, submitOnChange: false
            
            input name: "d1DayHeat", type: "number", title: "<b>Day Heating</b>", defaultValue: 66, required: true, width: 6, submitOnChange: false
            input name: "d1DayCool", type: "number", title: "<b>Day Cooling</b>", defaultValue: 75, required: true, width: 6, submitOnChange: false
            
            input name: "d1EveningHeat", type: "number", title: "<b>Evening Heating</b>", defaultValue: 69, required: true, width: 6, submitOnChange: false
            input name: "d1EveningCool", type: "number", title: "<b>Evening Cooling</b>", defaultValue: 73, required: true, width: 6, submitOnChange: false
            
            input name: "d1NightHeat", type: "number", title: "<b>Night Heating</b>", defaultValue: 64, required: true, width: 6, submitOnChange: false
            input name: "d1NightCool", type: "number", title: "<b>Night Cooling</b>", defaultValue: 75, required: true, width: 6, submitOnChange: false
        }
        ...
        section("<b>SECTION 2: Office HVAC Controller or Thermostat (Secondary / Floor Heater)</b>", hideable: true, hidden: true) {
            ...
            input name: "d2MorningHeat", type: "number", title: "<b>Morning Heating</b>", defaultValue: 68, required: true, width: 6, submitOnChange: false
            input name: "d2MorningCool", type: "number", title: "<b>Morning Cooling</b>", defaultValue: 72, required: true, width: 6, submitOnChange: false
            
            input name: "d2DayHeat", type: "number", title: "<b>Day Heating</b>", defaultValue: 66, required: true, width: 6, submitOnChange: false
            input name: "d2DayCool", type: "number", title: "<b>Day Cooling</b>", defaultValue: 75, required: true, width: 6, submitOnChange: false
            
            input name: "d2EveningHeat", type: "number", title: "<b>Evening Heating</b>", defaultValue: 69, required: true, width: 6, submitOnChange: false
            input name: "d2EveningCool", type: "number", title: "<b>Evening Cooling</b>", defaultValue: 73, required: true, width: 6, submitOnChange: false
            
            input name: "d2NightHeat", type: "number", title: "<b>Night Heating</b>", defaultValue: 62, required: true, width: 6, submitOnChange: false
            input name: "d2NightCool", type: "number", title: "<b>Night Cooling</b>", defaultValue: 78, required: true, width: 6, submitOnChange: false
        }
        ...
        section("<b>SECTION 4: System Overrides (Presence & Sleeping Setpoints)</b>", hideable: true, hidden: true) {
            ...
            // Standard Header Bar for House Presence
            ...
            input name: "awayDev1Heat", type: "number", title: "<b>House Presence Heating</b>", required: true, defaultValue: 62, width: 6
            input name: "awayDev1Cool", type: "number", title: "<b>House Presence Cooling</b>", required: true, defaultValue: 78, width: 6

            // Standard Header Bar for Office Presence
            paragraph "<table style='width:100%; border-collapse:collapse; margin:8px 0 4px 0; font-size:12px; font-weight:bold; text-align:center; background-color:#2C3E50; color:#FFFFFF; border-radius:4px;'>" +
                      "<tr>" +
                      "<td style='width:50%; padding:6px; border-right:2px solid #FFFFFF;'><span style='color:#E74C3C;'>OFFICE HEATING (°F)</span><br/><span style='font-size:10px; font-weight:normal; opacity:0.9;'>(Heat ON if &lt;)</span></td>" +
                      "<td style='width:50%; padding:6px;'><span style='color:DodgerBlue;'>OFFICE COOLING (°F)</span><br/><span style='font-size:10px; font-weight:normal; opacity:0.9;'>(A/C ON if &gt;)</span></td>" +
                      "</tr></table>"

            input name: "awayDev2Heat", type: "number", title: "<b>Office Presence Heating</b>", required: true, defaultValue: 60, width: 6
            input name: "awayDev2Cool", type: "number", title: "<b>Office Presence Cooling</b>", required: true, defaultValue: 80, width: 6
            ...
            // Standard Header Bar for House Sleeping
            paragraph "<table style='width:100%; border-collapse:collapse; margin:8px 0 4px 0; font-size:12px; font-weight:bold; text-align:center; background-color:#2C3E50; color:#FFFFFF; border-radius:4px;'>" +
                      "<tr>" +
                      "<td style='width:50%; padding:6px; border-right:2px solid #FFFFFF;'><span style='color:#E74C3C;'>HOUSE HEATING (°F)</span><br/><span style='font-size:10px; font-weight:normal; opacity:0.9;'>(Heat ON if &lt;)</span></td>" +
                      "<td style='width:50%; padding:6px;'><span style='color:DodgerBlue;'>HOUSE COOLING (°F)</span><br/><span style='font-size:10px; font-weight:normal; opacity:0.9;'>(A/C ON if &gt;)</span></td>" +
            ...
            input name: "sleepDev1Heat", type: "number", title: "<b>House Sleeping Heating</b>", required: true, defaultValue: 65, width: 6
            input name: "sleepDev1Cool", type: "number", title: "<b>House Sleeping Cooling</b>", required: true, defaultValue: 74, width: 6

            // Standard Header Bar for Office Sleeping
            paragraph "<table style='width:100%; border-collapse:collapse; margin:8px 0 4px 0; font-size:12px; font-weight:bold; text-align:center; background-color:#2C3E50; color:#FFFFFF; border-radius:4px;'>" +
                      "<tr>" +
                      "<td style='width:50%; padding:6px; border-right:2px solid #FFFFFF;'><span style='color:#E74C3C;'>OFFICE HEATING (°F)</span><br/><span style='font-size:10px; font-weight:normal; opacity:0.9;'>(Heat ON if &lt;)</span></td>" +
                      "<td style='width:50%; padding:6px;'><span style='color:DodgerBlue;'>OFFICE COOLING (°F)</span><br/><span style='font-size:10px; font-weight:normal; opacity:0.9;'>(A/C ON if &gt;)</span></td>" +
            ...
            input name: "sleepDev2Heat", type: "number", title: "<b>Office Sleeping Heating</b>", required: true, defaultValue: 62, width: 6
            input name: "sleepDev2Cool", type: "number", title: "<b>Office Sleeping Cooling</b>", required: true, defaultValue: 76, width: 6
        }
        ...
        section("<b>SECTION 7: Air Quality Monitoring & RGB Indicator Light</b>", hideable: true, hidden: true) {
            ...
            input name: "aqiGoodMax", type: "number", title: "<b>Good Max</b>", required: true, defaultValue: 50, width: 6, submitOnChange: false
            input name: "aqiModMax", type: "number", title: "<b>Moderate Max</b>", required: true, defaultValue: 100, width: 6, submitOnChange: false
            input name: "aqiSensMax", type: "number", title: "<b>Sensitive Max</b>", required: true, defaultValue: 150, width: 6, submitOnChange: false
