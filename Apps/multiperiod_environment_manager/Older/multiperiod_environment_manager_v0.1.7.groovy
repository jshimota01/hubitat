 ...
 *      2026-08-05    Gemini        0.1.7       Fixed UnknownDeviceTypeException by switching child device type to 'Virtual Tile'
 */
...
def evaluateAirQuality() {
    ...
    // Fallback if one sensor is temporarily unreachable
...
private void ensureChildDevice() {
    ...
    if (!child) {
        ...
        addChildDevice("hubitat", "Virtual Tile", childDni, [
