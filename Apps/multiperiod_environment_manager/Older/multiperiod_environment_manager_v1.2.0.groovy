...
def timeStamp() { return "2026/08/31 05:25 PM" }
...
def mainPage() {
    dynamicPage(name: "mainPage", title: "", install: true, uninstall: true) {
        ...
        section("<b>SECTION 4: Simulated Fan Circulation Control</b>", hideable: true, hidden: isCollapsed) {
            paragraph "<div style='color:#555; font-size:12px; margin-bottom:8px;'>" +
                      "Cycles the thermostat fan between <b>ON</b> and <b>AUTO</b> to simulate dynamic air circulation throughout the home. <i>(Recommended: Set target thermostat Fan Mode to <b>Ext</b>)</i>.</div>"
...
/**
 * Manages simulated thermostat fan circulation loops between ON and AUTO/EXT modes.
 */
    ...
    try {
        if (executeOnPhase) {
            ...
            if (opState != "heating" && opState != "cooling") {
                if (thermostat.fan != "auto" && thermostat.fan != "ext") {
            ...
            if (issuedAutoCommand || thermostat.fan == "auto" || thermostat.fan == "ext") {
                sendIfChangedStateValue("fanOwned", false)
            } else {
