 ...
 *        heat/cool mode changeover, and dashboard tile output.
 ...
 *
 *  Changelog:
 *	v1.3.1	  09/01/26	  jshimota	  Replaced 'Device 1 / Device 2' GUI labels with 'House HVAC Controller' and 'Office HVAC Controller'. Converted hysteresis buffers to HTML spinner controls. Added colorized schedule summary tables.
...
def timeStamp() { return "2026/09/01 09:55 AM" }
...
def mainPage() {
    dynamicPage(name: "mainPage", title: "", install: true, uninstall: true) {
        ...
        section() {
            ...
            String houseBadge = dev1AppEnabled ? "<span style='color:#27AE60; font-weight:bold;'>HOUSE ENABLED</span>" : "<span style='color:#C0392B; font-weight:bold;'>HOUSE DISABLED</span>"
            String officeBadge = dev2AppEnabled ? "<span style='color:#27AE60; font-weight:bold;'>OFFICE ENABLED</span>" : "<span style='color:#C0392B; font-weight:bold;'>OFFICE DISABLED</span>"
        ...
        section("<b>SECTION 1: House HVAC Controller (Primary)</b>", hideable: true, hidden: true) {
            ...
            input name: "dev1AppEnabled", type: "bool", title: "<b>Enable Automated Setpoint Scheduling (House HVAC)</b>", defaultValue: true, submitOnChange: true
            input name: "targetThermostat", type: "capability.thermostat", title: "<b>Select House HVAC Controller Device</b>", required: true, multiple: false, submitOnChange: true
            
            paragraph "<hr style='border:0; border-top:1px solid #E0E0E0; margin:8px 0;'/>"
            
            input name: "dev1AutoChangeoverEnabled", type: "bool", title: "<b>Enable Automated System Mode Changeover (House HVAC)</b>", defaultValue: true, submitOnChange: true
            if (dev1AutoChangeoverEnabled) {
                paragraph "<b>House Temperature Hysteresis Buffer (°F):</b><br/><input type='number' name='dev1TempDeadband' min='1' max='10' step='1' value='${dev1TempDeadband ?: 2}' style='width:70px; padding:4px; font-size:14px; border:1px solid #ccc; border-radius:4px;'/> <i>(Degree offset required beyond opposing setpoint before triggering mode change)</i>"
            }

            paragraph "<hr style='border:0; border-top:1px solid #E0E0E0; margin:8px 0;'/>"
            paragraph "<span style='color:#2C3E50; font-weight:bold; font-size:13px;'>House HVAC Schedule Summary</span>"
            
            // Colorized Schedule Summary Table
            ...
            houseTable.append("<th style='padding:6px;'>Time Period</th><th style='padding:6px; color:#2980B9;'>High Target (Cooling)</th><th style='padding:6px; color:#C0392B;'>Low Target (Heating)</th>")
            houseTable.append("</tr>")
            houseTable.append("<tr style='border-bottom:1px solid #E0E0E0;'><td style='padding:6px;'><b>Morning</b></td><td style='padding:6px; color:#2980B9; font-weight:bold;'>").append(d1MorningCool ?: 72).append("°F</td><td style='padding:6px; color:#C0392B; font-weight:bold;'>").append(d1MorningHeat ?: 68).append("°F</td></tr>")
            houseTable.append("<tr style='border-bottom:1px solid #E0E0E0;'><td style='padding:6px;'><b>Day</b></td><td style='padding:6px; color:#2980B9; font-weight:bold;'>").append(d1DayCool ?: 75).append("°F</td><td style='padding:6px; color:#C0392B; font-weight:bold;'>").append(d1DayHeat ?: 66).append("°F</td></tr>")
            houseTable.append("<tr style='border-bottom:1px solid #E0E0E0;'><td style='padding:6px;'><b>Evening</b></td><td style='padding:6px; color:#2980B9; font-weight:bold;'>").append(d1EveningCool ?: 73).append("°F</td><td style='padding:6px; color:#C0392B; font-weight:bold;'>").append(d1EveningHeat ?: 69).append("°F</td></tr>")
            houseTable.append("<tr style='border-bottom:1px solid #E0E0E0;'><td style='padding:6px;'><b>Night</b></td><td style='padding:6px; color:#2980B9; font-weight:bold;'>").append(d1NightCool ?: 75).append("°F</td><td style='padding:6px; color:#C0392B; font-weight:bold;'>").append(d1NightHeat ?: 64).append("°F</td></tr>")
        ...
        section("<b>SECTION 2: Office HVAC Controller (Secondary / Floor Heater)</b>", hideable: true, hidden: true) {
            ...
            input name: "dev2AppEnabled", type: "bool", title: "<b>Enable Automated Setpoint Scheduling (Office HVAC)</b>", defaultValue: false, submitOnChange: true
            if (dev2AppEnabled) {
                input name: "targetThermostat2", type: "capability.thermostat", title: "<b>Select Office HVAC Controller Device</b>", required: true, multiple: false, submitOnChange: true
                
                paragraph "<hr style='border:0; border-top:1px solid #E0E0E0; margin:8px 0;'/>"
                
                input name: "dev2AutoChangeoverEnabled", type: "bool", title: "<b>Enable Automated System Mode Changeover (Office HVAC)</b>", defaultValue: false, submitOnChange: true
                if (dev2AutoChangeoverEnabled) {
                    paragraph "<b>Office Temperature Hysteresis Buffer (°F):</b><br/><input type='number' name='dev2TempDeadband' min='1' max='10' step='1' value='${dev2TempDeadband ?: 2}' style='width:70px; padding:4px; font-size:14px; border:1px solid #ccc; border-radius:4px;'/> <i>(Degree offset required beyond opposing setpoint before triggering mode change)</i>"
                }

                paragraph "<hr style='border:0; border-top:1px solid #E0E0E0; margin:8px 0;'/>"
                paragraph "<span style='color:#2C3E50; font-weight:bold; font-size:13px;'>Office HVAC Schedule Summary</span>"
                ...
                officeTable.append("<th style='padding:6px;'>Time Period</th><th style='padding:6px; color:#2980B9;'>High Target (Cooling)</th><th style='padding:6px; color:#C0392B;'>Low Target (Heating)</th>")
                officeTable.append("</tr>")
                officeTable.append("<tr style='border-bottom:1px solid #E0E0E0;'><td style='padding:6px;'><b>Morning</b></td><td style='padding:6px; color:#2980B9; font-weight:bold;'>").append(d2MorningCool ?: 72).append("°F</td><td style='padding:6px; color:#C0392B; font-weight:bold;'>").append(d2MorningHeat ?: 68).append("°F</td></tr>")
                officeTable.append("<tr style='border-bottom:1px solid #E0E0E0;'><td style='padding:6px;'><b>Day</b></td><td style='padding:6px; color:#2980B9; font-weight:bold;'>").append(d2DayCool ?: 75).append("°F</td><td style='padding:6px; color:#C0392B; font-weight:bold;'>").append(d2DayHeat ?: 66).append("°F</td></tr>")
                officeTable.append("<tr style='border-bottom:1px solid #E0E0E0;'><td style='padding:6px;'><b>Evening</b></td><td style='padding:6px; color:#2980B9; font-weight:bold;'>").append(d2EveningCool ?: 73).append("°F</td><td style='padding:6px; color:#C0392B; font-weight:bold;'>").append(d2EveningHeat ?: 69).append("°F</td></tr>")
                officeTable.append("<tr style='border-bottom:1px solid #E0E0E0;'><td style='padding:6px;'><b>Night</b></td><td style='padding:6px; color:#2980B9; font-weight:bold;'>").append(d2NightCool ?: 78).append("°F</td><td style='padding:6px; color:#C0392B; font-weight:bold;'>").append(d2NightHeat ?: 62).append("°F</td></tr>")
        ...
        section("<b>SECTION 4: System Overrides & Fire Hazard Safety Controls</b>", hideable: true, hidden: true) {
            ...
            if (awaySwitch) {
                ...
                input name: "awayDev2Action", type: "enum", title: "Office HVAC Away Mode Action", options: ["setpoint": "Use Away Setpoints", "off": "FORCE OFF (Fire Hazard Safety)"], defaultValue: "off", submitOnChange: true
            ...
            if (sleepSwitch) {
                ...
                input name: "sleepDev2Action", type: "enum", title: "Office HVAC Sleeping Mode Action", options: ["setpoint": "Use Sleeping Setpoints", "off": "FORCE OFF (Fire Hazard Safety)"], defaultValue: "off", submitOnChange: true
        ...
        section("<b>SECTION 5: Automatic Fan Circulation Control</b>", hideable: true, hidden: true) {
            ...
            input name: "fanCirculateEnabled", type: "bool", title: "<b>Enable Fan Circulation Loop (House HVAC)</b>", defaultValue: false, submitOnChange: true
...
private Map validateConfiguration() {
    ...
    if (dev1AppEnabled && !targetThermostat) errors.add("House HVAC Controller device is required when House scheduling is enabled.")
    if (dev2AppEnabled && !targetThermostat2) errors.add("Office HVAC Controller device is required when Office scheduling is enabled.")
