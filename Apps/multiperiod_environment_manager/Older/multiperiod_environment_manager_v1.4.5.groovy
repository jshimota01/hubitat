 ...
 *        heat/cool mode changeover, Smart Table boundary time pickers, and dashboard tile output.
...
def timeStamp() { return "2026/09/01 01:15 PM" }
...
def mainPage() {
    dynamicPage(name: "mainPage", title: "", install: true, uninstall: true) {
        ...
        /* Section 3: Smart Table Boundary Time Pickers (Mode Manager Advanced Pattern) */
