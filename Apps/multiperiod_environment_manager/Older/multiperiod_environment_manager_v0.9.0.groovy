 ...
 */
static String version() { return '0.9.0' }
...
def mainPage() {
    dynamicPage(name: "mainPage", title: "Multiperiod Environment Manager Setup v${version()}", install: true, uninstall: true) {
        ...
        section("<b>Air Quality Monitoring & RGB Indicator</b>") {
            paragraph "Monitors AQI sensors and averages their airQualityIndex attributes. IF RGB light is selected, will represent AQI with standard 6-tier EPA colors (Active strictly during 'Home' or 'Awake' modes, turned OFF during Good AQI):"[cite: 1]
            
            // Validate threshold inputs before rendering table
            Boolean isAqiValid = validateAqiThresholds()[cite: 1]
            if (!isAqiValid && aqiEnabled) {
                paragraph "<div style='color:red; background-color:#ffe6e6; padding:8px; border:1px solid red; border-radius:4px;'><b>CONFIGURATION ERROR:</b> AQI Thresholds must be in strictly ascending order (0 &lt; Good &lt; Moderate &lt; Sensitive &lt; Unhealthy &lt; Very Unhealthy). Standard defaults will be applied until corrected.</div>"[cite: 1]
            }

            Map limits = getAqiTierLimits()[cite: 1]
            Integer tGoodMax = limits.good[cite: 1]
            Integer tModMax = limits.mod[cite: 1]
            Integer tSensMax = limits.sens[cite: 1]
            Integer tUnhealthMax = limits.unhealthy[cite: 1]
            Integer tVeryUnhealthMax = limits.veryUnhealthy[cite: 1]

            // 6-Tier AQI Color & Health Impact Table Display
            StringBuilder colorTableSb = new StringBuilder()[cite: 1]
            colorTableSb.append("<table style='width:100%; border-collapse:collapse; font-size:12px; margin-bottom:10px; text-align:left;'>")[cite: 1]
                       .append("<tr style='background-color:#f2f2f2; border-bottom:1px solid #ccc;'>")[cite: 1]
                       .append("<th style='padding:4px;'>AQI Range</th><th style='padding:4px;'>Level of Concern</th><th style='padding:4px;'>Color</th><th style='padding:4px;'>Health Impact & Actions</th>")[cite: 1]
                       .append("</tr>")[cite: 1]
                       .append("<tr style='border-bottom:1px solid #eee;'>")[cite: 1]
                       .append("<td style='padding:4px;'>0 – ").append(tGoodMax).append("</td><td style='padding:4px; color:green;'><b>Good (Normal)</b></td><td style='padding:4px;'>⚪ OFF</td><td style='padding:4px;'>Satisfactory air quality. Little to no risk.</td>")[cite: 1]
                       .append("</tr>")[cite: 1]
                       .append("<tr style='border-bottom:1px solid #eee;'>")[cite: 1]
                       .append("<td style='padding:4px;'>").append(tGoodMax + 1).append(" – ").append(tModMax).append("</td><td style='padding:4px; color:#b8860b;'><b>Moderate</b></td><td style='padding:4px;'>🟡 Yellow</td><td style='padding:4px;'>Acceptable. Sensitive groups may feel minor symptoms.</td>")[cite: 1]
                       .append("</tr>")[cite: 1]
                       .append("<tr style='border-bottom:1px solid #eee;'>")[cite: 1]
                       .append("<td style='padding:4px;'>").append(tModMax + 1).append(" – ").append(tSensMax).append("</td><td style='padding:4px; color:orange;'><b>Sensitive Groups</b></td><td style='padding:4px;'>🟠 Orange</td><td style='padding:4px;'>Potentially harmful for kids, elderly, and asthmatics.</td>")[cite: 1]
                       .append("</tr>")[cite: 1]
                       .append("<tr style='border-bottom:1px solid #eee;'>")[cite: 1]
                       .append("<td style='padding:4px;'>").append(tSensMax + 1).append(" – ").append(tUnhealthMax).append("</td><td style='padding:4px; color:red;'><b>Unhealthy</b></td><td style='padding:4px;'>🔴 Red</td><td style='padding:4px;'>Active danger. Everyone may experience adverse effects.</td>")[cite: 1]
                       .append("</tr>")[cite: 1]
                       .append("<tr style='border-bottom:1px solid #eee;'>")[cite: 1]
                       .append("<td style='padding:4px;'>").append(tUnhealthMax + 1).append(" – ").append(tVeryUnhealthMax).append("</td><td style='padding:4px; color:purple;'><b>Very Unhealthy</b></td><td style='padding:4px;'>🟣 Purple</td><td style='padding:4px;'>Health alert. High risk of respiratory irritation.</td>")[cite: 1]
                       .append("</tr>")[cite: 1]
                       .append("<tr>")[cite: 1]
                       .append("<td style='padding:4px;'>&ge; ").append(tVeryUnhealthMax + 1).append("</td><td style='padding:4px; color:maroon;'><b>Hazardous</b></td><td style='padding:4px;'>🟤 Maroon</td><td style='padding:4px;'>Emergency conditions. Stay entirely indoors.</td>")[cite: 1]
                       .append("</tr>")[cite: 1]
                       .append("</table>")[cite: 1]
            paragraph colorTableSb.toString()[cite: 1]

            input name: "aqiEnabled", type: "bool", title: "Enable Air Quality Monitoring", defaultValue: false, submitOnChange: true[cite: 1]
            if (aqiEnabled) {
                input name: "aqiSensor1", type: "capability.airQuality", title: "Select Primary AQI Sensor", required: true, multiple: false, submitOnChange: true[cite: 1]
                ...
                input name: "rgbLight", type: "capability.colorControl", title: "Select Indicator RGB Light", required: false, multiple: false[cite: 1]
                
                paragraph "<b>Configure AQI Tier Threshold Overrides (Upper Boundaries)</b>"[cite: 1]
                input name: "aqiGoodMax", type: "number", title: "Good AQI Max (Default: 50)", required: true, defaultValue: 50, submitOnChange: true[cite: 1]
                input name: "aqiModMax", type: "number", title: "Moderate AQI Max (Default: 100)", required: true, defaultValue: 100, submitOnChange: true[cite: 1]
                input name: "aqiSensMax", type: "number", title: "Sensitive Groups Max (Default: 150)", required: true, defaultValue: 150, submitOnChange: true[cite: 1]
                input name: "aqiUnhealthyMax", type: "number", title: "Unhealthy Max (Default: 200)", required: true, defaultValue: 200, submitOnChange: true[cite: 1]
                input name: "aqiVeryUnhealthyMax", type: "number", title: "Very Unhealthy Max (Default: 300)", required: true, defaultValue: 300, submitOnChange: true[cite: 1]
            }
        }
        ...
        section("<b>Room Air Filter Control</b>") {
            ...
            StringBuilder aqiTableSb = new StringBuilder()[cite: 1]
            aqiTableSb.append("<table style='width:100%; border-collapse:collapse; font-size:12px; margin-bottom:10px; text-align:left;'>")[cite: 1]
                     .append("<tr style='background-color:#f2f2f2; border-bottom:1px solid #ccc;'>")[cite: 1]
                     .append("<th style='padding:4px;'>AQI Range</th><th style='padding:4px;'>Level of Concern</th><th style='padding:4px;'>Indicator Light</th><th style='padding:4px;'>Room Air Filter State</th>")[cite: 1]
                     .append("</tr>")[cite: 1]
                     .append("<tr style='border-bottom:1px solid #eee;'>")[cite: 1]
                     .append("<td style='padding:4px;'>0 – ").append(tGoodMax).append("</td><td style='padding:4px; color:green;'><b>Good (Normal)</b></td><td style='padding:4px;'>⚪ OFF</td><td style='padding:4px;'>OFF</td>")[cite: 1]
                     .append("</tr>")[cite: 1]
                     .append("<tr style='border-bottom:1px solid #eee;'>")[cite: 1]
                     .append("<td style='padding:4px;'>").append(tGoodMax + 1).append(" – ").append(tModMax).append("</td><td style='padding:4px; color:#b8860b;'><b>Moderate</b></td><td style='padding:4px;'>🟡 Yellow</td><td style='padding:4px; color:green;'><b>ON</b></td>")[cite: 1]
                     .append("</tr>")[cite: 1]
                     .append("<tr style='border-bottom:1px solid #eee;'>")[cite: 1]
                     .append("<td style='padding:4px;'>").append(tModMax + 1).append(" – ").append(tSensMax).append("</td><td style='padding:4px; color:orange;'><b>Sensitive Groups</b></td><td style='padding:4px;'>🟠 Orange</td><td style='padding:4px; color:green;'><b>ON</b></td>")[cite: 1]
                     .append("</tr>")[cite: 1]
                     .append("<tr style='border-bottom:1px solid #eee;'>")[cite: 1]
                     .append("<td style='padding:4px;'>").append(tSensMax + 1).append(" – ").append(tUnhealthMax).append("</td><td style='padding:4px; color:red;'><b>Unhealthy</b></td><td style='padding:4px;'>🔴 Red</td><td style='padding:4px; color:green;'><b>ON</b></td>")[cite: 1]
                     .append("</tr>")[cite: 1]
                     .append("<tr style='border-bottom:1px solid #eee;'>")[cite: 1]
                     .append("<td style='padding:4px;'>").append(tUnhealthMax + 1).append(" – ").append(tVeryUnhealthyMax).append("</td><td style='padding:4px; color:purple;'><b>Very Unhealthy</b></td><td style='padding:4px;'>🟣 Purple</td><td style='padding:4px; color:green;'><b>ON</b></td>")[cite: 1]
                     .append("</tr>")[cite: 1]
                     .append("<tr>")[cite: 1]
                     .append("<td style='padding:4px;'>&ge; ").append(tVeryUnhealthyMax + 1).append("</td><td style='padding:4px; color:maroon;'><b>Hazardous</b></td><td style='padding:4px;'>🟤 Maroon</td><td style='padding:4px; color:green;'><b>ON</b></td>")[cite: 1]
                     .append("</tr>")[cite: 1]
                     .append("</table>")[cite: 1]
            paragraph aqiTableSb.toString()[cite: 1]

            input name: "airFilterEnabled", type: "bool", title: "Enable Automated Room Air Filter Control", defaultValue: true, submitOnChange: true[cite: 1]
            if (airFilterEnabled) {
                input name: "airFilterSwitch", type: "capability.switch", title: "Select Room Air Filter Switch/Device", required: true, multiple: false, submitOnChange: true[cite: 1]
            }
        }
...
def executeEvaluationPass(String cause = "Manual / Scheduled") {
    ...
    // STEP 2: DISPATCH THERMOSTAT SETPOINTS
    ...
    if (sched.targetHeat != null && sched.targetCool != null && targetThermostat) {
        applySetpoints(sched.targetHeat as BigDecimal, sched.targetCool as BigDecimal)
    }
    ...
    if (child) {
        String tileHtml = buildTileHtml(context)
 ...
 */
private void applySetpoints(BigDecimal heat, BigDecimal cool) {
    if (!targetThermostat || heat == null || cool == null) return
    Map thermostat = getThermostatStateSnapshot()
    BigDecimal currentHeatSp = safeToDecimal(thermostat.heat)
    BigDecimal currentCoolSp = safeToDecimal(thermostat.cool)
...
private Map determineStatus(Object avgAqiVal) {
    ...
    } else if (avgAqi <= limits.unhealthy) {
    ...
    } else if (avgAqi <= limits.veryUnhealthy) {
...
private Map buildEvaluationContext(Integer overrideAvgAqi = null, String filterOverride = null) {
    ...
    if (calculatedAqi == null && aqiEnabled && (aqiSensor1 || aqiSensor2)) {
        Map rawVals = readSensors()
        calculatedAqi = calculateAverage(rawVals.v1, rawVals.v2)
    }
...
private void updateTile(Integer currentAvgAqi = null, String filterStateOverride = null) {
    def child = getChildDevice("MEM_TILE_${app.id}")
    if (!child) return

    Map ctx = buildEvaluationContext(currentAvgAqi, filterStateOverride)
...
private Map validateConfiguration() {
    ...
    List periods = [
        [name: "Morning", heat: morningHeat, cool: morningCool, defH: 68.0, defC: 72.0],
        [name: "Day", heat: dayHeat, cool: dayCool, defH: 66.0, defC: 75.0],
        [name: "Evening", heat: eveningHeat, cool: eveningCool, defH: 69.0, defC: 73.0],
        [name: "Night", heat: nightHeat, cool: nightCool, defH: 64.0, defC: 75.0]
    ]
    ...
    if (aqiEnabled) {
        ...
        if (!validateAqiThresholds()) errors.add("AQI Tier Thresholds must be non-negative and strictly ascending (Good < Mod < Sens < Unhealthy < VeryUnhealthy).")
    }
