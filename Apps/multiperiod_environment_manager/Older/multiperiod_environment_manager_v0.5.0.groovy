 ...
 *      dynamic fan circulation, AQI Air Quality monitoring, independent Air Filter control, and 
 *      dashboard tile output.
 *
...
// =================================================================================================
// 1. INITIALIZATION & LIFECYCLE ENGINE
// =================================================================================================
...
/**
 * Queries the target thermostat once and returns a snapshot map of key operational attributes.
 * @return Map containing heatingSetpoint, coolingSetpoint, thermostatMode, thermostatFanMode, thermostatOperatingState.
 */
...
/**
 * Reads raw air quality attributes from configured sensors.
...
/**
 * Evaluates an average AQI integer against configured thresholds and returns status data.
 * @param avgAqiVal Integer average AQI value.
 * @return Map containing status label string, RGB colorMap, and filterOn boolean flag.
 */
...
/**
 * Applies color map settings to configured indicator RGB light device.
...
/**
 * Evaluates air quality sensors, updates indicator light colors, controls air filter switch, and updates tile display.
...
/**
 * Toggles the room air filter switch device based on calculated AQI action flags.
...
/**
 * Ensures child MEM Dashboard Tile device is created under app instance.
 */
...
/**
 * Generates and updates HTML tile attribute on child tile device using deduplicated sendIfChangedAttributeValue.
