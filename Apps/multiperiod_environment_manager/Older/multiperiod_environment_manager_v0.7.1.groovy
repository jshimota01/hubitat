...
def mainPage() {
    dynamicPage(name: "mainPage", title: "Multiperiod Environment Manager Setup v${version()}", install: true, uninstall: true) {
        ...
        section("<b>Air Quality Monitoring & RGB Indicator</b>") {
            paragraph "Monitors two airQuality sensors and averages their airQualityIndex attributes. IF RGB light is selected, will represent AQI with standard 6-tier EPA colors:"
            ...
            colorTableSb.append("<table style='width:100%; border-collapse:collapse; font-size:12px; margin-bottom:10px; text-align:left;'>")
                       ...
                       .append("<td style='padding:4px;'>0 – ").append(tGoodMax).append("</td><td style='padding:4px; color:green;'><b>Good (Normal)</b></td><td style='padding:4px;'>🟢 Green</td><td style='padding:4px;'>Satisfactory air quality. Little to no risk.</td>")
                       .append("</tr>")
                       .append("<tr style='border-bottom:1px solid #eee;'>")
        ...
        section("<b>Room Air Filter Control</b>") {
            ...
            aqiTableSb.append("<table style='width:100%; border-collapse:collapse; font-size:12px; margin-bottom:10px; text-align:left;'>")
                     ...
                     .append("</tr>")
                     .append("<tr style='border-bottom:1px solid #eee;'>")
                     .append("<td style='padding:4px;'>0 – ").append(tGoodMax).append("</td><td style='padding:4px; color:green;'><b>Good (Normal)</b></td><td style='padding:4px;'>🟢 Green</td><td style='padding:4px;'>OFF</td>")
                     .append("</tr>")
                     .append("<tr style='border-bottom:1px solid #eee;'>")
...
private Map determineStatus(Object avgAqiVal) {
    if (avgAqiVal == null || !(avgAqiVal instanceof Integer)) {
        return [status: "Not Evaluated", colorMap: [:], actionText: "N/A", filterOn: false]
    }
...
/**
 * Applies color map settings to configured indicator RGB light device. Action Routine.
 * @param colorMap Map containing hue, saturation, and level properties.
 */
