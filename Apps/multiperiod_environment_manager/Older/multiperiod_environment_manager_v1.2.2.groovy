...
def timeStamp() { return "2026/08/31 09:45 PM" }
...
void updated() {
    ...
    // Clean up previous target device ownership before updating
    if (state.previousThermostatDni && targetThermostat && state.previousThermostatDni != targetThermostat.deviceNetworkId) {
        logInfo "Thermostat selection changed. Releasing ownership on previous target device..."
