...
static String version() { return '1.4.7' }
def timeStamp() { return "2026/09/01 01:55 PM" }
...
def mainPage() {
    dynamicPage(name: "mainPage", title: "", install: true, uninstall: true) {
        ...
        section("<b>SECTION 1: House HVAC Controller (Primary)</b>", hideable: true, hidden: true) {
            ...
            // Native Persisted Groovy Form Controls for House Setpoints
            paragraph "<div style='background-color:#F2F4F4; padding:6px; font-weight:bold; border-bottom:2px solid #2C3E50;'>House HVAC Period Setpoint Matrix</div>"
            
            input name: "d1MorningCool", type: "number", title: "<b>Morning Cool (°F)</b> <i>(if temp exceeds)</i>", defaultValue: 72, required: true, width: 6
            input name: "d1MorningHeat", type: "number", title: "<b>Morning Heat (°F)</b> <i>(if temp falls below)</i>", defaultValue: 68, required: true, width: 6
            
            input name: "d1DayCool", type: "number", title: "<b>Day Cool (°F)</b> <i>(if temp exceeds)</i>", defaultValue: 75, required: true, width: 6
            input name: "d1DayHeat", type: "number", title: "<b>Day Heat (°F)</b> <i>(if temp falls below)</i>", defaultValue: 66, required: true, width: 6
            
            input name: "d1EveningCool", type: "number", title: "<b>Evening Cool (°F)</b> <i>(if temp exceeds)</i>", defaultValue: 73, required: true, width: 6
            input name: "d1EveningHeat", type: "number", title: "<b>Evening Heat (°F)</b> <i>(if temp falls below)</i>", defaultValue: 69, required: true, width: 6
            
            input name: "d1NightCool", type: "number", title: "<b>Night Cool (°F)</b> <i>(if temp exceeds)</i>", defaultValue: 75, required: true, width: 6
            input name: "d1NightHeat", type: "number", title: "<b>Night Heat (°F)</b> <i>(if temp falls below)</i>", defaultValue: 64, required: true, width: 6
        }
        ...
        section("<b>SECTION 2: Office HVAC Controller (Secondary / Floor Heater)</b>", hideable: true, hidden: true) {
            ...
            // Native Persisted Groovy Form Controls for Office Setpoints
            paragraph "<div style='background-color:#F2F4F4; padding:6px; font-weight:bold; border-bottom:2px solid #2C3E50;'>Office HVAC Period Setpoint Matrix</div>"
            
            input name: "d2MorningCool", type: "number", title: "<b>Morning Cool (°F)</b> <i>(if temp exceeds)</i>", defaultValue: 72, required: true, width: 6
            input name: "d2MorningHeat", type: "number", title: "<b>Morning Heat (°F)</b> <i>(if temp falls below)</i>", defaultValue: 68, required: true, width: 6
            
            input name: "d2DayCool", type: "number", title: "<b>Day Cool (°F)</b> <i>(if temp exceeds)</i>", defaultValue: 75, required: true, width: 6
            input name: "d2DayHeat", type: "number", title: "<b>Day Heat (°F)</b> <i>(if temp falls below)</i>", defaultValue: 66, required: true, width: 6
            
            input name: "d2EveningCool", type: "number", title: "<b>Evening Cool (°F)</b> <i>(if temp exceeds)</i>", defaultValue: 73, required: true, width: 6
            input name: "d2EveningHeat", type: "number", title: "<b>Evening Heat (°F)</b> <i>(if temp falls below)</i>", defaultValue: 69, required: true, width: 6
            
            input name: "d2NightCool", type: "number", title: "<b>Night Cool (°F)</b> <i>(if temp exceeds)</i>", defaultValue: 78, required: true, width: 6
            input name: "d2NightHeat", type: "number", title: "<b>Night Heat (°F)</b> <i>(if temp falls below)</i>", defaultValue: 62, required: true, width: 6
        }
