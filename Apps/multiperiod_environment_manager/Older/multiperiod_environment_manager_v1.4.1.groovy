 ...
 *
 *  Changelog:
 *	v1.4.1	  09/01/26	  jshimota	  Decoupled enable switches from section collapse routines. Clarified Mode Changeover guidance. Renamed schedule section headers to 'Setpoints for Periods'. Updated table headers strictly to 'Cooling (°F)' and 'Heating (°F)'.
...
def timeStamp() { return "2026/09/01 11:15 AM" }
...
def mainPage() {
    dynamicPage(name: "mainPage", title: "", install: true, uninstall: true) {
        ...
        section("<b>SECTION 1: House HVAC Controller (Primary)</b>", hideable: true, hidden: true) {
            ...
            input name: "dev1AppEnabled", type: "bool", title: "<b>Enable Home Thermostat</b>", defaultValue: true, submitOnChange: false
            ...
            input name: "dev1AutoChangeoverEnabled", type: "bool", title: "<b>Enable Automatic Mode Changeover (Heat / Cool Switch)</b>", defaultValue: true, submitOnChange: true
            ...
            // Active Interactive Schedule Table
            ...
            houseTable.append("<th style='padding:6px;'>Time Period</th><th style='padding:6px; color:#2980B9;'>Cooling (°F)</th><th style='padding:6px; color:#C0392B;'>Heating (°F)</th>")
            houseTable.append("</tr>")
            
            // Morning
            houseTable.append("<tr style='border-bottom:1px solid #E0E0E0;'><td style='padding:6px;'><b>Morning</b></td>")
            houseTable.append("<td style='padding:6px;'><input type='number' name='d1MorningCool' min='50' max='90' step='1' value='${d1MorningCool ?: 72}' style='${spinnerStyle}'/></td>")
            houseTable.append("<td style='padding:6px;'><input type='number' name='d1MorningHeat' min='50' max='90' step='1' value='${d1MorningHeat ?: 68}' style='${spinnerStyle}'/></td></tr>")
            
            // Day
            houseTable.append("<tr style='border-bottom:1px solid #E0E0E0;'><td style='padding:6px;'><b>Day</b></td>")
            houseTable.append("<td style='padding:6px;'><input type='number' name='d1DayCool' min='50' max='90' step='1' value='${d1DayCool ?: 75}' style='${spinnerStyle}'/></td>")
            houseTable.append("<td style='padding:6px;'><input type='number' name='d1DayHeat' min='50' max='90' step='1' value='${d1DayHeat ?: 66}' style='${spinnerStyle}'/></td></tr>")
            
            // Evening
            houseTable.append("<tr style='border-bottom:1px solid #E0E0E0;'><td style='padding:6px;'><b>Evening</b></td>")
            houseTable.append("<td style='padding:6px;'><input type='number' name='d1EveningCool' min='50' max='90' step='1' value='${d1EveningCool ?: 73}' style='${spinnerStyle}'/></td>")
            houseTable.append("<td style='padding:6px;'><input type='number' name='d1EveningHeat' min='50' max='90' step='1' value='${d1EveningHeat ?: 69}' style='${spinnerStyle}'/></td></tr>")
            
            // Night
            houseTable.append("<tr style='border-bottom:1px solid #E0E0E0;'><td style='padding:6px;'><b>Night</b></td>")
            houseTable.append("<td style='padding:6px;'><input type='number' name='d1NightCool' min='50' max='90' step='1' value='${d1NightCool ?: 75}' style='${spinnerStyle}'/></td>")
            houseTable.append("<td style='padding:6px;'><input type='number' name='d1NightHeat' min='50' max='90' step='1' value='${d1NightHeat ?: 64}' style='${spinnerStyle}'/></td></tr>")
        ...
        section("<b>SECTION 2: Office HVAC Controller (Secondary / Floor Heater)</b>", hideable: true, hidden: true) {
            ...
            input name: "dev2AppEnabled", type: "bool", title: "<b>Enable Office Thermostat</b>", defaultValue: false, submitOnChange: false
            input name: "targetThermostat2", type: "capability.thermostat", title: "<b>Select Office HVAC Controller Device</b>", required: false, multiple: false, submitOnChange: true
            
            paragraph "<hr style='border:0; border-top:1px solid #E0E0E0; margin:8px 0;'/>"
            
            input name: "dev2AutoChangeoverEnabled", type: "bool", title: "<b>Enable Automatic Mode Changeover (Heat / Cool Switch)</b>", defaultValue: false, submitOnChange: true
            paragraph "<div style='color:#666; font-size:11px; margin-top:-6px; margin-bottom:6px;'>" +
                      "<i>When enabled, MEM automatically toggles the thermostat mode between Heat and Cool based on ambient room temperature readings and setpoint boundaries.</i></div>"
            ...
            officeTable.append("<th style='padding:6px;'>Time Period</th><th style='padding:6px; color:#2980B9;'>Cooling (°F)</th><th style='padding:6px; color:#C0392B;'>Heating (°F)</th>")
            officeTable.append("</tr>")
            
            // Morning
            officeTable.append("<tr style='border-bottom:1px solid #E0E0E0;'><td style='padding:6px;'><b>Morning</b></td>")
            officeTable.append("<td style='padding:6px;'><input type='number' name='d2MorningCool' min='50' max='90' step='1' value='${d2MorningCool ?: 72}' style='${spinnerStyle}'/></td>")
            officeTable.append("<td style='padding:6px;'><input type='number' name='d2MorningHeat' min='50' max='90' step='1' value='${d2MorningHeat ?: 68}' style='${spinnerStyle}'/></td></tr>")
            
            // Day
            officeTable.append("<tr style='border-bottom:1px solid #E0E0E0;'><td style='padding:6px;'><b>Day</b></td>")
            officeTable.append("<td style='padding:6px;'><input type='number' name='d2DayCool' min='50' max='90' step='1' value='${d2DayCool ?: 75}' style='${spinnerStyle}'/></td>")
            officeTable.append("<td style='padding:6px;'><input type='number' name='d2DayHeat' min='50' max='90' step='1' value='${d2DayHeat ?: 66}' style='${spinnerStyle}'/></td></tr>")
            
            // Evening
            officeTable.append("<tr style='border-bottom:1px solid #E0E0E0;'><td style='padding:6px;'><b>Evening</b></td>")
            officeTable.append("<td style='padding:6px;'><input type='number' name='d2EveningCool' min='50' max='90' step='1' value='${d2EveningCool ?: 73}' style='${spinnerStyle}'/></td>")
            officeTable.append("<td style='padding:6px;'><input type='number' name='d2EveningHeat' min='50' max='90' step='1' value='${d2EveningHeat ?: 69}' style='${spinnerStyle}'/></td></tr>")
            
            // Night
            officeTable.append("<tr style='border-bottom:1px solid #E0E0E0;'><td style='padding:6px;'><b>Night</b></td>")
            officeTable.append("<td style='padding:6px;'><input type='number' name='d2NightCool' min='50' max='90' step='1' value='${d2NightCool ?: 78}' style='${spinnerStyle}'/></td>")
            officeTable.append("<td style='padding:6px;'><input type='number' name='d2NightHeat' min='50' max='90' step='1' value='${d2NightHeat ?: 62}' style='${spinnerStyle}'/></td></tr>")
...
def executeEvaluationPass(String cause = "Manual / Scheduled", Boolean forceSetpointApply = false) {
    ...
    if (getSettingBool("dev1AppEnabled", true) && getSettingBool("dev1ScheduleEnabled", true) && targetThermostat && sched.d1TargetHeat != null && sched.d1TargetCool != null) {
...
private Map validateConfiguration() {
    ...
    if (getSettingBool("dev1AppEnabled", true) && !targetThermostat) errors.add("House HVAC Controller device is required when House Thermostat is enabled.")
    if (getSettingBool("dev2AppEnabled", false) && !targetThermostat2) errors.add("Office HVAC Controller device is required when Office Thermostat is enabled.")
