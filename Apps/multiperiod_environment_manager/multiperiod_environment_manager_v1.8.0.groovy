...
def timeStamp() { return "2026/09/07 10:00 AM" }
...
private String buildTileHtml(Map ctx = null) {
    ...
    // 1. House & Office Current Temperatures
    ...
    tileSb.append("<div style='font-size:1em; line-height:1.25; text-align:center; padding:0.2em; display:flex; flex-direction:column; justify-content:space-between;'>")
    
    // Top 2 lines scaled 15% larger (1.15em)
    tileSb.append("<div style='font-size:1.15em;'><b>MEM Period:</b> ").append(activePeriod).append("</div>")
    tileSb.append("<div style='font-size:1.15em;'><b>House (${t1Temp}):</b> ").append(hTargetStr).append(" | <b>Office (${t2Temp}):</b> ").append(oTargetStr).append("</div>")
    
    // Remaining lines equal size (1em)
    tileSb.append("<div style='font-size:1em;'><b>Device Mode:</b> House - ").append(t1Mode).append(" | Office - ").append(t2Mode).append("</div>")
    tileSb.append("<div style='font-size:1em;'><b>Air Filter:</b> ").append(airFilterState).append("</div>")
    tileSb.append("<div style='font-size:1em;'><b>Circulation:</b> ").append(circState).append("</div>")
    tileSb.append("<div style='font-size:1em;'><b>AQI:</b> <span style='color:").append(aqiColorCss).append("; font-weight:bold;'>").append(avgAqiStr).append(" ").append(aqiStatusStr).append("</span></div>")
