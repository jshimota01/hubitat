...
def timeStamp() { return "2026/09/02 11:45 AM" }
    ...
    dynamicPage(name: "mainPage", title: "", install: true, uninstall: true) {
        ...
        section("<b>SECTION 1: House HVAC Controller or Thermostat (Primary)</b>", hideable: true, hidden: true) {
            ...
            paragraph "<table style='width:100%; border-collapse:collapse; margin-bottom:4px; font-size:12px; font-weight:bold; text-align:center; background-color:#2C3E50; color:#FFFFFF; border-radius:4px;'>" +
                      "<tr>" +
                      "<td style='width:25%; padding:6px; border-right:1px solid #555;'>HEATING (°F)<br/><span style='font-size:10px; font-weight:normal; opacity:0.9;'>Morning & Day</span></td>" +
                      "<td style='width:25%; padding:6px; border-right:1px solid #555;'>COOLING (°F)<br/><span style='font-size:10px; font-weight:normal; opacity:0.9;'>Morning & Day</span></td>" +
                      "<td style='width:25%; padding:6px; border-right:1px solid #555;'>HEATING (°F)<br/><span style='font-size:10px; font-weight:normal; opacity:0.9;'>Evening & Night</span></td>" +
                      "<td style='width:25%; padding:6px;'>COOLING (°F)<br/><span style='font-size:10px; font-weight:normal; opacity:0.9;'>Evening & Night</span></td>" +
                      "</tr></table>"
        ...
        section("<b>SECTION 4: System Overrides (Presence & Sleeping Setpoints)</b>", hideable: true, hidden: true) {
            ...
            input name: "awayDev1Heat", type: "number", title: "House Presence Heat Target (°F)", required: true, defaultValue: 62, width: 6
            input name: "awayDev1Cool", type: "number", title: "House Presence Cool Target (°F)", required: true, defaultValue: 78, width: 6
            ...
            input name: "awayDev2Heat", type: "number", title: "Office Presence Heat Target (°F)", required: true, defaultValue: 60, width: 6
            input name: "awayDev2Cool", type: "number", title: "Office Presence Cool Target (°F)", required: true, defaultValue: 80, width: 6
            ...
            input name: "sleepDev1Heat", type: "number", title: "House Sleeping Heat Target (°F)", required: true, defaultValue: 65, width: 6
            input name: "sleepDev1Cool", type: "number", title: "House Sleeping Cool Target (°F)", required: true, defaultValue: 74, width: 6
            ...
            input name: "sleepDev2Heat", type: "number", title: "Office Sleeping Heat Target (°F)", required: true, defaultValue: 62, width: 6
            input name: "sleepDev2Cool", type: "number", title: "Office Sleeping Cool Target (°F)", required: true, defaultValue: 76, width: 6
        }
