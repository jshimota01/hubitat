    ...
    dynamicPage(name: "mainPage", title: "Multiperiod Environment Manager Setup v${version()}", install: true, uninstall: true) {
        ...
        section("<b>Air Quality Monitoring & RGB Indicator</b>") {
            ...
            String aqiColorTableHtml = "<table style='width:100%; border-collapse:collapse; font-size:12px; margin-bottom:10px; text-align:left;'>" +
                                       ...
                                       "<td style='padding:4px;'>0 - 50</td><td style='padding:4px; color:green;'><b>Good</b></td><td style='padding:4px;'>Green</td>" +
                                       "</tr>" +
                                       "<tr style='border-bottom:1px solid #eee;'>" +
                                       "<td style='padding:4px;'>51 - 99</td><td style='padding:4px; color:#b8860b;'><b>Moderate</b></td><td style='padding:4px;'>Yellow</td>" +
                                       "</tr>" +
                                       "<tr>" +
                                       "<td style='padding:4px;'>&ge; 100</td><td style='padding:4px; color:red;'><b>Unhealthy</b></td><td style='padding:4px;'>Red</td>" +
                                       "</tr>" +
                                       "</table>"
        ...
        section("<b>Room Air Filter Control</b>") {
            ...
            String aqiTableHtml = "<table style='width:100%; border-collapse:collapse; font-size:12px; margin-bottom:10px; text-align:left;'>" +
                                  ...
                                  "</tr>" +
                                  "<tr style='border-bottom:1px solid #eee;'>" +
                                  "<td style='padding:4px;'>0 - 50</td><td style='padding:4px; color:green;'><b>Good</b></td><td style='padding:4px;'>Green</td><td style='padding:4px;'>OFF</td>" +
                                  "</tr>" +
                                  "<tr style='border-bottom:1px solid #eee;'>" +
                                  "<td style='padding:4px;'>51 - 99</td><td style='padding:4px; color:#b8860b;'><b>Moderate</b></td><td style='padding:4px;'>Yellow</td><td style='padding:4px; color:green;'><b>ON</b></td>" +
                                  "</tr>" +
                                  "<tr>" +
                                  "<td style='padding:4px;'>&ge; 100</td><td style='padding:4px; color:red;'><b>Unhealthy</b></td><td style='padding:4px;'>Red</td><td style='padding:4px; color:green;'><b>ON</b></td>" +
                                  "</tr>" +
                                  "</table>"
...
def initialize() {
    ...
    if (aqiEnabled) {
        ...
        logInfo "Performing immediate Air Quality evaluation upon pressing Done."
        evaluateAirQuality()
    }
    ...
    // Evaluate setpoints and tile status immediately
    evaluateSchedule()
...
def evaluateAirQuality() {
    ...
    if (val1 == null || val2 == null) {
        logWarn "Could not evaluate Air Quality. Sensor 1: ${val1}, Sensor 2: ${val2}"
        return
    }
...
private void ensureChildDevice() {
    ...
    if (!child) {
        ...
        addChildDevice("hubitat", "Generic Component Variable", childDni, [
