...
def mainPage() {
    dynamicPage(name: "mainPage", title: "Multiperiod Environment Manager Setup v${version()}", install: true, uninstall: true) {
        ...
        section("<b>Room Air Filter Control</b>") {
            ...
            aqiTableSb.append("</tr>")
            aqiTableSb.append("<tr>")
            aqiTableSb.append("<td style='padding:4px;'>&ge; ").append(tVeryUnhealthMax + 1).append("</td><td style='padding:4px; color:maroon;'><b>Hazardous</b></td><td style='padding:4px;'>🟤 Maroon</td><td style='padding:4px; color:green;'><b>ON</b></td>")
            aqiTableSb.append("</tr>")
