...
static String version() { return '1.5.6' }
def timeStamp() { return "2026/09/02 11:32 AM" }
...
def mainPage() {
    dynamicPage(name: "mainPage", title: "", install: true, uninstall: true) {
        ...
        section("<b>SECTION 1: House HVAC Controller or Thermostat (Primary)</b>", hideable: true, hidden: true) {
            ...
            paragraph "<div style='background-color:#F2F4F4; padding:6px; font-weight:bold; border-bottom:2px solid #2C3E50; margin-bottom:8px;'>House HVAC Period Setpoints (width: 3 Diagnostic Test)</div>"
            
            // EXPERIMENTAL COMPRESSED NATIVE INPUTS (width: 3 = 4 controls per row)
            input name: "d1MorningHeat", type: "number", title: "Morning Heating (°F)", defaultValue: 68, required: true, width: 3, submitOnChange: false
            input name: "d1MorningCool", type: "number", title: "Morning Cooling (°F)", defaultValue: 72, required: true, width: 3, submitOnChange: false
            input name: "d1DayHeat", type: "number", title: "Day Heating (°F)", defaultValue: 66, required: true, width: 3, submitOnChange: false
            input name: "d1DayCool", type: "number", title: "Day Cooling (°F)", defaultValue: 75, required: true, width: 3, submitOnChange: false
            
            input name: "d1EveningHeat", type: "number", title: "Evening Heating (°F)", defaultValue: 69, required: true, width: 3, submitOnChange: false
            input name: "d1EveningCool", type: "number", title: "Evening Cooling (°F)", defaultValue: 73, required: true, width: 3, submitOnChange: false
            input name: "d1NightHeat", type: "number", title: "Night Heating (°F)", defaultValue: 64, required: true, width: 3, submitOnChange: false
            input name: "d1NightCool", type: "number", title: "Night Cooling (°F)", defaultValue: 75, required: true, width: 3, submitOnChange: false
        }
        ...
        section("<b>SECTION 2: Office HVAC Controller or Thermostat (Secondary / Floor Heater)</b>", hideable: true, hidden: true) {
            ...
            paragraph "<div style='background-color:#F2F4F4; padding:6px; font-weight:bold; border-bottom:2px solid #2C3E50; margin-bottom:8px;'>Office HVAC Period Setpoint Grid (width: 6 Baseline)</div>"
            
            input name: "d2MorningHeat", type: "number", title: "Morning Heating (°F)", defaultValue: 68, required: true, width: 6, submitOnChange: false
            input name: "d2MorningCool", type: "number", title: "Morning Cooling (°F)", defaultValue: 72, required: true, width: 6, submitOnChange: false
            
            input name: "d2DayHeat", type: "number", title: "Day Heating (°F)", defaultValue: 66, required: true, width: 6, submitOnChange: false
            input name: "d2DayCool", type: "number", title: "Day Cooling (°F)", defaultValue: 75, required: true, width: 6, submitOnChange: false
            
            input name: "d2EveningHeat", type: "number", title: "Evening Heating (°F)", defaultValue: 69, required: true, width: 6, submitOnChange: false
            input name: "d2EveningCool", type: "number", title: "Evening Cooling (°F)", defaultValue: 73, required: true, width: 6, submitOnChange: false
            
            input name: "d2NightHeat", type: "number", title: "Night Heating (°F)", defaultValue: 62, required: true, width: 6, submitOnChange: false
            input name: "d2NightCool", type: "number", title: "Night Cooling (°F)", defaultValue: 78, required: true, width: 6, submitOnChange: false
        }
