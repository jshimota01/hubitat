 ...
 *  Schedules 6 heating/cooling setpoint windows with mode overrides, live device tracking, dynamic fan circulation, AQI Air Quality filtering, and dynamic dashboard tile output.
...
definition(
    ...
    description: "Schedules 6 heating/cooling setpoint windows with mode overrides, live device tracking, dynamic fan/Filtered Air circulation, and dashboard tile output.",
