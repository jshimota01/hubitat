...
def timeStamp() { return "2026/09/02 02:25 PM" }
...
def mainPage() {
    dynamicPage(name: "mainPage", title: "", install: true, uninstall: true) {
        ...
        section("<b>SECTION 1: House HVAC Controller/Thermostat Device (Primary)</b>", hideable: true, hidden: true) {
            ...
            input name: "d1MorningHeat", type: "number", title: "<div style='border-right:1px solid #CCC; padding-right:8px;'><b>Morning</b></div>", defaultValue: 68, required: true, width: 3, submitOnChange: false
            input name: "d1MorningCool", type: "number", title: "<div style='border-right:1px solid #CCC; padding-right:8px;'><b>Morning</b></div>", defaultValue: 72, required: true, width: 3, submitOnChange: false
            input name: "d1DayHeat", type: "number", title: "<div style='border-right:1px solid #CCC; padding-right:8px;'><b>Day</b></div>", defaultValue: 66, required: true, width: 3, submitOnChange: false
            ...
            input name: "d1EveningHeat", type: "number", title: "<div style='border-right:1px solid #CCC; padding-right:8px;'><b>Evening</b></div>", defaultValue: 69, required: true, width: 3, submitOnChange: false
            input name: "d1EveningCool", type: "number", title: "<div style='border-right:1px solid #CCC; padding-right:8px;'><b>Evening</b></div>", defaultValue: 73, required: true, width: 3, submitOnChange: false
            input name: "d1NightHeat", type: "number", title: "<div style='border-right:1px solid #CCC; padding-right:8px;'><b>Night</b></div>", defaultValue: 64, required: true, width: 3, submitOnChange: false
        ...
        section("<b>SECTION 2: Office HVAC Controller/Thermostat Device (Secondary / Floor Heater)</b>", hideable: true, hidden: true) {
            ...
            // Row 1: Morning & Day (4-across layout width 3)
            input name: "d2MorningHeat", type: "number", title: "<div style='border-right:1px solid #CCC; padding-right:8px;'><b>Morning</b></div>", defaultValue: 68, required: true, width: 3, submitOnChange: false
            input name: "d2MorningCool", type: "number", title: "<div style='border-right:1px solid #CCC; padding-right:8px;'><b>Morning</b></div>", defaultValue: 72, required: true, width: 3, submitOnChange: false
            input name: "d2DayHeat", type: "number", title: "<div style='border-right:1px solid #CCC; padding-right:8px;'><b>Day</b></div>", defaultValue: 66, required: true, width: 3, submitOnChange: false
            input name: "d2DayCool", type: "number", title: "<b>Day</b>", defaultValue: 75, required: true, width: 3, submitOnChange: false
            
            // Row 2: Evening & Night (4-across layout width 3)
            input name: "d2EveningHeat", type: "number", title: "<div style='border-right:1px solid #CCC; padding-right:8px;'><b>Evening</b></div>", defaultValue: 69, required: true, width: 3, submitOnChange: false
            input name: "d2EveningCool", type: "number", title: "<div style='border-right:1px solid #CCC; padding-right:8px;'><b>Evening</b></div>", defaultValue: 73, required: true, width: 3, submitOnChange: false
            input name: "d2NightHeat", type: "number", title: "<div style='border-right:1px solid #CCC; padding-right:8px;'><b>Night</b></div>", defaultValue: 62, required: true, width: 3, submitOnChange: false
...
def overrideSwitchHandler(evt) { 
    executeEvaluationPass("Override Attribute Changed (${evt?.device?.displayName} = ${evt?.value})", true) 
    if (fanCirculateEnabled && sleepSwitch && evt?.device?.id == sleepSwitch.id) {
        logInfo "Sleeping switch state change detected. Recalculating and restarting fan circulation timer."
        manageFanCirculation(true)
    }
}
