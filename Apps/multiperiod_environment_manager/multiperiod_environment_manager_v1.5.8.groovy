...
static String version() { return '1.5.8' }
def timeStamp() { return "2026/09/02 11:55 AM" }
...
def mainPage() {
    dynamicPage(name: "mainPage", title: "", install: true, uninstall: true) {
        ...
        section("<b>SECTION 1: House HVAC Controller or Thermostat (Primary)</b>", hideable: true, hidden: true) {
            ...
            // CSS Injection to add vertical column dividers between width: 3 inputs on 1080p desktop
            paragraph "<style>" +
                      "  .mdl-cell--3-col { border-right: 2px solid #BDC3C7 !important; padding-right: 12px !important; margin-right: 0px !important; box-sizing: border-box !important; }" +
                      "  .mdl-cell--3-col:nth-of-type(4n) { border-right: none !important; }" +
                      "</style>"

            // Custom Table Header Row (Mockup 1 Style with FireBrick Heating and DodgerBlue Cooling)
            ...
            // Clean 4-across inputs with shortened non-redundant labels
        ...
        section("<b>SECTION 4: System Overrides (Presence & Sleeping Setpoints)</b>", hideable: true, hidden: true) {
            ...
            input name: "awayDev1Heat", type: "number", title: "<span style='color:FireBrick; font-weight:bold;'>House Presence Heat Target (°F)</span>", required: true, defaultValue: 62, width: 6
            input name: "awayDev1Cool", type: "number", title: "<span style='color:DodgerBlue; font-weight:bold;'>House Presence Cool Target (°F)</span>", required: true, defaultValue: 78, width: 6
            ...
            input name: "awayDev2Heat", type: "number", title: "<span style='color:FireBrick; font-weight:bold;'>Office Presence Heat Target (°F)</span>", required: true, defaultValue: 60, width: 6
            input name: "awayDev2Cool", type: "number", title: "<span style='color:DodgerBlue; font-weight:bold;'>Office Presence Cool Target (°F)</span>", required: true, defaultValue: 80, width: 6

            // --- SLEEPING OVERRIDE GROUP ---
            paragraph "<div style='background-color:#F2F4F4; padding:6px; font-weight:bold; border-left:4px solid #8E44AD; margin-top:12px; margin-bottom:8px;'>Sleeping Override / Setpoints</div>"
            ...
            input name: "sleepDev1Heat", type: "number", title: "<span style='color:FireBrick; font-weight:bold;'>House Sleeping Heat Target (°F)</span>", required: true, defaultValue: 65, width: 6
            input name: "sleepDev1Cool", type: "number", title: "<span style='color:DodgerBlue; font-weight:bold;'>House Sleeping Cool Target (°F)</span>", required: true, defaultValue: 74, width: 6
            ...
            input name: "sleepDev2Heat", type: "number", title: "<span style='color:FireBrick; font-weight:bold;'>Office Sleeping Heat Target (°F)</span>", required: true, defaultValue: 62, width: 6
            input name: "sleepDev2Cool", type: "number", title: "<span style='color:DodgerBlue; font-weight:bold;'>Office Sleeping Cool Target (°F)</span>", required: true, defaultValue: 76, width: 6
        }
