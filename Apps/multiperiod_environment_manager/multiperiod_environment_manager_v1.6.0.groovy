...
def timeStamp() { return "2026/09/02 12:15 PM" }
...
def mainPage() {
    dynamicPage(name: "mainPage", title: "", install: true, uninstall: true) {
        ...
        paragraph "<style>" +
                  "  .mdl-cell--3-col, .mdl-cell--6-col, .mdl-cell--4-col { border-right: 2px solid #BDC3C7 !important; padding-right: 12px !important; margin-right: 0px !important; box-sizing: border-box !important; }" +
                  "  .mdl-cell--3-col:nth-of-type(4n), .mdl-cell--6-col:nth-of-type(2n) { border-right: none !important; }" +
                  "</style>"
