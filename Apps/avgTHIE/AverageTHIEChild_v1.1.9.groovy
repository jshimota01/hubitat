...
def mainPage() {
    dynamicPage(name: "mainPage", uninstall: true, install: true) {
        section(getFormat("title", " ${app.label ?: app.name}")) {
            paragraph "<div style='color:#1A77C9'>Calculate rolling averages or aggregate totals for your specialized virtual devices.</div>"
        }
        
        // Native Hubitat App Label Input
        section("App Name") {
            label title: "Enter a custom name for this child app", required: false, defaultValue: "AvgTHIE Child"
        }
