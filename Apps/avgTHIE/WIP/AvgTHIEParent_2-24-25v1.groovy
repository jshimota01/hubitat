...
def mainPage() {
	dynamicPage(name: "mainPage", uninstall: true, install: true)
	{
		...
		section
		{
			...
			paragraph title: "AvgTHIE",
			"<b>This parent app is a container for all AvgTHIE child apps</b>"
		}
		section 
		{
			app(name: "AvgTHIEChild", appName: "AvgTHTIEChild", namespace: "jshimota", title: "<b>New Average THTE Child</b>", multiple: true)
		}    
