...
static String version() { return '1.1.79' }
def timeStamp() { return "2026/09/21 01:45 PM" }
...
private void restorePersistedGroundTruth() {
    ...
    Boolean restoredIsHome = (groundTruth.isHome != null) ? groundTruth.isHome : true
    Boolean restoredIsAwake = (groundTruth.isAwake != null) ? groundTruth.isAwake : true

    logInfo "RESTRICTED BOOT RESTORE -> Mode: '${restoredMode}' | Control Source: '${restoredControlSource}' | Period: '${restoredPeriodKey}' | Home: ${restoredIsHome} | Awake: ${restoredIsAwake} (Saved: ${groundTruth.timestamp ?: 'N/A'})"
...
private void commitGroundTruthSnapshot(Map decision) {
    Boolean isHomeVal = (homeSwitch ? (homeSwitch.currentValue("switch") == "on") : true)
    Boolean isAwakeVal = (awakeSwitch ? (awakeSwitch.currentValue("switch") == "on") : true)
