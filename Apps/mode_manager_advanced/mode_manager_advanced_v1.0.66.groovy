 ...
 *                        - Updated execution trace markers to include section, reason, and source context.
 * see changelog.txt for 1.0.1 - 1.0.63
 *
 */

static String version() { return '1.0.66' }
    ...
    dynamicPage(name: "mainPage", title: "", install: true, uninstall: true) {
        ...
        section("<b>SECTION 5: Notification(s) & Alert Preferences</b>", hideable: true, hidden: isCollapsed) {
            ...
            if (getSettingBool("enableNotifications", true)) {
                ...
                /* Trigger 1: Scheduled */
                input name: "notifyOnScheduled", type: "bool", title: "Notify on <b>Scheduled Transitions</b>? <i>(e.g., 07:30 Morning CRON)</i>", defaultValue: false, submitOnChange: true
                if (getSettingBool("notifyOnScheduled", false)) {
                    input name: "templateScheduled", type: "text", title: "<b>Scheduled Message Template</b>", 
