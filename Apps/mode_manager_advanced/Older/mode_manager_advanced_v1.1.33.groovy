 ...
 *                        - Bumped release to v1.1.33 for forward version tracking.
...
static String version() { return '1.1.33' }
...
def mainPage() {
    dynamicPage(name: "mainPage", title: "", install: true, uninstall: true) {
        ...
        section("<b>SECTION 7: Notification Matrix & Alerts Engine</b>", hideable: true, hidden: true) {
            paragraph "<div style='color:#555; font-size:12px; margin-bottom:8px;'>" +
                      "<b>Notification Alerts Engine:</b> Configure custom templates and discrete push/audio dispatch rules per trigger cause event.</div>"

            // --- SECTION PREFERENCES & GLOBAL CONTROLS ---
            paragraph "<span style='color:#2C3E50; font-weight:bold; font-size:13px;'>Notification Preferences & Global Mute</span>"
            ...
            // --- NOTIFICATION TEMPLATE PLACEHOLDERS TABLE ---
            paragraph "<div style='background-color:#F8F9FA; border-left:4px solid #8E44AD; padding:10px; border-radius:4px; font-size:12px; margin-top:8px; margin-bottom:12px;'>" +
                      ...
                      "<table style='width:100%; border-collapse:collapse; font-size:12px; font-family:sans-serif; margin-bottom:5px;'>" +
            ...
            Map onOffRadioOptions = ["true": "On", "false": "Off"]
            ...
            paragraph "<div style='background-color:#F4F6F7; border-left:4px solid #2980B9; padding:6px 10px; margin-bottom:2px; border-radius:4px; font-weight:bold; font-size:13px; color:#2C3E50;'>Scheduled Transitions</div>" +
                      "<div style='color:#7F8C8D; font-size:11px; margin-left:10px; margin-bottom:4px;'>ℹ️ <b>Trigger Cause (%reason%):</b> <code>Scheduled</code> (Chronological time period CRON boundaries or routine rechecks)</div>", width: 6
            input name: "pushScheduled", type: "enum", title: "<b>Push Notification</b>", options: onOffRadioOptions, defaultValue: "false", style: "radio", required: false, width: 3
            input name: "audioScheduled", type: "enum", title: "<b>Audio / Speech</b>", options: onOffRadioOptions, defaultValue: "false", style: "radio", required: false, width: 3
            ...
            paragraph "<hr style='border:0; border-top:1px solid #E0E0E0; margin:8px 0 6px 0;'/>" +
                      ...
                      "<div style='color:#7F8C8D; font-size:11px; margin-left:10px; margin-bottom:4px;'>ℹ️ <b>Trigger Cause (%reason%):</b> <code>Voice</code> (Alexa Voice Routine execution verified via Voice Marker pulse)</div>", width: 6
            input name: "pushVoice", type: "enum", title: "<b>Push Notification</b>", options: onOffRadioOptions, defaultValue: "false", style: "radio", required: false, width: 3
            input name: "audioVoice", type: "enum", title: "<b>Audio / Speech</b>", options: onOffRadioOptions, defaultValue: "false", style: "radio", required: false, width: 3
            ...
            paragraph "<hr style='border:0; border-top:1px solid #E0E0E0; margin:8px 0 6px 0;'/>" +
                      ...
                      "<div style='color:#7F8C8D; font-size:11px; margin-left:10px; margin-bottom:4px;'>ℹ️ <b>Trigger Cause (%reason%):</b> <code>Presence</code> (Master Presence Sensor or Home/Away state switch toggles)</div>", width: 6
            input name: "pushPresence", type: "enum", title: "<b>Push Notification</b>", options: onOffRadioOptions, defaultValue: "false", style: "radio", required: false, width: 3
            input name: "audioPresence", type: "enum", title: "<b>Audio / Speech</b>", options: onOffRadioOptions, defaultValue: "false", style: "radio", required: false, width: 3
            ...
            paragraph "<hr style='border:0; border-top:1px solid #E0E0E0; margin:8px 0 6px 0;'/>" +
                      ...
                      "<div style='color:#7F8C8D; font-size:11px; margin-left:10px; margin-bottom:4px;'>ℹ️ <b>Trigger Cause (%reason%):</b> <code>Override</code> (Manual Dashboard virtual switch toggle or Awake switch override)</div>", width: 6
            input name: "pushOverride", type: "enum", title: "<b>Push Notification</b>", options: onOffRadioOptions, defaultValue: "false", style: "radio", required: false, width: 3
            input name: "audioOverride", type: "enum", title: "<b>Audio / Speech</b>", options: onOffRadioOptions, defaultValue: "false", style: "radio", required: false, width: 3
            ...
            input name: "pushReboot", type: "enum", title: "<b>Push Notification</b>", options: onOffRadioOptions, defaultValue: "false", style: "radio", required: false, width: 3
            input name: "audioReboot", type: "enum", title: "<b>Audio / Speech</b>", options: onOffRadioOptions, defaultValue: "false", style: "radio", required: false, width: 3
            ...
            paragraph "<hr style='border:0; border-top:1px solid #E0E0E0; margin:8px 0 6px 0;'/>" +
                      ...
                      "<div style='color:#7F8C8D; font-size:11px; margin-left:10px; margin-bottom:4px;'>ℹ️ <b>Trigger Cause (%reason%):</b> <code>RecheckNoChange</code> (Periodic status check where mode and evaluation reason remain unchanged)</div>", width: 6
            input name: "pushRecheckNoChange", type: "enum", title: "<b>Push Notification</b>", options: onOffRadioOptions, defaultValue: "false", style: "radio", required: false, width: 3
            input name: "audioRecheckNoChange", type: "enum", title: "<b>Audio / Speech</b>", options: onOffRadioOptions, defaultValue: "false", style: "radio", required: false, width: 3
            ...
            paragraph "<hr style='border:0; border-top:1px solid #E0E0E0; margin:8px 0 6px 0;'/>" +
                      ...
                      "<div style='color:#7F8C8D; font-size:11px; margin-left:10px; margin-bottom:4px;'>ℹ️ <b>Trigger Cause (%reason%):</b> Dynamic evaluation cause updated (e.g. Scheduled -> Override) while Mode remains identical</div>", width: 6
            input name: "pushReasonOnly", type: "enum", title: "<b>Push Notification</b>", options: onOffRadioOptions, defaultValue: "false", style: "radio", required: false, width: 3
            input name: "audioReasonOnly", type: "enum", title: "<b>Audio / Speech</b>", options: onOffRadioOptions, defaultValue: "false", style: "radio", required: false, width: 3
            ...
            paragraph "<hr style='border:0; border-top:1px solid #E0E0E0; margin:8px 0 6px 0;'/>" +
                      ...
                      "<div style='color:#7F8C8D; font-size:11px; margin-left:10px; margin-bottom:4px;'>ℹ️ <b>Trigger Cause (%reason%):</b> Location Mode changed (e.g. Day -> Evening) under an ongoing trigger cause (e.g. Scheduled)</div>", width: 6
            input name: "pushModeOnly", type: "enum", title: "<b>Push Notification</b>", options: onOffRadioOptions, defaultValue: "false", style: "radio", required: false, width: 3
            input name: "audioModeOnly", type: "enum", title: "<b>Audio / Speech</b>", options: onOffRadioOptions, defaultValue: "false", style: "radio", required: false, width: 3
        ...
        section("<b>SECTION 8: System Diagnostics, Overrides & Simulation Panel</b>", hideable: true, hidden: true) {
        ...
        section("<b>SECTION 9: System Startup & Boot Guard</b>", hideable: true, hidden: true) {
...
private void dispatchTileNotification(Map decision, String overrideReasonVal = null, Boolean isSleepingState = false) {
    ...
    if (reasonVal != "Reboot" && !modeChanged && reasonChanged) {
        pushEnabled  = (settings.pushReasonOnly != null) ? settings.pushReasonOnly.toBoolean() : false
    ...
    // BRANCH 2: MODE CHANGED ONLY (Reason Unchanged)
        ...
        pushEnabled  = (settings.pushModeOnly != null) ? settings.pushModeOnly.toBoolean() : false
        audioEnabled = (settings.audioModeOnly != null) ? settings.audioModeOnly.toBoolean() : false
    } 
    // BRANCH 3: BOTH MODE AND REASON CHANGED (OR STANDARD RECHECK / REBOOT)
        ...
        switch (reasonVal) {
            case "Scheduled":
                ...
                break
            case "Voice":
                pushEnabled  = (settings.pushVoice != null) ? settings.pushVoice.toBoolean() : false
                audioEnabled = (settings.audioVoice != null) ? settings.audioVoice.toBoolean() : false
                break
            case "Presence":
                pushEnabled  = (settings.pushPresence != null) ? settings.pushPresence.toBoolean() : false
                audioEnabled = (settings.audioPresence != null) ? settings.audioPresence.toBoolean() : false
                break
            case "Override":
                pushEnabled  = (settings.pushOverride != null) ? settings.pushOverride.toBoolean() : false
                audioEnabled = (settings.audioOverride != null) ? settings.audioOverride.toBoolean() : false
                break
            case "Reboot":
                pushEnabled  = (settings.pushReboot != null) ? settings.pushReboot.toBoolean() : false
...
def executeForcedTestEvaluation() {
    ...
    processStatePipeline([
        ...
        source: "Section 8 Simulation Control Panel",
