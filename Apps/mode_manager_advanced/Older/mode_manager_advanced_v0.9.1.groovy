...
static String version() { return '0.9.1' }
...
def executeForcedTestEvaluation() {
    ...
    /* 1. Set explicit reason in state and update dynamic label */
    ...
    /* 6. Sync Virtual Indicator Switches (Uses timed switch reservations to prevent Override hijacking) */
