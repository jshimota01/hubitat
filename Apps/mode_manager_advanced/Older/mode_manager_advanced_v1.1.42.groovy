 ...
 * Change History:
 *
 * v1.1.42 (2026-08-24) - Notification Matrix & Template Re-Integration Refactor:
 *                        - Re-integrated the Event Trigger Dispatch Matrix toggles directly alongside their corresponding message text fields in Section 8.
 *                        - Dedicated Section 7 strictly to Global Notification Preferences, Master Switches, and Mute Controls.
 *                        - Consolidated each trigger cause into a unified row card containing trigger cause notes, output toggles (Push, Mobile, Audio), 
 * 						  - and template input fields.
...
static String version() { return '1.1.42' }
...
def mainPage() {
    dynamicPage(name: "mainPage", title: "", install: true, uninstall: true) {
        ...
        section("<b>SECTION 8: Event Trigger Dispatch Matrix & Message Templates</b>", hideable: true, hidden: true) {
            ...
            input name: "templateScheduled", type: "text", title: "<b>Scheduled Message Text Template*</b>", defaultValue: "Mode scheduled transition: %mode% (from %prevMode% at %time%)", required: true, width: 12
            ...
            input name: "templateVoice", type: "text", title: "<b>Voice Trigger Message Text Template*</b>", defaultValue: "Voice command changed mode to %mode% (Reason: %reason% at %time%)", required: true, width: 12
            ...
            input name: "templatePresence", type: "text", title: "<b>Presence Change Message Text Template*</b>", defaultValue: "Presence update changed mode to %mode% (was %prevMode% at %time%)", required: true, width: 12
            ...
            input name: "templateOverride", type: "text", title: "<b>Manual Override Message Text Template*</b>", defaultValue: "Manual Override activated: Mode set to %mode% (Reason: %reason% at %time%)", required: true, width: 12
            ...
            input name: "templateReboot", type: "text", title: "<b>Hub Reboot Message Text Template*</b>", defaultValue: "System restarted following hub boot. Mode synchronized to %mode% (Reason: %reason% at %time%)", required: true, width: 12
            ...
            input name: "templateRecheckNoChange", type: "text", title: "<b>Recheck Message Text Template*</b>", defaultValue: "Mode recheck completed: Still in %mode% (%reason%) at %time%", required: true, width: 12
            ...
            input name: "templateReasonOnly", type: "text", title: "<b>Reason Only Message Text Template</b>", defaultValue: "Evaluation Reason updated to %reason% (Mode remains %mode% at %time%)", required: false, width: 12
            ...
            input name: "templateModeOnly", type: "text", title: "<b>Mode Only Message Text Template</b>", defaultValue: "Mode changed to %mode% (Reason remains %reason% at %time%)", required: false, width: 12
        }
