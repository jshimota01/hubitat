...
def updateAppLabel(String currentMode, String reason = null) {
    ...
    String displayReason = reason ?: state.modeReason ? " (${state.modeReason})" : ""
    String formattedLabel = "${baseLabel} - [<span style='color:green; font-weight:bold;'>${displayMode}${displayReason}</span>]"
