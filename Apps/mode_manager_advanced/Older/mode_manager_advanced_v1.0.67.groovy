 ...
 *                        - Added variable reference table displaying %mode%, %prevMode%, %reason%, %prevReason%, and %time% with descriptions and example outputs.
 *                        - Removed the word 'Template' from individual input field titles while preserving 'Templates' in the sub-section header.
 ...
 * see changelog.txt for 1.0.1 - 1.0.64
 *
 */

static String version() { return '1.0.67' }
