 ...
 * Change History:
 *
 * v1.0.40 (2026-08-15) - Dynamic Dynamic-Page State-Driven Section Collapse:
 ...
 *                        - Overhauled SECTION 5 GUI with master toggle, push vs speech device selectors, and quiet-hours mute options.
...
static String version() { return '1.0.40' }
...
def mainPage() {
    dynamicPage(name: "mainPage", title: "", install: true, uninstall: true) {
        ...
        /* State-Driven Collapse Logic:
           When first opened, state.sectionsExpanded is false, so sections collapse (hidden = true).
           Once a submitOnChange input fires while editing, state.sectionsExpanded becomes true, 
           keeping sections open during active form usage. Clicking Done resets state.sectionsExpanded to false. */
