 ...
 *                        - Relocated notification preferences to the top of Section 7 and moved Placeholders table above the Matrix card grid.
 *                        - Converted matrix Push/Audio selections to 2-state On/Off dropdowns defaulting to Off.
...
static String version() { return '1.1.32' }
...
def mainPage() {
    dynamicPage(name: "mainPage", title: "", install: true, uninstall: true) {
        ...
        section("<b>SECTION 6: Status Tile(s) and Output Devices</b>", hideable: true, hidden: true) {
            ...
            paragraph "<hr style='border:0; border-top:1px solid #E0E0E0; margin:12px 0 8px 0;'/>" +
                      "<span style='color:#2C3E50; font-weight:bold; font-size:13px;'>Notification Target Devices & Text Formatting</span>"
        ...
        section("<b>SECTION 7: Notification Matrix & Alerts Engine</b>", hideable: true, hidden: true) {
            ...
            // --- SECTION PREFERENCES & GLOBAL CONTROLS (MOVED TO TOP OF SECTION 7) ---
            ...
            // --- NOTIFICATION TEMPLATE PLACEHOLDERS TABLE (MOVED ABOVE MATRIX TABLE) ---
            ...
            Map onOffOptions = ["false": "Off", "true": "On"]
            ...
            input name: "pushScheduled", type: "enum", title: "<b>Push Notification</b>", options: onOffOptions, defaultValue: "false", required: false, width: 3
            input name: "audioScheduled", type: "enum", title: "<b>Audio / Speech</b>", options: onOffOptions, defaultValue: "false", required: false, width: 3
            ...
            input name: "pushVoice", type: "enum", title: "<b>Push Notification</b>", options: onOffOptions, defaultValue: "false", required: false, width: 3
            input name: "audioVoice", type: "enum", title: "<b>Audio / Speech</b>", options: onOffOptions, defaultValue: "false", required: false, width: 3
            ...
            input name: "pushPresence", type: "enum", title: "<b>Push Notification</b>", options: onOffOptions, defaultValue: "false", required: false, width: 3
            input name: "audioPresence", type: "enum", title: "<b>Audio / Speech</b>", options: onOffOptions, defaultValue: "false", required: false, width: 3
            ...
            input name: "pushOverride", type: "enum", title: "<b>Push Notification</b>", options: onOffOptions, defaultValue: "false", required: false, width: 3
            input name: "audioOverride", type: "enum", title: "<b>Audio / Speech</b>", options: onOffOptions, defaultValue: "false", required: false, width: 3
            ...
            input name: "pushReboot", type: "enum", title: "<b>Push Notification</b>", options: onOffOptions, defaultValue: "false", required: false, width: 3
            input name: "audioReboot", type: "enum", title: "<b>Audio / Speech</b>", options: onOffOptions, defaultValue: "false", required: false, width: 3
            ...
            input name: "pushRecheckNoChange", type: "enum", title: "<b>Push Notification</b>", options: onOffOptions, defaultValue: "false", required: false, width: 3
            input name: "audioRecheckNoChange", type: "enum", title: "<b>Audio / Speech</b>", options: onOffOptions, defaultValue: "false", required: false, width: 3
            ...
            input name: "pushReasonOnly", type: "enum", title: "<b>Push Notification</b>", options: onOffOptions, defaultValue: "false", required: false, width: 3
            input name: "audioReasonOnly", type: "enum", title: "<b>Audio / Speech</b>", options: onOffOptions, defaultValue: "false", required: false, width: 3
            ...
            input name: "pushModeOnly", type: "enum", title: "<b>Push Notification</b>", options: onOffOptions, defaultValue: "false", required: false, width: 3
            input name: "audioModeOnly", type: "enum", title: "<b>Audio / Speech</b>", options: onOffOptions, defaultValue: "false", required: false, width: 3
        }
