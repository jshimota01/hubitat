 ...
 *                        - Restored getSettingBool checks in updateAppLabel() for showVersionInLabel,
 *                          showModeInLabel, and showReasonInLabel toggles.
...
static String version() { return '1.0.55' }
