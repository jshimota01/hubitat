 ...
 */
// [KEEP-EXACT] see changelog.txt for v1.0.1 - v1.1.31
...
static String version() { return '1.1.38' }
...
def mainPage() {
    dynamicPage(name: "mainPage", title: "", install: true, uninstall: true) {
        ...
        section("<b>SECTION 7: Notification Matrix & Alerts Engine</b>", hideable: true, hidden: true) {
            ...
            paragraph "<span style='color:#2C3E50; font-weight:bold; font-size:13px;'>Notification Preferences (Push/Mobile/Audio)</span>"
            input name: "enableNotifications", type: "bool", title: "<b>Disable/Enable All Notification Outputs</b>", defaultValue: true

            paragraph "<div style='margin-left: 20px; padding: 8px 12px; background-color: #F8F9FA; border-left: 3px solid #3498DB; border-radius: 4px; margin-top: 4px; margin-bottom: 8px;'>" +
                      "<span style='color: #2C3E50; font-size: 12px; font-weight: bold;'>Master Output Sub-Controls (Type Master Switches):</span></div>"
            
            paragraph "<div style='margin-left: 20px;'>", width: 12
            input name: "masterEnablePush", type: "bool", title: "<b>Enable Standard Push?</b>", defaultValue: true, width: 4
            input name: "masterEnablePushMobile", type: "bool", title: "<b>Enable Mobile Push?</b>", defaultValue: true, width: 4
            input name: "masterEnableAudio", type: "bool", title: "<b>Enable Audio/Speech?</b>", defaultValue: true, width: 4
            paragraph "</div>", width: 12
            ...
            paragraph "<div style='width:85%; margin:10px auto 16px auto; background-color:#FFFFFF; border:1px solid #E0E0E0; border-left:5px solid #8E44AD; border-radius:6px; box-shadow:0 4px 8px rgba(0,0,0,0.1); padding:12px 16px; font-size:12px; font-family:sans-serif;'>" +
