...
static String version() { return '1.0.77' }
...
def mainPage() {
    dynamicPage(name: "mainPage", title: "", install: true, uninstall: true) {
        ...
        section("<b>SECTION 6: Status Tiles & Notification Alerts</b>", hideable: true, hidden: isCollapsed) {
            ...
            paragraph "<div style='color:#555; font-size:12px; margin-bottom:8px;'>" +
                      "Select a virtual device powered by the <b>Virtual Mode Status & State Tracker Tile Driver</b> (installed via GitHub/HPM) to receive real-time mode badges, reason attributes, and formatted HTML dashboard tiles.</div>"
            ...
            input name: "tileFormat", type: "enum", title: "<b>Dashboard Tile Text Format</b>", options: ["plain": "Plain Text", "html": "Formatted HTML"], defaultValue: "plain", required: true
...
private String captureSettingsSnapshot() {
    List<String> watchKeys = [
        ...
        "alexaModeSwitch", "alexaAwakeSwitch", "alexaVoiceMarkerSwitch", "statusTileDevice", "tileFormat", "logInfoEnable", "logDebugEnable", "logTraceEnable"
    ]
