...
def schedulePeriodTime(String timeIso) {
    if (timeIso) {
        try {
            ...
            logTrace "Scheduled recurring daily period trigger at ${String.format('%02d:%02d', hour, min)} (${tz.ID}) via CRON [${cronStr}]"
        } catch (Exception e) {
...
private void logMessage(String level, String msg) {
    ...
    if (settings["log${lowerLevel.capitalize()}Enable"] == true) {
