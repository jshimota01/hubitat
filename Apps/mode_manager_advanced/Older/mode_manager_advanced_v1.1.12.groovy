...
static String version() { return '1.1.12' }
...
def verifyHsmSync(Map data) {
    ...
    logTrace "=== verifyHsmSync Execution -> Expected: '${expected}' | Actual: '${actualHsm}' | DispatchMs: ${initialDispatchMs} (Dispatched ${elapsedMs}ms ago) ==="
