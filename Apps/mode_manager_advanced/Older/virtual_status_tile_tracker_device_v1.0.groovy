/*
 * Virtual Status Tile & State Driver for Mode Manager Advanced
...
metadata {
    definition (
        name: "Virtual Status Tile & State Tracker",
        namespace: "jshimota",
...
def installed() {
    logInfo "Virtual Status Tile & State Tracker installed."
    initialize()
}

def updated() {
    logInfo "Virtual Status Tile & State Tracker updated."
}
