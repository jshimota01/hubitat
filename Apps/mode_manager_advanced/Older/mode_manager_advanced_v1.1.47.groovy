...
// Thread-safe heap registers & sequence counter
...
@Field static AtomicLong txCounter = new AtomicLong(0)

static String version() { return '1.1.47' }
...
private void processStatePipeline(Map request) {
    ...
    String txId = "tx_${now()}_${txCounter.incrementAndGet()}"
