...
static String version() { return '1.0.48' }
...
private String captureSettingsSnapshot() {
    ...
    // Safely serialize the map to a JSON string and generate MD5 hash via java.security.MessageDigest
