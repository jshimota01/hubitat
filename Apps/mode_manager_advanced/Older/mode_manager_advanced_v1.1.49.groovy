 ...
 * Change History:
 *
 * v1.1.49 (2026-08-24) - GUI Section Collapse State Retention Fix:
 *                        - Fixed Section 8 collapsing on submitOnChange UI re-renders during template preview changes.
 *                        - Section 8 now dynamically evaluates 'hidden' based on user interaction state to stay open during edits.
 ...
 */
// [KEEP-EXACT] see changelog.txt for v1.0.1 - v1.1.39
...
static String version() { return '1.1.49' }
...
def mainPage() {
    dynamicPage(name: "mainPage", title: "", install: true, uninstall: true) {
        ...
        // Section 8 dynamic collapse protection: stays open when preview Cause dropdown is clicked
