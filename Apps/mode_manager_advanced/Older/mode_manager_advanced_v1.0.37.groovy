...
static String version() { return '1.0.37' }
...
def initialize() {
    ...
    /* Subcribing to Hubitat System Startup Event */
...
def hubStartupHandler(evt = null) {
    ...
    /* Clear cached notification mode to ensure startup notification always fires */
