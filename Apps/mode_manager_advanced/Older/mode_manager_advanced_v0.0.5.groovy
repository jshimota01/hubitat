...
definition(
    ...
    namespace: "community",
    author: "J. Shimota",
    description: "Advanced Hubitat Mode Manager driven by master presence, reverse-mirrored presence and sleep/awake switches, dynamic time periods, and virtual mode indicators.",
...
def evaluateAndSetMode() {
    ...
    if (!isHome) {
        logDebug "State Check: Presence is Away. Mode shifts paused."
        updateVirtualModeSwitches(null) // Turn off mode indicator switches when away
        return
    }
