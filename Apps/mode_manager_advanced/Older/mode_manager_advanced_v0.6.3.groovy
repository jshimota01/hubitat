...
private void seedLoggingState() {
    state.lastLogInfoEnable  = (settings.logInfoEnable != false)
    state.lastLogDebugEnable = (settings.logDebugEnable != false)
...
private void checkLoggingChanges() {
    Boolean currentInfo  = (settings.logInfoEnable != false)
    Boolean currentDebug = (settings.logDebugEnable != false)
