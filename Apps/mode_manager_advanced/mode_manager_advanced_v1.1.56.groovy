...
static String version() { return '1.1.56' }
...
def initialize() {
    ...
    // Preserve and heal active period state across updates/reboots
...
def startPeriodSchedules() {
    // Check for duplicate start times across configuration settings
