 ...
 *                        - Eliminates ambiguous or redundant generic trace lines across nested app lifecycle and pipeline runs.
 ...
 * see changelog.txt for 1.0.1 - 1.0.61
 *
 */

static String version() { return '1.0.64' }
