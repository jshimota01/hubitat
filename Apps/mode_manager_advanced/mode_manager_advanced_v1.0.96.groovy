...
static String version() { return '1.0.96' }
    ...
    if (rawDevId != null) {
        ...
        if (pendingMap.containsKey(compositeKey)) {
            ...
            if (marker && marker.value == evtVal && currentMs <= (marker.expires as long)) {
                logTrace "SUCCESS: Suppressed app-generated internal output event from '${evt.device?.displayName}' [ID: ${devId} | CompositeKey: ${compositeKey}]"
