...
static String version() { return '1.1.08' }
...
private void registerExpectedAck(String deviceId, String expectedValue) {
    if (!deviceId) return
    pendingAckTokens.put(deviceId.toString(), expectedValue.toString())
}
...
private boolean consumeExpectedAck(def evt) {
    ...
    String expectedVal = pendingAckTokens.get(devId)

    if (expectedVal != null && expectedVal == actualVal) {
