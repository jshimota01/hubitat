 ...
 *                        - Added '=== Mode Manager Adv Begins ===' and '=== Mode Manager Adv Ends ===' log markers.
 *                        - Removed trailing hyphen lines at end of execution transactions.
 *                        - Fixed finalIsSleeping evaluation in calculateDecision() to ensure output switches (Mode - Sleeping / Mode - Awake) properly sync on Wake transitions.
 ...
 *                        - Prevents circular dependency where stale homeSwitch state overrode valid departure events.
...
static String version() { return '1.0.63' }
...
def installed() {
    logTrace "=== Mode Manager Adv Begins ==="
    ...
    logTrace "=== Mode Manager Adv Ends ==="
}
