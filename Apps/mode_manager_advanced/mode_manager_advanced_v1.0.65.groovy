 ...
 *                        - Ensures '=== Mode Manager Adv [Handler: ...] Begins ===' is the absolute first log line when an external device trigger hits the app.
 ...
 * see changelog.txt for 1.0.1 - 1.0.62
 *
 */

static String version() { return '1.0.65' }
...
def sleepSwitchHandler(evt) {
    ...
    logTrace "=== Mode Manager Adv [Handler: Sleep Switch '${devName}' (${evt.value})] Begins ==="
    if (isInternalTransaction(evt)) {
