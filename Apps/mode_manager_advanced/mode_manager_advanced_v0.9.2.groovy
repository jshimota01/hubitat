...
static String version() { return '0.9.2' }
...
def executeForcedTestEvaluation() {
    ...
    /* 1. Determine Target Location Mode based on forced state parameters */
    ...
    /* 5. Sync Virtual Indicator Switches (Uses timed switch reservations) */
    updateVirtualModeSwitches(periodKey)

    /* 6. Lock in explicit forced reason and refresh dynamic App Label AFTER all switch syncs finish */
