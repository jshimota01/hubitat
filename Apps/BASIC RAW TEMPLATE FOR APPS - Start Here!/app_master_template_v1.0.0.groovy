...
def timeStamp() { return "2026/08/30 08:35 AM" }
...
def mainPage() {
    dynamicPage(name: "mainPage", title: "<b>[App Name] Configuration</b>", install: true, uninstall: true) {
        section("<b>App Label</b>") {
            label title: "Assign a custom name for this app instance:", required: false
        }

        section("<b>Device Selections</b>") {
