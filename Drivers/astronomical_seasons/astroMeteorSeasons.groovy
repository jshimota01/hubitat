...
def showAstroSeason() {
    ...
    AstronomicalSeason todaysAstroSeason = AstronomicalSeason.of(m)

    if (isSouthern) { // switch to southern equivalent if necessary
        todaysAstroSeason = result.onSouthernHemisphere()
    }

    // System.out.println(result)
    sendEvent(name: "todaysAstroSeason", value: todaysAstroSeason)
}
