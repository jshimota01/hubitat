...
private BigDecimal calcMoonPosition() {
    ...
    BigDecimal finalAltitude = BigDecimal.valueOf(mAlt).setScale(precision, java.math.RoundingMode.HALF_UP)
    BigDecimal finalAzimuth = BigDecimal.valueOf(az).setScale(precision, java.math.RoundingMode.HALF_UP)
    ...
    state.currentMoonAltitude = finalAltitude
    state.currentMoonAzimuth = finalAzimuth
    return finalAltitude
}
