...
static String version()    {  return '2.5.19-Dev'  }
...
metadata {
    ...
    preferences {
        ...
        input name: "overrideMinutelyExclude", type: "bool", title: "Base Override - Gather Short-Term 60-Minute Precipitation Data", description: "Turn ON to retrieve 60-minute short-term precipitation forecast data (rain, sleet, snow) from OpenWeatherMap during scheduled API calls (Does not increase API call quantity)<br><i>*Formatted using the Display Decimal Precision & Unit settings below.</i><br>Default: <b>OFF</b> (Excluded)", defaultValue: false, required: true
...
private void calcMinutelyPrecipitation(List minutelyList) {
    ...
    int minutesUntilPrecipStop  = currentlyPrecipitating ? precipStopMinute : -1
