...
static String version()    {  return '2.5.23-Dev'  }
...
metadata {
    ...
    preferences {
        ...
        input name: "precisionPrecip", type: "enum", title: "Display Decimal Precision - Precipitation (Rain, Sleet/Snow)", options: ["0": "0 Places", "1": "1 Place", "2": "2 Places"], description: "Choice of decimal precision for precipitation in logging and tiles<br>Default: <b>2</b><br><i>EG: 1, 1.5, 1.55</i><br><i>*Note: Applies to Precipitation in both forecast and next 60 minute data if enabled.</i>", defaultValue: "2", required: true
