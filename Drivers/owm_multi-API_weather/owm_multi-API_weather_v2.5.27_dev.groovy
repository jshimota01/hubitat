...
static String version()    {  return '2.5.27-Dev'  }
...
private void calcMinutelyPrecipitation(List minutelyList) {
    ...
    logDebug "precipNextHr Short-Term Precip Parsed -> Start in: ${minutesUntilPrecipStart} min | Stop in: ${minutesUntilPrecipStop} min | Current Rate: ${currentRateText} | 1-Hour Accumulation: ${accumulationText} | ${summaryText}"
}
