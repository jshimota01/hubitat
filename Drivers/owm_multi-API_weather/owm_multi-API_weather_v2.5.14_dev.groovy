...
static String version()    {  return '2.5.14-Dev'  }
...
private void calcMinutelyPrecipitation(List minutelyList) {
    ...
    logDebug "Minutely Parsed -> Expected in: ${minutesUntilRain} min | Current: ${displayCurrentRate}${spaceStr}${pUnit} | Total Depth: ${displayTotalAccum}${spaceStr}${pUnit} | ${summaryText}"
}
