...
static String version()    {  return '2.5.13-Dev'  }
...
private void calcMinutelyPrecipitation(List minutelyList) {
    ...
    logDebug "Minutely Parsed -> Current: ${displayCurrentRate}${spaceStr}${pUnit} | Total Depth: ${displayTotalAccum}${spaceStr}${pUnit} | ${summaryText}"
}
