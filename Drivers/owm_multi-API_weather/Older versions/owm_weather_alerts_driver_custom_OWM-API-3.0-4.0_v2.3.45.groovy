...
void generateTiles(Map currentData = [:], Map todayData = [:], Map tomData = [:], Map tdaData = [:]) {
    ...
    String currentBodyHtml = "<div style='color:#fff;display:flex;flex-direction:column;justify-content:space-around;align-items:center;height:100%;box-sizing:border-box;overflow:hidden;padding:.1em;line-height:1;text-align:center;font-size:1em'>" +
        ...
        "<div style='display:flex;align-items:center'><img src='${currentIconUrl}' style='height:2em;max-width:2.4em;object-fit:contain'><b style='font-size:1.22em;margin-left:.2em'>${sT}${tUnit}</b></div>" +
        "<div style='font-size:.65em;color:#ddd;margin-top:-.2em'>(feels like ${sFL}${tUnit})</div>" +
        ...
        "<div style='font-size:.7em'>High: ${sH}° Low: ${sL}°</div>" +
    ...
    String forecastBodyHtml = "<style>.fcTable{width:100%;height:100%;text-align:center;color:#fff;font-size:.55rem;border-collapse:collapse;line-height:1.1}.fcTable td{padding:1px;vertical-align:middle}.fcI{height:1.6em;vertical-align:middle}</style>" +
        "<table class='fcTable'>" +
        "<tr><td colspan='4'><b>${cityName}</b></td></tr>" +
        "<tr><td>Now</td><td>Today</td><td>${day1Name}</td><td>${day2Name}</td></tr>" +
        "<tr>" +
        "<td><img src='${cIcon}' class='fcI'></td>" +
        "<td><img src='${d0.icon}' class='fcI'></td>" +
        "<td><img src='${d1.icon}' class='fcI'></td>" +
        "<td><img src='${d2.icon}' class='fcI'></td>" +
        "</tr>" +
        "<tr><td>Current</td><td rowspan='2' style='font-size:.48rem'>${d0.desc}</td><td rowspan='2' style='font-size:.48rem'>${d1.desc}</td><td rowspan='2' style='font-size:.48rem'>${d2.desc}</td></tr>" +
        "<tr><td>${cTStr}°</td></tr>" +
        "<tr><td>Hi/Low</td><td><b>${d0.hi}°/${d0.lo}°</b></td><td><b>${d1.hi}°/${d1.lo}°</b></td><td><b>${d2.hi}°/${d2.lo}°</b></td></tr>" +
