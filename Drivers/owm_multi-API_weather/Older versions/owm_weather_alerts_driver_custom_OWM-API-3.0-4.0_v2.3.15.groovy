...
// =========================================================================
    ...
    String alertBaseStyle = "display:flex;flex-direction:column;justify-content:space-between;height:100%;padding:8px;box-sizing:border-box;border-radius:6px;color:#fff;font-family:sans-serif;line-height:1.2;text-align:center"

    String alertBodyHtml = ""
    if (alertActive != "No active alerts" && alertActive != "N/A" && alertActive != "") {
        alertBodyHtml = "<div style='${alertBaseStyle}'><div style='font-size:0.85em;font-weight:bold;color:#f00;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;margin-bottom:2px;'>⚠️ ${alertActive}&nbsp;<br>&nbsp;</div><div style='font-size:.5em;font-weight:600;color:#fff;padding:4px;overflow:hidden;display:-webkit-box;-webkit-line-clamp:3;-webkit-box-orient:vertical;'>${alertDesc}</div><div style='display:flex;justify-content:space-between;border-top:1px solid rgba(255,255,255,0.15);padding-top:4px;font-size:0.4em;color:#f2f2f2'><span>👤 ${alertSender.take(12)}</span><span>⏰ ${lastPollTime}</span></div>"
    } else {
        alertBodyHtml = "<div style='${alertBaseStyle}'><div style='font-size:0.75em;font-weight:bold;color:#55ff55;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;margin-bottom:2px;'>✅ ${cityName}</br>Clear Weather</div><div style='font-size:0.8em;font-weight:600;color:#f2f2f2;padding:8px 4px;'>No active weather alerts from OpenWeatherMap or their sources</div><div style='display:flex;justify-content:center;border-top:1px solid rgba(255,255,255,0.15);padding-top:4px;font-size:0.5em;color:#bbb'><span>Updated ${lastPollTime}</span></div>"
    }
