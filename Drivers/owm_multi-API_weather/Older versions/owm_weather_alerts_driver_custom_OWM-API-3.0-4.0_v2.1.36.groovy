...
private BigDecimal calcSunPosition() {
    ...
    if (lat == null || lon == null) {
        logWarn "Latitude or Longitude is not configured in Hub locations settings for use as default. Skipping sun calculations." 
        return 0.0 
    }
	...
	logDebug "azimuthDeg=${azimuthDeg}"
	logDebug "altitudeDeg=${altitudeDeg}"
	logDebug "azimuth=${azimuth}"
	logDebug "altitude=${altitude}"
