...
// 12. Current Weather Summary Text Formatter
    ...
    try {
        ...
        // DateTime Formats
        def lastUpdatedTime = device.currentValue("lastUpdatedDateTimeText") ?: "--"
        // Grab formatted date (using todayDateText as fallback/helper)
        def lastUpdatedDate = device.currentValue("todayDateText") ?: "--"
        ...
        // Units
        String tUnit = settings.temperatureUnit ?: "°F"
        wUnit = (settings.windSpeedUnit == "none") ? "" : " ${settings.windSpeedUnit ?: 'mph'}" // <-- FIX: Removed 'String' type prefix here
        
        // Humidity and Wind
        def humText = device.currentValue("currentHumidityText") ?: "--"
        def tempText = device.currentValue("currentTemperatureText") ?: "--"
        ...
        String windSpeedText = device.currentValue("currentWindSpeedText") ?: "--"
        ...
        // Main dynamic string assembly - Zero internal quote marks
