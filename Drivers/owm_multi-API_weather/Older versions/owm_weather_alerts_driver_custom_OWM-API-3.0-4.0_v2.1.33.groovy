...
private BigDecimal calcSunPosition() {
	...
	// --- NEW ATTRIBUTE OUTPUTS WITH SPACE AND DEGREE SIGN ---
    sendIfChanged(name: "altitudeText", value: "${altitudeDeg.setScale(precision)} °")
    sendIfChanged(name: "azimuthText", value: "${azimuthDeg.setScale(precision)} °")
