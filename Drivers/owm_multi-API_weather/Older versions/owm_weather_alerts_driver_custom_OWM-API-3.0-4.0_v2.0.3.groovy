...
metadata {
    ...
    preferences {
        ...
        input name: "precisionPressure", type: "enum", title: "Pressure", options: ["0": "0 Places", "1": "1 Place", "2": "2 Places"], defaultValue: "2", required: true
        ...
        input name: "useImperial", type: "bool", title: "Display Unit - Imperial or Metric Temperature", description: "Display Unit - Temperature: Fahrenheit (°F) or Celsius (°C)", defaultValue: true, required: true
