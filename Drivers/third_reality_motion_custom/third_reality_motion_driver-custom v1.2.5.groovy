...
===================================================================================================
v1.2.5  Fixed double reporting issue by separating IAS Zone Status parsing from cluster 0500 parsing.
v1.2.4  Optimized logic, fixed scoping, fixed bitwise operator bugs, cleaned up battery processing.
