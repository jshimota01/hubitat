...
static String version() { return '1.09' }
def timeStamp() { return "2026/09/05 10:05 AM" }
...
metadata {
    ...
    preferences {
        ...
        input name: "tempDelta", type: "decimal", title: "<b>Temperature Minimum Change Delta</b>", description: "<i>Minimum temperature change required to emit an event (0.1 to 5.0 °F/°C). Evaluated on rounded 1-decimal value.</i>", range: "0.1..5.0", defaultValue: 0.2
