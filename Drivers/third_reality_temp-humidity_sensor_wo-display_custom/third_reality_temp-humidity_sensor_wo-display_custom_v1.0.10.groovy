...
static String version() { return '1.10' }
def timeStamp() { return "2026/09/05 10:10 AM" }
...
metadata {
    ...
    preferences {
        ...
        input name: "tempOffset", type: "decimal", title: "<b>Temperature Offset</b>", description: "<i>Adjust temperature reading (-10.0 to +10.0 °${tempUnit}).</i>", range: "-10.0..10.0", defaultValue: 0.0
        ...
        input name: "tempDelta", type: "decimal", title: "<b>Temperature Minimum Change Delta</b>", description: "<i>Minimum temperature change required to emit an event (0.1 to 10.0 °${tempUnit}). Evaluated on rounded 1-decimal value.</i>", range: "0.1..10.0", defaultValue: 0.2
...
void parseHumidityCluster(final Map descMap) {
    ...
    // Apply preference offset with explicit BigDecimal math
...
@Field static final int COMMAND_TIMEOUT = 2
