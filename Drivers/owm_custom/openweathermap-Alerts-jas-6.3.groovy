...
//  <<<<<<<<<< Begin Built 3dayfcstTile >>>>>>>>>>
	if(threedayTilePublish) {
		...
		String my3day = '<style type="text/css">.cI{width:75%}.cIb{height:80%}tr:nth-child(3){vertical-align:bottom}tr:first-child{font-size:.8rem}td:first-child{font-size:.6rem}tr:last-child{font-size:.5rem}</style>'
        
		//  [orig] my3day += '<table style="text-align:center;display:inline">'
		my3day += '<table style="text-align:center;display:inline-table;width: 100%;height: 90%;font-size:.9rem">'
		...
		my3day += sIMGS8 + myGetData(sICON) + 'wsr.png' + iconClose + myGetData('localSunrise') + sSPC + sIMGS8 + myGetData(sICON) + 'wss.png' + iconClose + myGetData('localSunset') + sSPC + (my3day.length() + OWMIcon.length()+13) + 'chrs'
