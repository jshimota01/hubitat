 ...
 *  ------------------------------------------------------------------------------------------------------
 *  Changelog:
 *  v1.3.5 (2026-08-28) - Added lastBatteryReport timestamp attribute with NPE safeguards.
 *  v1.3.4 (2026-08-28) - Aligned header comment formatting, metadata structure, and changelog layout with MS01 driver.
 *  v1.3.3 (2026-08-28) - Refactored parse() to use sendIfChanged for state deduplication.
...
def refresh() {
    logDebug "Requesting battery attribute (0x0021)"
    List<String> cmds = []
    cmds += zigbee.readAttribute(0x0001, 0x0021)
