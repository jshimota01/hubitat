 ...
 * Capabilities: ContactSensor, Battery, Configuration, Refresh, Sensor, FirmwareUpdate
 **/
/**
...
def timeStamp() { return "2026/08/29 09:20 AM" }
...
def updateFirmware() {
    logInfo "Initiating Zigbee OTA Firmware Update check..."
    logDebug "Requesting current firmware version (ApplicationVersion 0x0002) prior to update check"
    
    List<String> cmds = []
    cmds += zigbee.readAttribute(0x0000, 0x0002)
    logDebug "updateFirmware(): Generated Zigbee read commands -> ${cmds}"
    return cmds
}
