...
metadata {
    definition(name: "OpenWeatherMap Multi-Version Weather Driver 2.0", namespace: "jshimota", author: "James Shimota") {
		...
		attribute "currentMoonPhasePngImageUrl", "string"
...
void generateTiles(Map currentData = [:], Map todayData = [:], Map tomData = [:], Map tdaData = [:]) {
    ...
    if (rawMoonPhase != null && rawMoonPhase.toString().isNumber()) {
        ...
        moonPngUrl = device.currentValue("currentMoonPhasePngImageUrl") ?: ""
    }
...
void calcMoonPhaseValue(Map todayData = [:], Map tomData = [:], Map tdaData = [:]) {
    ...
    def phases = [
        [sourceMap: todayData, apiKey: "moon_phase", valAttr: "todayMoonPhase", iconAttr: "todayMoonPhaseIcon", pngAttr: "todayMoonPhasePngImageUrl", textAttr: "todayMoonPhaseText", emojiAttr: "todayMoonPhaseEmojiIcon"],
        [sourceMap: tomData,   apiKey: "moon_phase", valAttr: "tomMoonPhase",   iconAttr: "tomMoonPhaseIcon",   pngAttr: "tomMoonPhasePngImageUrl",   textAttr: "tomMoonPhaseText",   emojiAttr: "tomMoonPhaseEmojiIcon"],
        [sourceMap: tdaData,   apiKey: "moon_phase", valAttr: "tdaMoonPhase",   iconAttr: "tdaMoonPhaseIcon",   pngAttr: "tdaMoonPhasePngImageUrl",   textAttr: "tdaMoonPhaseText",   emojiAttr: "tdaMoonPhaseEmojiIcon"]
    ]
    ...
    if (todayVal != null) {
        ...
        String filename = isPathOverridden ? "mp${index}.png" : "moon-phase-icon-${index}.png"
        String basePath = state.moonPhaseImageLoc ?: "https://raw.githubusercontent.com/thebearmay/hubitat/main/moonPhaseRes/"
        sendIfChanged(name: "currentMoonPhasePngImageUrl", value: "${basePath}${filename}")
    } else {
