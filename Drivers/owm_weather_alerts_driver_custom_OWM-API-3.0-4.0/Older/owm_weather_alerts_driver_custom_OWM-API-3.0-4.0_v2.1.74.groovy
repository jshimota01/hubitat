...
private void sendOWMData(Map current, Map today, Map tom, Map tda) {
    ...
    // ==========================================
    if (today) {
		if (today.sunrise != null) sendIfChanged(name: "todaySunrise", value: today.sunrise)
		if (today.sunset  != null) sendIfChanged(name: "todaySunset",  value: today.sunset)	
    ...
    // ==========================================
    if (tom) {
		if (tom.sunrise != null) sendIfChanged(name: "tomSunrise", value: tom.sunrise)
		if (tom.sunset  != null) sendIfChanged(name: "tomSunset",  value: tom.sunset)
    ...
    // ==========================================
    if (tda) {
		if (tda.sunrise != null) sendIfChanged(name: "tdaSunrise", value: tda.sunrise)
		if (tda.sunset  != null) sendIfChanged(name: "tdaSunset",  value: tda.sunset)
