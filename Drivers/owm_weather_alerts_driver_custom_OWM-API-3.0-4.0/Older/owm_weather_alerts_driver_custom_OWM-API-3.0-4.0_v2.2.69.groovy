...
metadata {
    ...
    preferences {
		...
		// Tile Options
        input name: "displayTileMoonPhaseSVGEnable", type: "bool", title: "Tile - SVG or PNG image use in Moon Phase Tile", description: "Choice of Moon Phase Tile image type. Enable uses SVG, disabled uses PNG<br>Default: <b>ON</b>", defaultValue: true, required: true
...
void calcMoonPhaseSVGIcon(Map todayData = [:], Map tomData = [:], Map tdaData = [:]) {
    ...
    String path = state.iconBasePath ?: "https://tinyurl.com/icnqz/"
