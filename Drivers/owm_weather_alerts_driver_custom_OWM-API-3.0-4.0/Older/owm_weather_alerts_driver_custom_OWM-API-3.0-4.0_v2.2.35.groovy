...
def updated() {
    ...
    // --- FORCE REGISTER NEW MOON PHASE TEXT ATTRIBUTES ---
    sendEvent(name: "todayMoonPhaseText", value: "Pending Poll...")
    sendEvent(name: "tomMoonPhaseText", value: "Pending Poll...")
    sendEvent(name: "tdaMoonPhaseText", value: "Pending Poll...")
...
private void parseOWMData(Map json) {
    ...
    if (state.isInitializing == true) {
		...
		runIn(2, "calcMoonPhaseIconWithText")
    }
}
...
private void sendOWMData(Map current, Map today, Map tom, Map tda) {
	...
	calcMoonPhaseIconWithText(today.moon_phase,tom.moon_phase,tda.moon_phase)
...
void calcMoonPhaseIconWithText() {
	logDebug "${phase.valAttr} = ${device.currentValue(phase.valAttr)}"
    logDebug "Calculating moon phase icons and text names using range tolerances..."
    
    def phases = [
        [valAttr: "todayMoonPhase", iconAttr: "todayMoonPhaseIcon", textAttr: "todayMoonPhaseText"],
        [valAttr: "tomMoonPhase",   iconAttr: "tomMoonPhaseIcon",   textAttr: "tomMoonPhaseText"],
        [valAttr: "tdaMoonPhase",   iconAttr: "tdaMoonPhaseIcon",   textAttr: "tdaMoonPhaseText"]
    ]
    ...
    phases.each { phase ->
        ...
        if (rawVal != null) {
            ...
            // 1. Determine the icon bin index (0 to 7) unchanged
            ...
            logDebug "Skipping icon and text calculation for ${phase.valAttr}: Value is null."
        }
    }
}
