...
private void parseOWMData(Map json) {
    ...
    if (state.isInitializing == true) {
        ...
        runIn(2, "calcCurrentText", [data: [freshLux, freshTemp, freshPress, freshWind, freshHum, currentData, data0, data1, data2]])
...
private void calcCurrentText(BigDecimal freshLux = null, BigDecimal freshTemp = null, BigDecimal freshPress = null, BigDecimal freshWind = null, BigDecimal freshHum = null, Map currentMap = [:], Map todayMap = [:], Map tomMap = [:], Map tdaMap = [:]) {
