...
metadata {
    definition(name: "OpenWeatherMap Multi-Version Weather Driver 2.0", namespace: "jshimota", author: "James Shimota") {
        ...
        attribute "currentSolarNoonTime", "string"
        attribute "currentTwilightBeginTime", "string"
...
private void calcCurrentText(BigDecimal freshLux = null, BigDecimal freshTemp = null, BigDecimal freshPress = null, BigDecimal freshWind = null, BigDecimal freshHum = null) {
    ...
    // 8. Date-Only Attributes Auto-Formatting
    ...
    // 9. Time-Only Attributes Auto-Formatting
    ...
    device.properties.supportedAttributes.each { attr ->
        String attrName = attr.name
        // Filter out 'currentSolarNoonTime' if it stores string formatted timestamps (e.g., "12:34") 
        // to prevent numeric parsing errors, and avoid matching anything mapped to DateTime
        if (attrName.endsWith("Time") && !attrName.contains("DateTime") && attrName != "currentSolarNoonTime") {
            def epochValue = device.currentValue(attrName)
            if (epochValue != null) {
                String targetTextAttribute = "${attrName}Text"
