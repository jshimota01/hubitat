...
def refresh() {
    ...
    // Use coords.lat and coords.lon directly inside your weather query URL assembly string
    logDebug "Proceeding with weather lookup at Lat: ${coords.lat}, Lon: ${coords.lon}"
    
    // Example endpoint implementation format:
    // def weatherUrl = "https://api.openweathermap.org/data/3.0/onecall?lat=${coords.lat}&lon=${coords.lon}&appid=${apiKey}"
}
