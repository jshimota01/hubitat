...
metadata {
    ...
    preferences {
        ...
        input name: "overrideCity", type: "text", title: "Base Override - City", description: "Optional - Will attempt to geo lookup and override <b>ALL</b> longitude/Latitude values (both Hub and values entered below)<br><b>Default: (empty)</b><br><i>
		EG: Portland, OR or London, UK.<br>*Note: Overrides Latitude/Longitude parameters of hub AND values configured below</i>", required: false
