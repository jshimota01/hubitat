...
// =========================================================================
    ...
    // =========================================================================
    def temp, cond, hi, lo, hum, wind, currentIconUrl
	...
	String currentBodyHtml = "<div style='color:#fff;display:flex;flex-direction:column;justify-content:space-around;align-items:center;height:100%;box-sizing:border-box;overflow:hidden;padding:.1em;line-height:1;text-align:center;font-size:1em'>" +
        "<div style='font-size:.75em;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;max-width:100%'>Currently in ${cityName}</div>" +
        "<div><img src='${currentIconUrl}' style='height:2em;max-width:2.4em;object-fit:contain;vertical-align:middle'><b style='font-size:1.22em'>${sT}${tUnit}</b></div>" +
        "<div style='font-size:.7em;text-transform:capitalize;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;max-width:100%'>${cond}</div>" +
        "<div style='font-size:.75em'>High: ${sH}° Low: ${sL}°</div>" +
        "<div style='font-size:.7em;white-space:nowrap'>💧${hum}% ${windIconDisplay}${sW}${wUnit}</div>"
