...
void pollSunRiseSet() {
    ...
    if(!tSunset || tSunset == null){
        ...
        // Dynamically get latitude value for astronomical bounds
...
void pollOWMData() {
    ...
    // DYNAMIC LATITUDE/LONGITUDE SOURCE EVALUATION
...
void pollOWMHandler(resp, data) {
    ...
    if(resp.getStatus() != 200 && resp.getStatus() != 207) {
        ...
        if(myGetData(sPMETR) == 'inHg') {
            ...
            t_press = Math.round(t_press * mult_p) /