...
// hubitat end
/*	OpenWeatherMap-Alerts Weather Driver (Custom OLD 2.5/3.0)			
	...
	V0.7.3d 06/23/2026  Made old version cuz my new one is broken on 4.0 api
    V0.7.3c 06/23/2026  Version catchup
...
static String version()	{  return '0.7.3d'  }
import groovy.transform.Field

metadata {
	definition (name: 'OpenWeatherMap-Alerts Weather Driver (Custom 2.5/3.0)',
		namespace: 'jshimota',
		author: 'Scottma61',
