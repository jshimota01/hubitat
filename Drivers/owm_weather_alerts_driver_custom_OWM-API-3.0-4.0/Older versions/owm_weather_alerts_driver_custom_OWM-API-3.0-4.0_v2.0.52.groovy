...
metadata {
    definition(name: "OpenWeatherMap Multi-Version Weather Driver", namespace: "jshimota", author: "James Shimota") {
        ...
        attribute "conditionIconUrlDAT", "string"
...
private def parsePayload(Map json) {
	...
	sendIfChanged(name: "currentConditionIcon", value: parseCond.icon)
	sendIfChanged(name: "currentConditionIconImg", value: parseCond.icon)
    ...
    sendIfChanged(name: "rainDATorrow", value: rainDat)
    ...
    sendIfChanged(name: "forecastIconUrlTom", value: IconUrlTom)
    sendIfChanged(name: "forcastIconUrlDAT", value: IconUrlDAT)
