...
metadata {
    ...
    preferences {
        ...
        input name: "altMoonPhaseImageLoc", type: "text", title: "Base Override - Moon Phase Image Location", description: "Optional - Moon Phase Image Source Location:<br><i>blank for default Moon Pase Image location</i>", required: false
