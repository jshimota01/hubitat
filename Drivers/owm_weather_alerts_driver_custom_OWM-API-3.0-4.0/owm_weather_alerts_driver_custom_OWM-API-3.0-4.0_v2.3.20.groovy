...
// =========================================================================
    ...
    String moonBodyHtml = "<div style='display:flex;flex-direction:column;justify-content:center;align-items:center;height:100%;width:100%;box-sizing:border-box;border-radius:6px;color:#fff;font-family:sans-serif;text-align:center;overflow:hidden;container-type:inline-size;'>" +
                          ...
                          graphicDisplay +
                          "<div style='position:absolute;width:100%;max-width:90%;left:50%;bottom:42%;transform:translateX(-50%);font-size:clamp(0.6rem, 11cqi, 1.2rem);font-weight:bold;-webkit-text-stroke:.08em#000;text-shadow:.15em .15em .15em #000;z-index:10;pointer-events:none;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;margin:0 auto;'>" + moonPhaseText + "</div>" +
                          "</div>"
