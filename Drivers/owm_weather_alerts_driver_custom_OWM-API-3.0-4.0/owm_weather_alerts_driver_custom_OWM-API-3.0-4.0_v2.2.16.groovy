...
void generateTiles(Map currentData = [:], Map todayData = [:], Map tomData = [:], Map tdaData = [:]) {
    // =========================================================================
    // SECTION 1: currentTile (In-Memory Fix with DB Fallback protection)
    // =========================================================================
    ...
    // If live current/today map payload data exists, extract directly from memory
    if (currentData && todayData) {
        ...
        // Fall back safely to DB values if called parameterless from system schedulers
    ...
    // =========================================================================
    // SECTION 2: 3DayForecastTile (In-Memory Fix with DB Fallback protection)
    // =========================================================================
    // Determine dynamic Day Names safely using sandboxed now()
    ...
    // Helper closure to build identical columns using payload mapping first
