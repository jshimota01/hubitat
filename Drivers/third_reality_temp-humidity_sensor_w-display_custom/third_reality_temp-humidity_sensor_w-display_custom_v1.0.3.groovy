 ...
 * Refactored Diagnostic Build (v1.0.3) for probing and logging private cluster 0xFF01 calibration
 * attributes (0x0031, 0x0032, 0x0033) and verifying device reporting responses.
 *
 * Notes:
...
def timeStamp() { return "2026/09/05 11:00 AM" }
...
List<String> queryPrivateCluster() {
    logInfo "Executing manual Private Cluster 0xFF01 Diagnostic Query..."
    List<String> cmds = []
...
List<String> refresh() {
    ...
    // Include diagnostic query sequence
...
void parse(final String description) {
    ...
    switch (descMap.clusterInt as Integer) {
        ...
        case 0xFF01: // Manufacturer Private Cluster Diagnostics
            assertDeviceOnline()
            logInfo "PROOF TEST - Private Cluster 0xFF01 Payload: attrInt=${descMap.attrInt}, encoding=${descMap.encoding}, value=${descMap.value}, rawMap=${descMap}"
            break
        default:
...
void parseHumidityCluster(final Map descMap) {
    ...
    // Apply integer preference offset before final rounding
