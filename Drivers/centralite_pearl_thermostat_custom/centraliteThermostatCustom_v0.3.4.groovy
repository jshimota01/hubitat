...
metadata {
    definition(
        ...
        // Includes standardized metadata strings for layout generation
        attribute "thermostatFanModes", "JSON_OBJECT"
        attribute "supportedThermostatModes", "JSON_OBJECT" // <-- EXPLICITLY REVEALS THE THERMOSTAT MODE SWITCHES IN HUBITAT UI
...
def initialize() {
    ...
    // UI presentation fan list context - standardized to Hubitat-native tokens
    ...
    // UI presentation system mode context - populates standard button tiles
