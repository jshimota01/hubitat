/**
 * Third Reality Motion Sensor (Custom dev)
...
static String version() { return '1.4.0-dev' }
def timeStamp() { return "2026/09/19 08:30 AM" }
...
metadata {
    definition (
        name: "Third Reality Motion Sensor (Custom dev)", 
        namespace: "jshimota", 
        author: "James Shimota", 
        importUrl: "https://raw.githubusercontent.com/jshimota01/hubitat/main/Drivers/third_reality_motion_sensor/third_reality_motion_sensor_dev.groovy"
    ) {
        capability "Battery"
        ...
        fingerprint profileId: "0104", endpointId: "01", inClusters: "0000,0001,0500,FF01", outClusters: "0019", model: "3RMS16BZ", manufacturer: "Third Reality, Inc", deviceJoinName: "Third Reality Motion Sensor (Custom dev)"
    }

    preferences {
        input name: "coolDownTimeSetting", type: "number", title: "<b>Motion Cool-Down Period</b>", range: "5..3600", defaultValue: 30, required: true, description: "<i>Hardware motion delay before clearing active state (5 to 3600 seconds). Requires firmware 1.00.79+. Note: Wake up the sensor (press button) after saving if battery powered.</i>"
