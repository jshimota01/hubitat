 ...
 *   and real-time IAS Zone motion events.
 **/
/**
...
def timeStamp() { return "2026/08/31 12:30 PM" }
...
metadata {
    ...
    preferences {
        input name: "minVolts", type: "enum", title: "<b>Minimum Operating Voltage</b>", options: ["1.8":"1.8 V", "2.0":"2.0 V", "2.1":"2.1 V", "2.2":"2.2 V", "2.3":"2.3 V", "2.4":"2.4 V"], defaultValue: "2.1", required: true, description: "<i>Sets the minimum threshold voltage used to calculate battery percentage.</i>"
...
private void parseBatteryVoltage(String hexValue) {
    ...
    int batteryPercentage = Math.min(100, Math.max(1, roundedPct))
