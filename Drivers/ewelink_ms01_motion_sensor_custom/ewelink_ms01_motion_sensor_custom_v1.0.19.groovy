 ...
 * Notes: Custom driver for eWeLink MS01 & Sonoff SNZB-03 motion sensors featuring dynamic reporting interval sync, motion reset timer, firmware reporting, and dedicated voltage/percentage battery reporting.
...
def timeStamp() { return "2026/08/30 02:15 PM" }
