 ...
 * Notes: Custom driver for eWeLink MS01 & Sonoff SNZB-03 motion sensors featuring dynamic reporting interval sync, motion reset timer, and dual voltage/percentage battery reporting.
 ...
 **/
/**
 *  Purpose: Provides full device state management, configurable activity check-in intervals, motion reset timeouts, and battery voltage monitoring for eWeLink MS01 and Sonoff SNZB-03 motion sensors.
 *
...
def timeStamp() { return "2026/08/29 10:10 AM" }
