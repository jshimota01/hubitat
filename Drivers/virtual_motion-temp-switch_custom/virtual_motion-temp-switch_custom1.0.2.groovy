 ...
 *      2024-12-23    jshimota      0.1.0.2          added temperature and motion
  **/

static String version() { return '0.1.1.0' }

    definition (name: "Virtual Motion-Temp-Switch Sensor (Custom)", namespace: "jshimota", author: "James Shimota") {
...
def readCurrentValuesIntoLog() {
    csPresence = device.currentState("motion")?.value
    csContact = device.currentState("contact")?.value
