...
static String version() { return '1.45' }
def timeStamp() { return "2026/08/31 03:00 PM" }
 ...
 * Single entry point exposed on the Device Detail page to avoid Hubitat UI command duplication.
 **/
