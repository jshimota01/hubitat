...
static String version() { return '1.34' }
def timeStamp() { return "2026/08/31 05:15 PM" }
...
metadata {
    definition(
        ...
        command "Health Check (Initiate Ping/Pong)"
        command "toggle"
...
List<String> "Health Check (Initiate Ping/Pong)"() {
    return ping()
}
