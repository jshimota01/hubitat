...
static String version() { return '1.22' }
def timeStamp() { return "2026/08/31 01:15 PM" }
...
metadata {
    ...
    preferences {
        ...
        input name: "scheduleSegmentOverride", type: "enum", title: "<b>Health Check Stagger Segment Override</b>", options: SegmentOpts.options, defaultValue: "0", description: "<i>Override the auto-generated 5-minute stagger segment (1-12) used during Health Check scheduling. Select 'Automatic / Use State Value' to use auto-assigned state.</i>"
        ...
        input name: "powerDelta", type: "number", title: "<b>Power Minimum Change </b><i><i>(Power Meter Capable Models Only)</i></i>", description: "<i>The minimum Power (watts) change that will be recorded (3RSP02028BZ model only).</i>", range: "0.1..1500"
...
// Model Detection Helper Routine (Defensive Match + Attribute Emitter)
...
void parseReadReportingConfigResponse(final Map descMap) {
    ...
    if (!DataType.isDiscrete(dataType)) {
        ...
        if (data.size() >= start + 2) {
            reportableChange = hexStrToUnsignedInt(data[start..-1].join())
        }
    }
...
@Field static final Map HealthCheckIntervalOpts = [
    defaultValue: 10,
    options: [ 10: "Every 10 Mins", 15: "Every 15 Mins", 30: "Every 30 Mins", 45: "Every 45 Mins", 60: "Every Hour", 240: "Every 4 Hours", 0: "Disabled" ]
]
