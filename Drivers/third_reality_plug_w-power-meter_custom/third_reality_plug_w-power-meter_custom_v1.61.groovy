...
static String version() { return '1.61' }
def timeStamp() { return "2026/09/10 08:08 AM" }
 ...
 * Transmits the underlying Zigbee Basic Cluster attribute request (Attribute 0x0000 = ZCL Version),
 * registers a timeout check, and remains hidden from the Hubitat GUI command interface.
 **/
...
void parseOnOffCluster(final Map descMap) {
    ...
    switch (descMap.attrInt as Integer) {
        case POWER_ON_OFF_ID:
            ...
            // Force scaled BigDecimal zeros on switch off matching exact handler precisions
        ...
        case POWER_RESTORE_ID:
            ...
            // Only update setting if it differs from current setting to prevent updated() feedback loop
...
@Field static final int HEALTH_CHECK_ATTR_ID = 0x0000 // Basic Cluster ZCL Version
