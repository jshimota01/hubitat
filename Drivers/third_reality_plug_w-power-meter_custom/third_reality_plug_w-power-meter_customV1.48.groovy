...
static String version() { return '1.48' }
def timeStamp() { return "2026/09/01 10:10 AM" }
...
private void initialize(Boolean isInstall = false) {
    ...
    if (interval > 0) {
        scheduleHealthCheck("executeHealthCheck", interval)
    }
 ...
 * Single entry point exposed on the Device Detail page.
 **/
