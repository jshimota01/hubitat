...
static String version() { return '1.36' }
def timeStamp() { return "2026/08/31 05:45 PM" }
...
void updated() {
    ...
    state.remove("lastLoggedVersion")
    state.remove("lastInitializedVersion")
...
void parseWriteAttributeResponse(final Map descMap) {
    ...
    final String statusName = ZigbeeStatusEnum[statusCode] ?: "0x${statusName}"
...
@Field static final Map<Integer, String> ZigbeeGeneralCommandEnum = [
    ...
    011: "Discover Commands Received", 0x12: "Discover Commands Received Response",
