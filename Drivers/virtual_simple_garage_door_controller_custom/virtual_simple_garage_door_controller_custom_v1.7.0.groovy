 ...
 *  
 *  Changelog:
 *  v1.7.0    08/30/26    jshimota    Applied Driver Master Template v1.0.4, added lastInitializedVersion check, cleared active timers on open/close calls
...
metadata {
    definition (
        ...
        importUrl: "https://raw.githubusercontent.com/jshimota01/hubitat/main/Drivers/virtual_simple_garage_door_controller_custom/Virtual_Simple_Garage_Door_Controller_Custom.groovy"
    ) {
