...
def timeStamp() { return "2026/08/28 11:35 AM" }
...
metadata {
    ...
    preferences {
        ...
        if (settings?.enableHtmlFormatting != false) {
            input name: "titleFontSize", type: "text", title: "<b>Title Font Size (em/px)</b> <i>(Default: 0.85em)</i>", defaultValue: "0.85em", required: true
            input name: "boldTitle", type: "bool", title: "<b>Bold Title Text?</b>", defaultValue: true, required: true

            input name: "statusFontSize", type: "text", title: "<b>Door State Font Size (em/px)</b> <i>(Default: 0.75em)</i>", defaultValue: "0.75em", required: true
            input name: "boldStatus", type: "bool", title: "<b>Bold Door State Badge?</b>", defaultValue: true, required: true

            input name: "sensorFontSize", type: "text", title: "<b>Sensor Status Font Size (em/px)</b> <i>(Default: 0.75em)</i>", defaultValue: "0.75em", required: true
            input name: "boldSensors", type: "bool", title: "<b>Bold Sensor Badges?</b>", defaultValue: true, required: true

            input name: "updatedFontSize", type: "text", title: "<b>Footer Font Size (em/px)</b> <i>(Default: 0.65em)</i>", defaultValue: "0.65em", required: true
        }
...
void updateNotificationTile(String tileStr) {
    logDebug "updateNotificationTile(): Updating notification tile attribute"
    sendIfChanged([name: "notificationTile", value: tileStr, descriptionText: "notification tile updated"])
}
