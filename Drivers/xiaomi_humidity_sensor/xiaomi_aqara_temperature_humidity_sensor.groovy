 ...
 *	basis v1.14 (10th March 2023)
 */


@Field String driverVersion = "v1.14.1 (10th March 2023)"


#include Shumo.library
...
metadata {
	...
	definition (name: "Xiaomi Aqara Temperature and Humidity Sensor MODDED JAS", namespace: "Shumo", author: "James Shimota", importUrl: "https://raw.githubusercontent.com/jshimota/hubitat/master/xiaomi/drivers/xiaomi_aqara_temperature_humidity_sensor.groovy") {
...
void configureSpecifics() {
	...
	// JAS this overrides user settings and is bad form in required field
	if (device.name) {
