 ...
 *  
 *  Changelog:
 *  v1.0.15Test   09/07/26    jshimota    Updated version tag to v1.0.15Test
 *  v1.0.14Test   09/07/26    jshimota    Restored pure Garage Door Control by removing Lock and ContactSensor capabilities and event logic
...
static String version() { return '1.0.15Test' }
def timeStamp() { return "2026/09/07 02:35 PM" }
...
// -----------------------------------------------------------------------------
// Capability Commands: open(), close()
// -----------------------------------------------------------------------------
...
private void emitTestDoorEvent(String targetState, String sourceStr) {
    ...
    logInfo """
TEST: GARAGE DOOR EVENT TRANSCRIPT
  ------------------------------------------------------------------------
