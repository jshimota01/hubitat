 ...
 * Capabilities: GarageDoorControl, ContactSensor, Actuator, Configuration, Refresh
 **/
/**
...
static String version() { return '1.0.12Test' }
def timeStamp() { return "2026/09/07 11:00 AM" }
...
private void emitTestDoorEvent(String targetState, String sourceStr) {
    ...
    // Determine Contact Sensor state equivalent
    ...
    logInfo """
TEST: DOOR & CONTACT EVENT TRANSCRIPT
  ------------------------------------------------------------------------
