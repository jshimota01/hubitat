 ...
 * Capabilities: GarageDoorControl, Lock, ContactSensor, Actuator, Configuration, Refresh
 **/
/**
...
static String version() { return '1.0.13Test' }
def timeStamp() { return "2026/09/07 11:35 AM" }
...
private void emitTestDoorEvent(String targetState, String sourceStr) {
    ...
    // Emit Primary Garage Door Event
    sendEvent(
        name: "door", 
        value: cleanTarget, 
    ...
    // Emit Lock Event (Triggers Alexa.LockController payload state updates)
    sendEvent(
        name: "lock", 
        value: lockState, 
        isStateChange: flagVal, 
