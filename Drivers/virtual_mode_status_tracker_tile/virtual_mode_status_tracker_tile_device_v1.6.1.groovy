...
def setTile(String tileContent) {
    if (tileContent != null) {
        sendIfChanged([name: "tile", value: tileContent])
        sendIfChanged([name: "html", value: tileContent])
    }
}
...
private void updateTileDisplay(String overrideMode = null, String overrideCS = null, String overrideTime = null, String overrideHsm = null) {
    ...
    sendIfChanged([name: "tile", value: formattedTile])
    sendIfChanged([name: "html", value: formattedTile])
}
