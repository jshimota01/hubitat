...
def initialize() {
    ...
    sendEvent(name: "driverVersion", value: currentVer, descriptionText: "Driver version set to ${currentVer}")
...
def setStatus(String modeVal, String reasonVal, String timeVal = null) {
    ...
    // Force immediate generation using local variables to prevent state read latency
