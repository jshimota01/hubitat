...
def initialize() {
    ...
    // Explicitly restrict valid options. Hubitat UI will query this object to format Dashboard tiles.
    ...
    // Seed UI templates so state variables populate immediately
...
// Redirects or drops unsupported Auto selections safely
def auto() {
