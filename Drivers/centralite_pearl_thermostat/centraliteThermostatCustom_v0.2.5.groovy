...
/*
 * CentraLite Pearl Thermostat Custom - Fan Dropdown with Off
 * Version: 0.2.5
 */
...
def initialize() {
    ...
    // Added "fanOff" to the allowed platform UI dropdown array
...
// Added decoding translation map logic for reported hardware state "00"
...
// Added the hardware write method command logic for Fan Mode Off
def fanOff() {
