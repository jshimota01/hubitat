...
/*
 * CentraLite Pearl Thermostat Custom - Corrected
 * Version: 0.2.2
 */
...
metadata {
    definition(
        ...
        command "toggleHoldMode" // Renamed to avoid platform signature collision

        attribute "thermostatHoldMode", "string"
        attribute "powerSource", "string"
                               
		fingerprint profileId:"0104", endpointId:"01", inClusters:"0000,0001,0003,0020,0201,0202,0204,0B05", outClusters:"000A,0019", model:"3157100", manufacturer:"Centralite", controllerType: "ZGB" 
    }
...
def parse(String description) {
    ...
    if (description?.startsWith("read attr -") || description?.startsWith("catchall:")) {
        ...
        // Normalize integers for safer fallback detection
...
def setThermostatMode(String value) {
    // Convert spaced/hyphenated modes safely to CamelCase methods
