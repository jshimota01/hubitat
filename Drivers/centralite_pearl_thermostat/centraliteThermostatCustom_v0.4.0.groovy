 ...
 * 2026-06-03    jshimota  	   0.4.0	   text cleanup of UI to show Celsius or Fahrenheit as needed.
 */
...
def parse(String description) {
    ...
    if (map) {
        // Formats logging specifically for setpoint text readouts to include the full scale word
