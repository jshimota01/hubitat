/*
 * Centralite Pearl Zigbee Thermostat (Custom) - Original code derived from Smartthings 2021
 * Version: 0.4.3
 *
 * Change History:
 ...
 * 2026-06-04    jshimota      0.4.4	   Added Update Firmware button / check 
 */
...
metadata {
    definition(
        ...
        filename: "centraliteThermostat.groovy",
...
List<String> updateFirmware() {
    if (txtEnable) log.info 'checking for firmware updates'
