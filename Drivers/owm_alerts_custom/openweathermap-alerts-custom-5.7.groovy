...
//	so they are alway available and shown by default.
		...
		attribute 'tileFontSize', sNUM  //JAS for Android Dashboard
		attribute 'tileFontColor', sSTR //JAS for Android Dashboard
		attribute 'tileHorzWordPos', sSTR //JAS for Android Dashboard
...
//  <<<<<<<<<< Begin Built 3dayfcstTile >>>>>>>>>>
    if(threedayTilePublish) {
        ...
        // JAS Modified
        // String my3day = '<style type="text/css">.cI{height:45%}.cIb{height:80%}</style>' Original Line
        String my3day = '<style type="text/css">.cI{width:35%}.cIb{height:80%}*{font-size: unset !important}tr:nth-child(3){vertical-align:bottom}</style>'
        // my3day += '<table style="text-align:center;display:inline">' original line
        my3day += '<table style="text-align:center;display:inline-table;width: 100%;height: 95%;font-size:1.2rem">'
        // text-align:center;display:inline-table;width: 100%;height: 95%;
