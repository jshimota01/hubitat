...
static String timeStamp() { "2026/08/10 10:31 AM" }
...
void configure() {
    ...
    // 1. Write Hub IEEE Address to IAS CIE (Cluster 0x0500, Attr 0x0010)
    cmds += "zwrite 0x0500 0x0010 0x20 {${location.hub.zigbeeEui}}"
    cmds += "delay 200"
    ...
    // 3. Bind Clusters to Hub
    cmds += zigbee.bindToHub(0x0001, 0x01) // Power Configuration
    cmds += zigbee.bindToHub(0x0500, 0x01) // IAS Zone

    // 4. Configure Battery Reporting (Cluster 0x0001, Attr 0x0021 - Battery Percentage)
