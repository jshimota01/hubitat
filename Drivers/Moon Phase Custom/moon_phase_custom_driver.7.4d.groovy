 ...
 *    2026-05-08  jshimota       Gemini added Text overlay on svg
 */
 
import java.text.SimpleDateFormat
static String version()    {  return '0.7.4d'  }
...
// Tile Generation - Text Overlay Version
    String mediaElement = htmlVStile ? svgData : "<img class='moonPhase' src='${iconPath}moon-phase-icon-${imgNum}.png' style='width:100%; max-width:150px;'>"
    
    // Combined Style: relative container so absolute text can sit on top
    String tileHtml = """
    <div id='moonTile' style='position:relative; display:inline-block; text-align:center; width:100%;'>
        ${mediaElement}
        <div style='position:absolute; top:50%; left:50%; transform:translate(-50%, -50%); 
                    color:white; font-weight:bold; text-shadow: 2px 2px 4px #000; 
                    pointer-events:none; width:100%; font-size:0.5em;'>
            $phaseText
        </div>
    </div>
    """
