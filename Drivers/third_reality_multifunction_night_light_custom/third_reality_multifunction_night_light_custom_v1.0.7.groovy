...
def timeStamp() { return "2026/09/04 12:00 PM" }
...
void installed() {
    ...
    logTrace "installed(): Installing driver v${version()} (${timeStamp()})..."
...
void updated() {
    checkAndLogVersionDemarcation()
    logTrace "updated(): Preferences updated"
...
private void initialize(Boolean isInstall = false) {
    checkAndLogVersionDemarcation()
    logTrace "initialize(): Execution starting (isInstall: ${isInstall})"
