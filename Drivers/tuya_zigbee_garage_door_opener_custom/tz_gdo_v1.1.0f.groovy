...
@Field static final Integer PULSE_TIMER  = 500         // milliseconds


metadata {
    definition (name: "Tuya (Loratap) GDO Relay - Custom", namespace: "jshimota", author: "James Shimota", importUrl: "https://raw.githubusercontent.com/jshimota/Hubitat/Drivers/tuya_zigbee_garage_door_opener_custom/tz_gdo_v1.1.0f.groovy", singleThreaded: true ) {
        capability "Actuator"
