...
/*
	...
	v0.9.1-6	06/24/2026	  JAS     Trying to fix missing illuminated attribute
...
//cloudExtended
    ...
    preferences() {
        ...
        section('Query Inputs'){
            ...
            input 'dbgEnable', 'bool', title: 'Enable Debug Logging', description: '<i>Debug logging will turn off automatically after 30 minutes.</i>', required: true, defaultValue: false
...
void updateLux(Boolean pollAgain=true) {
    ...
    // By using 'pollAgain==false', passing false safely bypasses state checks and forces recalculations
    if(newLight != myGetData('is_lightOld') || myGetData('condition_id')==sNULL || myGetData('cloud')==sNULL || pollAgain==false) {
        
        // ... keep your full math switches, twilight_beginMillis calculations, and tables here ...
        
        // Ensure that at the very end of your active calculations, you push updates to both attributes:
