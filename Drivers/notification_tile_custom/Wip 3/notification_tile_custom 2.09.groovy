...
*    2022-02-19  jshimota 2.0.9     added HTML tile layout values and features
*    2022-02-19  jshimota 2.0.9     added date/time format to list
*/
import java.text.SimpleDateFormat
import groovy.transform.Field
static String version()	{  return '2.0.9'  }

@Field sdfList = ["ddMMMyyyy HH:mm","ddMMMyyyy HH:mm:ss","ddMMMyyyy hh:mma", "dd/MM/yyyy HH:mm:ss", "MM/dd/yyyy HH:mm:ss", "dd/MM/yyyy hh:mma", "MM/dd/yyyy hh:mma", "MM/dd HH:mm", "M/d h:ma", "HH:mm", "H:mm","h:mma", "None"]
