...
* 	 2025-04-03	 thebearmay	   add time/date formats, lowered minimum message count to 1
*    2025-04-20  amithalp	   add color options
*	 2026-04-21	 thebearmay	   v2.0.14 add a reverse fill option
*    2026-04-21  jshimota 2.0.15     added HTML tile layout values and features
*    2026-04-21  jshimota 2.0.16   added date/time format to list
*/
