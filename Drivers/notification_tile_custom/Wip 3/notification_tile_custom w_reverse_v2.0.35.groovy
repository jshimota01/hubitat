...
static String version()    {  return '2.0.35'  }
...
String getTileStyles() {
    ...
    return "<style>.last5 {display:block;${preStyle}text-align:${existingTileHorzWordPos};font-size:${existingTileFontSize}em;}.sh-black {text-shadow: 0px 2px 2px rgba(0,0,0,0.8);}.sh-white {text-shadow: 0px 2px 2px rgba(255,255,255,0.6);}</style>"
}
