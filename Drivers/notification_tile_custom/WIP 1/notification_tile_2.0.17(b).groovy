...
* 	 2025-11-28  jshimota 	2.0.17 mods for color by jas
* createMsgh became createMsgH
* lastMsg became lastMsg
* lastMsgH became lastMsgH
*/ 
...
String colorizeNotification(String msg) {
	...
	if (debugEnable) log.debug "formatted = ${formatted}"    
    return formatted
}
