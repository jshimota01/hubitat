...
*    2021-01-07  thebearmay	Add lastMsgH for horizontal display
*    2021-01-07  thebearmay	Add leading date option
*    2021-03-10  thebearmay	Lost span tag with class=lastMsg
...
*					correct <br/> to <br />
*					Restore: attribute lastMsgH as an optional preference. 
...
* 	 2025-11-28	 jshimota 2.0.13b  last5 changed to lastMsg, last5H changed to lastMsgH, create5H changed to createMsgH
*/
import java.text.SimpleDateFormat
import groovy.transform.Field
static String version()	{  return '2.0.13b'  }
...
metadata {
	...
	preferences {
		...
		input("msgLimit", "number", title:"Number of messages from 5 to 20",defaultValue:5, range:1..20)
	...
	// V2.0.2 When converting from original version set state variables, adjust html in lastMsg to make it work with V2.0.0+	
