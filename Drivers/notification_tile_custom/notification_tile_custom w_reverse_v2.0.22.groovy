...
*    2026-07-27  jshimota      v2.0.22 Added subtle 1px text drop shadow for improved text contrast
*/
/*
...
static String version()    {  return '2.0.22'  }
...
String getTileStyles() {
    ...
    return "<style>.last5 {display:block;${whiteSpace}text-align:${existingTileHorzWordPos};font-size:${existingTileFontSize}%;text-shadow: 1px 1px 1px rgba(0,0,0,0.8);}</style>"
}
