...
static String version()	{  return '0.7.4b'  }
...
metadata {
    definition (
		...
		author: "James Shimota",
	        importUrl:"https://raw.githubusercontent.com/jshimota/hubitat/main/moonPhase.groovy"
	) {
        capability "Actuator"
...
void getPhase(Long cDate = now()) {
    ...
    String phaseIcon = "<div id='moonTile'><img class='moonPhase' src='${iconPath}moon-phase-icon-${imgNum}.png' style='max-width: 100%;height: auto;'><p class='small' style='text-align:center'>$phaseText</p></div>"
    // String phaseIconHTML = "<div style='overflow:hidden; display: table;'><table style='width: calc(100% - 8px);table-layout: fixed;'><tbody><tr><td><img class='moonPhase' src='${iconPath}moon-phase-icon-${imgNum}.png' style='width: 95%'></td></tr><tr><td><p class='small' style='text-align:center'>$phaseText</p></td></tr></tbody></table></div>"
    String phaseIconHTML = "<div style='margin: auto; display: table; padding: 8px;'><table><tbody><tr><td><img class='moonPhase' src='${iconPath}moon-phase-icon-${imgNum}.png' ></td></tr><tr><td><p class='small' style='text-align:center'>$phaseText</p></td></tr></tbody></table></div>"
    if(!htmlVtile)
