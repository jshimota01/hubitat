...
static String version() {return "0.0.4b"}
...
metadata {
    definition (
        ...
        //JAS attributes
        attribute "herokuServer", "string"
        attribute "localServer", "string"
...
// convert bool fields to strings
// IsObservesDST = String.valueOf(ObservesDST)
// example sendEvent sendEvent(name: "DayName", value: DayName)
...
void refreshHTML(){
    ...
    if(serverData.onHeroku == "true"){
        ...
        sendEvent(name: "herokuServer", value: true)
        sendEvent(name: "localServer", value: false)
    } else {
        wkStr+=notOkSymFLD
        updateAttr("serverLocation","Local")
        sendEvent(name: "herokuServer", value: false)
        sendEvent(name: "localServer", value: true)
    }
