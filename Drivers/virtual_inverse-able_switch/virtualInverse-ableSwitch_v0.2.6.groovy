 ...
 * 2026-08-06    jshimota      0.2.6       Fixed infinite looping bug in autotoggle tracking logic
 */
...
private void autotoggle() {
    ...
    if (state.autoOffOnFired != true) {
        ...
        // Reset flag so subsequent manual toggles or state changes can trigger auto-toggle again
