...
def timeStamp() { return "2026/09/04 05:15 PM" }
...
metadata {
    ...
    preferences {
        ...
        input name: "startLevelChangeRate", type: "enum", title: "<b>Level Change Rate</b>", options: [50: "Fast (50 units/sec)", 25: "Medium (25 units/sec)", 10: "Slow (10 units/sec)"], defaultValue: 50, description: "<i>Sets the rate of level change used by startLevelChange().</i>"
...
def startLevelChange(direction) {
    ...
    int rate = settings.startLevelChangeRate != null ? settings.startLevelChangeRate.toInteger() : 50
