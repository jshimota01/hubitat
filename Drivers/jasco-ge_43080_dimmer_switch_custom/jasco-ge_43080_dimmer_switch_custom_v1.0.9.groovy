...
def timeStamp() { return "2026/09/04 04:30 PM" }
...
metadata {
    ...
    preferences {
        ...
        input name: "ledInfoNote", type: "hidden", title: "<b>LED Indicator Behavior</b>", description: "<i>The LED status indicator on the 43080 cannot be configured remotely via Zigbee parameters.<br>To change the LED mode locally on the hardware, quickly press the <b>TOP rocker 3 times</b>, then press the <b>BOTTOM rocker 1 time</b>.<br>This cycles through the three modes: <b>LED ON when Load OFF</b> (Default), <b>LED ON when Load ON</b>, and <b>LED Always OFF</b>.</i>"
        input name: "bindingInfoNote", type: "hidden", title: "<b>Direct Zigbee Bulb Binding (Endpoint 0x02)</b>", description: "<i>This switch includes a dedicated secondary ZDO Client Binding Endpoint (0x02) with client output clusters for On/Off (0x0006) and Level Control (0x0008).<br>Direct binding allows the physical switch to control compatible Zigbee bulbs or light groups directly even if the Hubitat hub is powered off.</i>"
