...
def timeStamp() { return "2026/09/04 03:35 PM" }
...
def setLevel(level, duration = null) {
    ...
    // Explicitly send MoveToLevelWithOnOff (Cluster 0x0008, Command 0x04)
    if (duration != null) {
...
def startLevelChange(direction) {
    ...
    // Command 0x01: Move (up/down at rate 0x32 = 50 units/sec)
...
def stopLevelChange() {
    ...
    List<String> cmds = []
    // Command 0x03: Stop level change
...
def configure() {
    ...
    // Standard Zigbee Bindings & Reporting (Cluster 0x0006 OnOff, Cluster 0x0008 Level)
    ...
    // Execute Health Check to establish online healthStatus and trigger Last Activity
