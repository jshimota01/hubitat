...
def timeStamp() { return "2026/09/04 03:25 PM" }
...
void parse(String description) {
    ...
    // Clear pending Health Check command timeout guard upon receiving frame
...
private void parseDescMap(Map descMap) {
    ...
    // ZDO Cluster 0x8021 (Bind Response) - Log confirmation
...
def setLevel(level, duration = null) {
    ...
    if (duration != null) {
        int transitionTime = duration.toInteger() * 10
...
def configure() {
    ...
    // Standard Zigbee Bindings & Reporting configuration (Cluster 0x0006 OnOff, Cluster 0x0008 Level)
    ...
    // Execute immediate Health Check to establish health status
 ...
 * Sends authentic readAttribute queries for OnOff and Level to refresh Last Activity natively.
 **/
