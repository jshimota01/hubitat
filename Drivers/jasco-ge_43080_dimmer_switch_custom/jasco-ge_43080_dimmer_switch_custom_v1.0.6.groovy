...
def timeStamp() { return "2026/09/04 04:10 PM" }
...
def probeClusterB00D() {
    logInfo "Executing Protocol Archaeology: Probing Cluster 0xB00D attributes 0x0002..0x0005 with MfgCode 0x1124..."
    List<String> cmds = []
    
    // Probe specific candidate attribute IDs 0x0002..0x0005 on Endpoint 1
    cmds += zigbee.readAttribute(0xB00D, 0x0002, [mfgCode: 0x1124])
    cmds += zigbee.readAttribute(0xB00D, 0x0003, [mfgCode: 0x1124])
    cmds += zigbee.readAttribute(0xB00D, 0x0004, [mfgCode: 0x1124])
    cmds += zigbee.readAttribute(0xB00D, 0x0005, [mfgCode: 0x1124])
