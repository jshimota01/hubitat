...
def timeStamp() { return "2026/09/04 06:30 PM" }
...
metadata {
    ...
    preferences {
        ...
        input name: "meteringInfoNote", type: "hidden", title: "<b>Power & Energy Metering Explanation</b>", description: "<i><b>Power (`power` in Watts):</b> Instantaneous real-time electrical draw currently consumed by the connected load (scaled ÷10).<br><b>Energy (`energy` in kWh):</b> Total cumulative electrical usage accrued by the switch over time (scaled ÷10000).</i>"
