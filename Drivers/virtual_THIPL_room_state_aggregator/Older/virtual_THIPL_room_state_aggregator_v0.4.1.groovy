/*
 * THIPL Room State Aggregator Driver (Virtual THIPL Room State Aggregator)
...
metadata {
    definition (name: "Virtual THIPL Room State Aggregator", namespace: "hubitat", author: "James Shimota") {
...
// Capability "Switch" required interface commands
...
def installed() {
    ...
    // Set baseline values for initial display
    setLightsOnCount(0)
