...
preferences {
    ...
    input(name: "rawDateFormat", type: "string", title:"RawDate Format", description: "Enter the date format to apply for entering and displaying RawDate purposes", defaultValue: "MM-dd-yyyy", required: true, displayDuringSetup: true)

    // Line below removed cuz I dont need time stuff
    ...
    // Lines below taken out but hardset in Installed() section - or removed!
...
def installed() {
    ...
    // Line Below commented out as I removed all Timezone stuff
    // timeZone() = getLocation().timeZone.getID()

    // Line Below I never got to work because of semicolon in value - not needed anyway!
