...
preferences {
    ...
    input name: "hemisphere", type: "bool", title: "Northern Hemisphere", defaultValue: true
	...
	input(name: "dateFormat", type: "string", title:"Date Format", description: "Enter the date format to apply for display purposes", defaultValue: "MMMM d", required: true, displayDuringSetup: true)
